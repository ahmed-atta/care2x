...
<?php $bill_obj->Display_Headline($LDInsuranceMenu,'','', 'insurance_menu.php','Insurance Management :: Main Menu'); ?>
			...
			<TBODY>
				<TR>
					<TD>
                        ...
                        <TD class="submenu_item"><nobr><a href="insurance_types_tz.php"><?php echo 'Manage Insurance Companies'; ?></a></nobr></TD>
                        <TD><?php echo 'Add or Edit Insurance Companies'; ?></TD>
                      					</tr>
							<tr>
                        <td align=center><img src="../../gui/img/common/default/pdata.gif" border=0></td>
...
<?php $bill_obj->Display_Footer($LDInsuranceMenu,'','', 'insurance_menu.php','Insurance Management :: Main Menu'); ?>
