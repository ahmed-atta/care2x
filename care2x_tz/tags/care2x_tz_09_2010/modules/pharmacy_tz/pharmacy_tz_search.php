...
if (!empty($keyword) || !empty($category)) {
  ...
  while ($search_element = $search_results->FetchRow()) {
    ...
    $http_buffer.=" <td>".$item_number."</td>
                    ...
                    <td><div align=\"center\"><a href=\"pharmacy_tz_new_product.php?mode=edit&item_id=".$item_id."&GOBACKTOSEARCH=TRUE&category=".$category."&keyword=".$keyword."\"><img src=\"".$root_path."gui/img/common/default/hammer.gif\" width=\"16\" height=\"16\" border=\"0\"></a></td>
