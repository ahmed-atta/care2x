			 ...
			 <table cellspacing="0"  class="titlebar" border=0>
 				<tr valign=top  class="titlebar" >
  					<td width="202" bgcolor="#99ccff" >
    					&nbsp;&nbsp;<font color="#330066"><?php echo $LDSystemReports; ?></font></td>
...
<TR>
                        ...
                        <TD class="submenu_item"><nobr><a href="insurance_types_tz.php"><?php echo $LDDiagReport;?></a></nobr></TD>                        <TD><?php echo $LDDocsDiagReport; ?></TD>
					 ...
					 <tr>
                      ...
                      <td align=center><img src="../../gui/img/common/default/pdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="insurance_company_tz.php"><?php echo $LDPrescReport; ?></a></nobr></TD>
                        <TD><?php echo $LDDocsPrescReport; ?></TD>
                      </tr>
                      

						<TR>
                        <td align=center><img src="../../gui/img/common/default/comments.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="insurance_types_tz.php"><?php echo $LDLabReport;?></a></nobr></TD>
                        <TD><?php echo $LDDocsLabReport; ?></TD>
                      </tr>

                      <TR>
                        <td align=center><img src="../../gui/img/common/default/new_group.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="insurance_members_tz.php"><?php echo $LDRadReport; ?></a></nobr></TD>
                        <TD><?php echo $LDDocsRadReport; ?></TD>
                      </tr>
					  
					  <TR>
                        <td align=center><img src="../../gui/img/common/default/new_group.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="insurance_members_tz.php"><?php echo $LDSurgReport; ?></a></nobr></TD>
                        <TD><?php echo $LDDocsSurgReport; ?></TD>
                      </tr>
					...
					<TR>
                        <td align=center><img src="../../gui/img/common/default/comments.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="insurance_types_tz.php"><?php echo $LDSysLogReport;?></a></nobr></TD>                        
						<TD><?php echo $LDSysLogReport; ?></TD>
