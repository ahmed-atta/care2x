...
$LDImaging,$LDOther,$LDTotal;
		...
		$table_head = "<tr>\n";
		if (!$PRINTOUT)
			$table_head .= "<td bgcolor=\"#ffffaa\" colspan=\"18\" align=\"center\">Cash Financial Summary : $admissionclass </td>\n";
		else
			$table_head .= "<td colspan=\"18\" align=\"center\">Cash  Financial Summary : $admissionclass </td>\n";
		$table_head.="</tr>\n";
...
OR purchasing_class='surgical_op') AND from_unixtime($curr_day_start,'%d-%m-%Y') <= from_unixtime(date_change,'%d-%m-%Y') AND from_unixtime($curr_day_start,'%d-%m-%Y') >= from_unixtime(date_change,'%d-%m-%Y') AND  insurance_id='$insuranceid'";
			...
			case "other":
                                ...
                                $sql_filter="WHERE purchasing_class='service' AND item_number like 'W%' AND from_unixtime($curr_day_start,'%d-%m-%Y') <= from_unixtime(date_change,'%d-%m-%Y') AND from_unixtime($curr_day_start,'%d-%m-%Y') >= from_unixtime(date_change,'%d-%m-%Y') AND  insurance_id='$insuranceid'";
                                break;
...
function _Create_Cash_receipts_tmp_master_table($start_timeframe,$end_timeframe, $admission) {
		...
		$sql_d ="DROP TABLE IF EXISTS `tmp_billing_master`";
		$db_ptr = $db->Execute($sql_d);
		$sql_s ="CREATE TABLE tmp_billing_master TYPE=HEAP (SELECT DISTINCT
				  care_tz_billing_archive_elem.nr as BillNumber,
				  care_tz_billing_archive_elem.date_change,
				  care_tz_billing_archive_elem.is_labtest,
				  care_tz_billing_archive_elem.is_medicine,
...
function DisplayCashReceiptsTestSummary($start_timeframe, $end_timeframe, $admission){
		...
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_advance_amount_of($start_timeframe,$admission,1,"","", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","amb", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","bed", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","consult", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","consum", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","dental", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","drugs", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","eye", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","file", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","icu", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","lab", TRUE).$italic_tag_close."</td>\n";
         $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","mort", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","minproc", TRUE).$italic_tag_close."</td>\n";
        $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","proc/surg", TRUE).$italic_tag_close."</td>\n";
        $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","radio", TRUE).$italic_tag_close."</td>\n";
        $table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","other", TRUE).$italic_tag_close."</td>\n";
		$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_bill_amount_of($start_timeframe,$admission,1,"","total", TRUE).$italic_tag_close."</td>\n";
...
function DisplayInsuranceCompanyTestSummary($start_timeframe, $end_timeframe, $insuranceid, $admission){
	...
	$sql_encounter_nr="SELECT distinct (encounter_nr)  as encounternr , pid FROM tmp_billing_master where insurance_id='$insuranceid' and from_unixtime( date_change, '%Y-%d-%m' )=from_unixtime( $current_day, '%Y-%d-%m' )  ";
		...
		if (!$PRINTOUT)$bg_color="#CC9933";
				...
				$table .= "<td bgcolor=\"$bg_color\" align=\"right\">".$italic_tag_open.$this->_get_insurance_company_advance_amount($start_timeframe,1,"",$insuranceid, TRUE).$italic_tag_close."</td>\n";
...
function DisplayCompaniesBillingTestSummary($start_timeframe, $end_timeframe, $admission){
		...
		tmp_billing_master.insurance_id=care_tz_company.id  where from_unixtime( date_change, '%Y-%d-%m' )=from_unixtime( $current_day, '%Y-%d-%m' )  AND insurance_id != '0' AND insurance_id != '' AND insurance_id != 'NULL' ORDER BY name ASC";
