<?php /* Smarty version 2.6.22, created on 2011-02-20 14:42:05
         compiled from med_depot/submenu_medlager.tpl */ ?>
		 <blockquote>
...
unset($_smarty_tpl_vars);
 ?>
					...
					<?php echo $this->_tpl_vars['LDOrderCat']; ?>
...
unset($_smarty_tpl_vars);
 ?>
					...
					<?php echo $this->_tpl_vars['LDOrderArchive']; ?>
...
unset($_smarty_tpl_vars);
 ?>
					...
					<?php echo $this->_tpl_vars['LDOrderBotActivate']; ?>
