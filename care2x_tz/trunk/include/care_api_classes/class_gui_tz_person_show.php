...
?>
		<table border=0 cellspacing=1 cellpadding=3 style="margin-left:5px;">
		<tr>
		<td bgColor="#eeeeee">
...
?>
	...
	<?php if ($vct[7]==1) { # if has diabetic enabled?>
		...
		<tr>
		<td  bgColor="#eeeeee">
			<FONT SIZE=-1  FACE="Arial"><?php echo $LDDiabeticNr ?>:
		</td>
		<td  bgcolor="#ffffee">
			<FONT SIZE=-1  FACE="Arial" color="#800000"><?php echo $diabetic_nr; ?>
		</td>
		</tr>
	...
	<?php if ($vct[6]==1) { # if has nhif enabled?>
		<tr>
		<td  bgColor="#eeeeee">
			<FONT SIZE=-1  FACE="Arial"><?php echo $LDnhifNr ?>:
		</td>
		<td  bgcolor="#ffffee">
			<FONT SIZE=-1  FACE="Arial" color="#800000"><?php echo $nhif_nr; ?>
		</td>
		</tr>
	<?php } # nhif ?>
	...
	<?php if ($vct[3]==1) { # if has ctc Number enabled?>
		<tr>
		<td  bgColor="#eeeeee">
			<FONT SIZE=-1  FACE="Arial"><?php echo $LDctcNr ?>:
		</td>
		<td  bgcolor="#ffffee">
			<FONT SIZE=-1  FACE="Arial" color="#800000"><?php echo $ctc_nr; ?>
		</td>
		</tr>

		<tr>
		<td  bgColor="#eeeeee">
			<FONT SIZE=-1  FACE="Arial"><?php echo $LDhivNr ?>:
		</td>
		<td  bgcolor="#ffffee">
			<FONT SIZE=-1  FACE="Arial" color="#800000"><?php echo $hiv_nr; ?>
		</td>
		</tr>
	<?php } # ctc ?>
