...
$LDRefDischarge='Referral discharge';
$LDRegularRelease='Regular discharge';
$LDSelfRelease='Patient requested to be discharged';
...
$LDConsultationRequest='Consultation Request';
...
$LDReports='Consultation Report';
$LDLabReports='Lab Reports';
$LDRadioReports='Radiology Reports';
$LDPhotos='Photos';
...
$LDConsumSupplies='Consumables/Supplies Used';
$LDProceduresRequest='Operations / Procedures Done';
...
$LDDaily='Daily';
$LDServicesRequest='Services Requested for patient';
...
$LDTestRequest='Requested Test';
$LDNotesReports='Notes & Reports';
...
$LDProcedures='OP & Procedures';
$LDProcedureName='Procedure Name';
$LDProcedureType='OP/ Procedure Category';
...
$LDAdmissionDate='Admission date/Time';
$LDPatientNr='Patient File No';
$LDPatientID='Patient ID';
$LDPatNr='File No.';

$LDNotesType='Notes Type';
$LDEnteredBy='Entered By:';
$LDTitleNotes='Title/Headline';
$LDFullDescription='Enter Notes';
$LDRequired='*Required';

$LDShowDiagnosis = 'Show Diagnosis';
$LDShowLabs = 'Show Laboratory Tests';
$LDShowRadio = 'Show Radiology Tests';

$LDprescriptionsSent="Drug prescriptions sent";
$LDConsumUsed="Consumables/Supplies Entered";
$LDProcedureDone="Medical Procedure Done";
$LDRadioRequested="Radiology Request Sent";
$LDRadioReportArrived="Radiology Report has arrived";
$LDServicesRequested="Services have been entered";
