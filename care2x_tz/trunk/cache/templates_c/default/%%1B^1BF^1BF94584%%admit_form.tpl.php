<?php /* Smarty version 2.6.26, created on 2010-10-22 15:10:29
			...
			<?php if ($this->_tpl_vars['LDWard']): ?>
				<tr>
				  ...
				  <td colspan=2 class="adm_input">&nbsp;</td>
					...
					<tr>
					  <td class="adm_item"><font color="red"><?php echo $this->_tpl_vars['LDWard']; ?>
</font>: </td>
					  <td colspan=2 class="adm_input"> <?php echo $this->_tpl_vars['sWardInput']; ?>
 </td>
			  </tr>
					<tr>
					  <td class="adm_item"><?php echo $this->_tpl_vars['LDAmbulance']; ?>
: </td>
					  <td colspan=2 class="adm_input"> <?php echo $this->_tpl_vars['sAmbInput']; ?>
 </td>
			  </tr>
					<tr>
					  <td class="adm_item"> <?php echo $this->_tpl_vars['LDRecBy']; ?>
: </td>
					  <td colspan=2 class="adm_input"> <?php echo $this->_tpl_vars['registration_fee']; ?>
 </td>
			  </tr>
					<tr>
					  <td class="adm_item">&nbsp;</td>
			  ...
			  <?php if ($this->_tpl_vars['sDeptInput']): ?>
			  <tr>
				  <td class="adm_item">
		...
		<?php endif; ?>
	            <tr>
				  <td class="adm_item">
					  <?php echo $this->_tpl_vars['LDRooms']; ?>
:				</td>
				  <td colspan=2 class="adm_input" id="specials">
					  <font color="red"><?php echo $this->_tpl_vars['sRoomInput']; ?>
</font>
	              </td>
	            </tr>
