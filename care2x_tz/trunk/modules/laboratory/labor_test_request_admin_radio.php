...
<?php 
$sql='select item_description from care_tz_drugsandservices where item_description='.$stored_request['test_request'];
...
?>
	<tr bgcolor="<?php echo $bgc1 ?>">
		...
		<font face="courier" size=2 color="#000099">&nbsp;&nbsp;<?php echo stripslashes($stored_request['number_of_tests']) ?></font>
				</td>
