	...
	<TR>
		<TD><table cellpadding=3 cellspacing=1>
              <tbody class="submenu">
				...
				<tr>
                  <td style="border-top:3px double #696969; background-color:#E2E2E2; border-bottom:3px double #696969;" colspan="3" align=center>
                  		<b>Hospital Reports</b>
                  </td>
                </tr>
		    ...
		    <!--  end poor fund -->
                ...
                <tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="rooming_main.php">Rooms & attendances</a></td>
                  <td>List of Rooms with respective doctors per month</td>
                </tr>
