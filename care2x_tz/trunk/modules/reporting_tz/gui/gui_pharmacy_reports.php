...
<TR>
					  ...
					  <td align=center><img src="../../gui/img/common/default/pdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="reporting_pharmacy.php"><?php echo $LDOPDPharmacyReport; ?></a></nobr></TD>
                        <TD><?php echo $LDOPDPharmacyReportInfo; ?></TD>
                      </tr>
					  
					  <TR>
					  <td align=center><img src="../../gui/img/common/default/pdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="reporting_pharmacy.php"><?php echo $LDIPDPharmacyReport; ?></a></nobr></TD>
                        <TD><?php echo $LDIPDPharmacyReportInfo; ?></TD>
                      </tr>
                      ...
                      <td align=center><img src="../../gui/img/common/default/pdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="reporting_consumables.php"><?php echo $LDConsSuppliesReport; ?></a></nobr></TD>
