...
$rep_obj->DisplayPharmacyTableHead($admission);
$rep_obj->DisplayPharmacyResultRows($start_timeframe, $end_timeframe, $admission);
echo '</table>';
echo '</html></body>';
exit();
}
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    {
    	urlholder="./reporting_pharmacy.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe;
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">				
                          ...
                          <?php $rep_obj->DisplayPharmacyTableHead($admission);?>

	<?php $rep_obj->DisplayPharmacyResultRows($start_timeframe,$end_timeframe,$admission);?>
