...
<DIV align="center">
	...
	<p><?php echo $LDCreationTime; ?><?php echo date("F j, Y, g:i a");?></p>
                          ...
                          <table width="500" border="1" cellspacing="0" cellpadding="0" align="center" >
                            <tr>
                              <td widtd="220" ><?php echo $LDOPDVisits; ?></td>
                              <td widtd="32" >&lt; 5 </td>
                              <td widtd="32" >&gt; 5 </td>
                              <td colspan="2"><?php echo $LDsex; ?></td>
                              <td widtd="64" ><?php echo $LDtotal; ?></td>
                            </tr>
                            <tr>
                              <td><b><?php echo $LDNewPatients; ?></b> </td>
                            ...
                            <tr>
                              <td><b><?php echo $LDViewsforthesamedisease; ?></b> </td>
                            ...
                            <tr>
                              <td><b><?php echo $LDTotalPediatrics; ?></b></td>
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo $LDReportingOPDSummary; ?></font></td>
...
<form name="form1" method="post" action="">
                          ...
                          <table width="500" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor=#ffffdd>
                            <tr>
                              <td widtd="220" bgcolor="#ffffaa"><?php echo $LDOPDVisits; ?>O</td>
                            ...
                            <tr>
                             ...
                             <tr>
                              <td bgcolor="#ffffaa"><b><?php echo $LDViewsforthesamedisease; ?></b> </td>
                              <td><?php echo $arr_ret['revisit']['underage'];?></td>
                              <td><?php echo $arr_ret['revisit']['adult'];?></td>
                              <td><?php echo $arr_ret['revisit']['male'];?></td>
                              <td><?php echo $arr_ret['revisit']['female'];?></td>
