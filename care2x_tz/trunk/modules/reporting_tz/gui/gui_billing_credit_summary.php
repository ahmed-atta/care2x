...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'Credit Revenue Summary'; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">
							...
							<?php require_once($root_path.$top_dir.'include/inc_gui_billing_timeframe_admission.php'); ?>
						  <br><br><br>
                          <table width="95%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffdd">
                          <?php $rep_obj->DisplayInsuranceBillingTableHead();?>

						  <?php $rep_obj->DisplayInsuranceBillingTestSummary($start_timeframe, $end_timeframe, $admission);?>
						  <?php $rep_obj->DisplayInsuranceBillingResultRows($start_timeframe, $end_timeframe);?>
                          </table>
				</form>
