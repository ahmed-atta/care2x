...
$rep_obj->DisplayInsuranceBillingTableHead();
$rep_obj->DisplayInsuranceBillingTestSummary($start_timeframe, $end_timeframe);
$rep_obj->DisplayInsuranceBillingResultRows($start_timeframe, $end_timeframe);
echo '</table>';
echo '</html></body>';
exit();
}
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'Insurance Financial Report - OPD'; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">
						  ...
						  <?php $rep_obj->DisplayInsuranceBillingTestSummary($start_timeframe, $end_timeframe);?>
