...
$sql1="SELECT DISTINCT(item_description) AS SERVICE  FROM $tmp_table1 WHERE purchasing_class LIKE '%xray' " ;
$db_ptr1=$db->Execute($sql1);
if ($db_ptr1) {
	$res_array1 = $db_ptr1->GetArray();
} else {
	$res_array1 = FALSE;
...
require_once('gui/gui_reporting_radiology.php');
?> 
