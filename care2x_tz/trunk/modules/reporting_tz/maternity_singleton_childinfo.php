...
if (empty($_GET['printout'])) {
	if (empty($_POST['CYears'])) {
			...
			$start_timeframe = mktime (0,0,0, 1, 1, $_POST['CYears']);
			$end_timeframe = mktime (0,0,0,1, 0, $_POST['CYears']);
...
<!--
    ...
    {
    	urlholder="./maternity_singleton_childinfo.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe+"&group_id="+group_id;
...
<FONT  COLOR="<?php echo $cfg['top_txtcolor']; ?>"  SIZE=+2  FACE="Arial"><STRONG>&nbsp;<?php echo $LDSReportSingletonChildInfo ?></STRONG></FONT></td>
