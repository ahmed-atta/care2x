...
*/
$lang_tables=array('dental.php','actions.php');
...
$allowedarea=$allow_area['dental'];
$append=URL_REDIRECT_APPEND;


$fileforward='../ambulatory/amb_clinic_patients.php?sid='.$sid.'&dept_nr=43&lang=en&origin=pass&target=list';


//$fileforward='dental_tz.php'.$append;

$lognow='Dental login ok';
