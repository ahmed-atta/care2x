...
<!-- NOTES AND APPOINTMENTS -->
  <tr>
	...
	<div id="pDiv" style="width:100%; overflow:hidden; height:30px; background-color:#A7A7A7; padding:2px;">
      <span style="float:left; background-color:#696969; text-align:center; white-space:nowrap; width:100%; margin:0px 0px 3px 0px; background-color:#696969; color:white; border-bottom:1px solid maroon; font:bold 11px Tahoma, monospace; ">
			...
			<table width="100%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr align="center" valign="middle">
				  ...
				  <td width="30px"><input id="pNb" onClick="hideme('pNb','pDiv',88)" type="button" value="+" style="float:right; width:20px; border:1px solid maroon; font-weight:bold; margin:2px;"> </td>
				</tr>
	    </table>
  ...
  <tr>
    <td  colspan="3" align="center" valign="top" bgcolor="#696969">
	<div id="radDiv" style="width:100%; overflow:hidden; height:30px; background-color:#A7A7A7; padding:2px;">
      <span style="float:left; background-color:#696969; text-align:center; white-space:nowrap; width:100%; margin:0px 0px 3px 0px; background-color:#696969; color:white; border-bottom:1px solid maroon; font:bold 11px Tahoma, monospace; ">
			...
			<table width="100%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr align="center" valign="middle">
				  ...
				  <td width="30px"><input id="radb" onClick="hideme('radb','radDiv',85)" type="button" value="+" style="width:20px; float:right; border:1px solid maroon; font-weight:bold; margin:2px;"> </td>
				</tr>
	    </table>
	  ...
	  <br>
		<center>
		<?php $rads = $Radiology->FindRadiologyBatchNo($pn);

			  echo '' .// RADIOLOGY REQUEST
				   '<input style="width:220px; overflow:hidden; border:1px solid maroon; margin:0px 6px 7px 0px;" type="button" ' .
				   'onClick="javascript:window.location.href=\''.$root_path.'modules/nursing/nursing-station-patientdaten-doconsil-radio.php?sid='.$sid.'&ntid=false&lang=en&pn='. $pn .'&edit=1&status=&target=radio&user_origin=lab&noresize=1&mode=\'"' .
				   ' value="Radiology Request">' .
				   '';

			  if ($rads != 'none'){ echo '<br />' .
			  						   '<input style="width:220px; overflow:hidden; border:1px solid maroon; margin:0px 6px 7px 0px;" type="button" ' .
			  						   'onClick="javascript:window.location.href=\''.$root_path.'modules/laboratory/labor_test_findings_radio.php?sid='.$sid.'&lang=en&edit=1&mode=done&target=admin&subtarget=radio&batch_nr='. $rads .'&pn='.$pn.'&user_origin=lab&entry_date=0000-00-00\'"' .
  ...
  <tr>
    <td  colspan="3" align="center" valign="top" bgcolor="#696969">
	<div id="jj" style="width:100%; overflow:hidden; height:30px; background-color:#A7A7A7; padding:2px;">
      <span style="float:left; background-color:#696969; text-align:center; white-space:nowrap; width:100%; margin:0px 0px 3px 0px; background-color:#696969; color:white; border-bottom:1px solid maroon; font:bold 11px Tahoma, monospace; ">
			...
			<table width="100%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr align="center" valign="middle">
				  ...
				  <td width="30px"><input id="jk" onClick="hideme('jk','jj',85)" type="button" value="+" style="width:20px; float:right; border:1px solid maroon; font-weight:bold; margin:2px;"> </td>
				</tr>
	    </table>
  ...
  <tr>
    <td  colspan="3" align="center" valign="top" bgcolor="#696969">
	<div id="otherDiv" style="width:100%; overflow:hidden; height:30px; background-color:#A7A7A7; padding:2px;">
      <span style="float:left; background-color:#696969; text-align:center; white-space:nowrap; width:100%; margin:0px 0px 3px 0px; background-color:#696969; color:white; border-bottom:1px solid maroon; font:bold 11px Tahoma, monospace; ">
			...
			<table width="100%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr align="center" valign="middle">
				  ...
				  <td width="30px"><input id="otherB" onClick="hideme('otherB','otherDiv',55)" type="button" value="+" style="float:right; width:20px; border:1px solid maroon; font-weight:bold; margin:2px;"> </td>
				</tr>
	    </table>
  ...
  <tr>
    <td  colspan="3" align="center" valign="top" bgcolor="#696969">
	<div id="dpDiv" style="width:100%; overflow:hidden; height:85px; background-color:#A7A7A7; padding:2px;">
      <span style="float:left; background-color:#696969; text-align:center; white-space:nowrap; width:100%; margin:0px 0px 3px 0px; background-color:#696969; color:white; border-bottom:1px solid maroon; font:bold 11px Tahoma, monospace; ">
			...
			<table width="100%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr align="center" valign="middle">
				  ...
				  <td width="30px"><input id="dpB" onClick="hideme('dpB','dpDiv',85)" type="button" value="-" style="width:20px; float:right;border:1px solid maroon; font-weight:bold; margin:2px;"> </td>
				</tr>
	    </table>
	  ...
	  <br>
		...
		<?php
			...
			if ($dept_nr == '43'){
						echo	'<input  style="width:220px; overflow:hidden; border:1px solid white; margin:0px 0px 7px 6px;" type="button" onClick="window.location.href=\''.$root_path.'modules/registration_admission/show_prescription.php?sid='.$SID.'&ntid=false&lang=en&mode=new&show=dental&disablebuttons=&externalcall=true&backpath=\'" value="'.$LDDentalPrescriptions.'">';
					}
			else {
						echo	'<input  style="width:220px; overflow:hidden; border:1px solid white; margin:0px 0px 7px 6px;" type="button" onClick="window.location.href=\''.$root_path.'modules/registration_admission/show_prescription.php'.URL_REDIRECT_APPEND.'$sid='.$SID.'&pn='.$pn.'&lang=en&ntid=false&externalcall=true&help_site=patient_charts&target=search&1=1&backpath='.urlencode($_SERVER["PHP_SELF"].URL_APPEND.'&pn='.$pn).'\'" value="'.$LDPrescriptions.'">';
					}
		?>
		</center>
    </div>
