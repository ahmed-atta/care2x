...
<meta http-equiv="refresh" content="0;URL=javascript:window.location.href='../dental/gui_patient_history.php?sid=<?php echo $_GET['sid']?>&ntid=false&lang=en&encounter=<?php echo $_GET['pn']?>&frm=list';">
