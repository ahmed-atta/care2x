...
echo '
  ...
  <?php echo $LDRequestingDoc ?>:
		<input type="text" name="send_doctor" size=40 maxlength=40 value="<?php ($stored_request['send_doctor'])? print $stored_request['send_doctor'] : print $_SESSION['sess_user_name']; // if($edit_form || $read_form) echo $stored_request['send_doctor'] ?>"></div><br>
		</td>
    </tr>
	<tr bgcolor="<?php echo $bgc1 ?>">
