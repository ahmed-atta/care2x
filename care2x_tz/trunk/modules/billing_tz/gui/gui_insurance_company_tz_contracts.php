				...
				<?php } ?>
  					...
  					<td align="right">
						<table border="1" cellpadding="2" cellspacing="0">
							 ...
							 <tr bgcolor=ffffee>
                                  		         <td colspan = 4 ><a href="insurance_company_tz_new.php"><?php echo $LDInsertCompany; ?></a></td>
							...
							<tr bgcolor=ffffee>
                                                         <td colspan = 4 ><a href="insurance_company_tz.php"><?php echo $LDInsuranceCompanies; ?></a></td>
