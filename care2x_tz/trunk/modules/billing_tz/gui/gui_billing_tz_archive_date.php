...
<form name="form1" method="post" action="billing_tz_archive_date.php">
					...
					<td>
					  ...
					  <?php
					  	...
					  	else
					  	{
							...
							echo '<td class="headline"><div align="center"><a href="billing_tz_archive.php?print=true&page=1&sortby=selian_pid&sorttyp='.$sorttyp.'&month='.$month.'&year='.$year.'&txtsearch='.$_REQUEST['txtsearch'].'&searchtyp='.$_REQUEST['searchtyp'].'">File No.</a>'.$img_pid.'</div></td>';
							...
							$total_sum = $bill_obj->DisplayAllArchivedBill($txtsearch,$searchtyp,$start_timeframe,$end_timeframe, $trans_id, 400,$month, $year, $sorttyp);	
							...
							echo '<td class="headline" colspan=4><div align="center"></div></td>';
                                                        echo '</tr>';
