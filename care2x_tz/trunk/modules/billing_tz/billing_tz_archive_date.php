 ...
 */
 ...
 else
 {
	...
	$selected_day = date("d",$f_date); 
	$selected_month = date("n",$f_date);
	$selected_year = date("Y",$f_date);

	$start_timeframe =  mktime (0,0,0,$selected_month, $selected_day, $selected_year);
        $end_timeframe =   mktime (0,0,0,$selected_month, $selected_day+1, $selected_year);
 }
