		...
		<td bgcolor=#ffffff valign=top>
				...
				<table border="0" cellpadding="2" cellspacing="0">
					...
					<tr bgcolor=ffffaa>
						...
						<td><?php echo $this_insurance['insurance']; ?></td>
					</tr>
					<tr bgcolor=ffffee>
						<td>Confirm:</td>
						<td><input type="hidden" name="id" value="<?php echo $id; ?>"><input type="hidden" name="mode" value="delete"><input type="submit" value="Delete this company"></td>
					</tr>
				</table>
				</form>
