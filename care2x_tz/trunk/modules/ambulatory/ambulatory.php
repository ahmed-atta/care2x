...
//
 ...
 $smarty->assign('sApptLink',"<a href=\"".$root_path."modules/appointment_scheduler/appt_main_pass.php".URL_APPEND."&target=".$v['nr']."&dept_nr=".$v['nr']."&user_origin=amb&dept=".strtr($v['name_formal'],' ','+')."\">Appointments</a>");
