							...
							<TABLE cellSpacing=1 cellPadding=3 width=600>
    							...
    							<TBODY class="submenu">
      								<TR>
						        		...
						        		<TD class="submenu_item"><nobr><a href="eye_examination.php<?php echo URL_APPEND ?>&pid=<?php echo $_GET['pid']?>&pn=<?php echo $_GET['encounter_nr']?>&mode=new" >Eye Examination</a></nobr></TD>
						        		<TD>Eye Examination Details</TD>
      								</tr>
      								<TR>
						        		<td align=center><img src="../../gui/img/common/default/showdata.gif" border=0></td>
						        		<TD class="submenu_item"><nobr><a href="eye_history.php<?php echo URL_APPEND ?>&pid=<?php echo $_GET['pid']?>&pn=<?php echo $_GET['encounter_nr']?>&mode=new" >History Sheet</a></nobr></TD>
