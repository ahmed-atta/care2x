...
$fileforward='radio_data_patient_such.php?sid='.$sid.'&lang='.$lang.'&mode=done';
$thisfile='radio_datasearch_pass.php';
...
<tr>
<td colspan=3><img <?php echo createLDImgSrc($root_path,'such-b.gif','0') ?>><a href="radio_datainput_pass.php?sid=<?php echo "$sid&lang=$lang" ?>&route=validroute"><img <?php echo createLDImgSrc($root_path,'newdata-gray.gif','0') ?>></a></td>
</tr>
