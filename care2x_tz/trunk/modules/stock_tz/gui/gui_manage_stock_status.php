...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066">Manage Stock Status</font>
				...
				<TD>
                    ...
                    <TBODY class="submenu">
                      <TR> 
                        ...
                        <TD class="submenu_item"><nobr><a href="manage_stock_status_show_items.php">Show items</a></nobr></TD>
                        <TD>Show all stock items</TD>
                      </tr>
                      <TR> 
                        <td align=center><img src="../../gui/img/common/default/waiting.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="manage_stock_status_transfers.php">Manage transfers</a></nobr></TD>
                        <TD>Show/Alter/Cancel Transfers</TD>
                      </tr>
                      <TR  height=1> 
