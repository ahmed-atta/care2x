...
// $smarty->assign('pbBack',$returnfile);
 ...
 $aSubMenuIcon=array(createComIcon($root_path,'lockfolder.gif','0'),
										...
										createComIcon($root_path,'hammer.gif','0'),
...
$aSubMenuItem=array('LDQViewTxt' => '<a href="edv-main-pass.php'.URL_APPEND.'&target=adminlogin">'.$LDManageAccess.'</a>',
										...
										'LDELTTxt' => '<a href="'.$root_path.'modules/elt/gui/gui_elt.php'.URL_APPEND.'">'.$LDETL.'</a>',
										'LDAsignTXT' => '<a href="'.$root_path.'modules/dept_admin/room.php'.URL_APPEND.'&fw=conf&mode=view">'.$LDAsign.'</a>',
										);
