...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'Reporting:ReportingDailyFinancialRecord(ARV)'; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
                  ...
                  <?php $rep_obj->DisplayARVBillingTableHead();?>  
						 
				 <?php $rep_obj->DisplayARVBillingTestSummary($start_timeframe, $end_timeframe);?>  
