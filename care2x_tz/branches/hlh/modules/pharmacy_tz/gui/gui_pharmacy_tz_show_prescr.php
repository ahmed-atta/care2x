...
//echo $sqlOuter;
			...
			$crit .= " and prescribe_date = '$dateSQL' ";
				...
				*/
				...
				$sqlInner = "select *, sum(dosage*times_per_day) as total from care_encounter_prescription INNER JOIN care_tz_drugsandservices ON care_tz_drugsandservices.item_id=care_encounter_prescription.article_item_number " .
