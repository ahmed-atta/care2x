						...
						<tr>
							...
							<table cellpadding="0" border="0" bgcolor="">
								<tbody>
									<tr>
										<td>&nbsp;</td>
										<td><FONT SIZE=1 FACE="Arial" color="#000066"><?php echo 'Priority : '; ?></FONT></td>
...
for ($i=0;$i<sizeOf($drug_list);$i++) {
	if ($drug_list[$i][2]==$stored_request['test_request']) {
		echo '<option selected value='.$drug_list[$i][0].'>'.$drug_list[$i][2].'</option>';
	} else {
		echo '<option value='.$drug_list[$i][0].'>'.$drug_list[$i][2].'</option>';
	}
}
echo '</select></td></tr>';
?>
    ...
    <tr>
      ...
      <td><input type="checkbox" name="nuclear" value="1" <?php if(($edit_form || $read_form) && $stored_request['nuclear']) echo "checked" ?>></td>
								...
								<tr>
									<td align="right">
									<div class=fva2_ml10><?php echo $LDPatMobile ?> &nbsp;<?php echo $LDYes ?>
									</div>
									</td>
									...
									&nbsp;<?php echo $LDNo ?> <input type="radio"
										...
										<?php if(($edit_form || $read_form) && !$stored_request['if_patmobile']) echo "checked" ?>></font></td>
									<td align="right">
									<div class=fva2_ml10><?php echo $LDAllergyKnown ?> &nbsp;<?php echo $LDYes ?>
									</div>
									</td>
									<td><font size=2 face="verdana,arial"> <input type="radio"
								...
								<tr>
									...
									&nbsp;<?php echo $LDNo ?> <input type="radio"
										...
										<?php if(($edit_form || $read_form) && !$stored_request['if_hyperten']) echo "checked" ?>></font></td>
									<td align="right">
									<div class=fva2_ml10><?php echo $LDPregnantPossible ?> &nbsp;<?php echo $LDYes ?>
									</div>
									</td>
									<td><font size=2 face="verdana,arial"> <input type="radio"
