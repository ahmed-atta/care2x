...
<table border=0 bgcolor="#000000" cellpadding=1 cellspacing=0>
 ...
 <?php
      ...
      <td bgcolor="<?php echo $bgc1 ?>"  class=fva2_ml10><div class=fva2_ml10><font size=5 color="#0000ff"><b><?php echo $formtitle ?></b></font>
		 ...
		 <br><?php echo $global_address[$subtarget].'<br>'; ?>
		 </div></td>
		 </tr>
	 <tr>
    ...
    <tr>
      <td align="right"><div class=fva2_ml10><?php echo $LDXrayTest ?></div></td>
      <td>&nbsp;<?php printCheckBox('xray'); ?></td>
      <td align="right"><div class=fva2_ml10><?php echo $LDSonograph ?></div></td>
      <td>&nbsp;<?php printCheckBox('sono'); ?></td>
    </tr>
    <!--
    <tr>
      <td align="right"><div class=fva2_ml10><?php echo $LDCT ?></div></td>
      <td>&nbsp;<?php printCheckBox('ct'); ?></td>
      <td align="right"><div class=fva2_ml10><?php echo $LDMammograph ?></div></td>
      <td>&nbsp;<?php printCheckBox('mammograph'); ?></td>
    </tr>
    -->
    <tr>
      <td align="right"><div class=fva2_ml10><?php echo $LDMRT ?></div></td>
      <td>&nbsp;<?php printCheckBox('mrt'); ?></td>
      <td align="right"><div class=fva2_ml10><?php echo $LDNuclear ?></div></td>
    ...
    <tr>
      <td align="right"><div class=fva2_ml10><?php echo $LDPatMobile ?> &nbsp;<?php echo $LDYes ?></div></td>
      <td><font size=2 face="verdana,arial">&nbsp;<?php printRadioButton('if_patmobile',1); ?>&nbsp;<?php echo $LDNo ?>
	  &nbsp;<?php printRadioButton('if_patmobile',0); ?></font></td>
      <td align="right"><div class=fva2_ml10><?php echo $LDAllergyKnown ?> &nbsp;<?php echo $LDYes ?></div></td>
      <td><font size=2 face="verdana,arial">&nbsp;<?php printRadioButton('if_allergy',1); ?>&nbsp;<?php echo $LDNo ?>
	  &nbsp;<?php printRadioButton('if_allergy',0); ?></font></td>
    </tr>
    <tr>
      <td align="right"><div class=fva2_ml10><?php echo $LDHyperthyreosisKnown ?> &nbsp;<?php echo $LDYes ?></div></td>
      <td><font size=2 face="verdana,arial">&nbsp;<?php printRadioButton('if_hyperten',1); ?>&nbsp;<?php echo $LDNo ?>
	  &nbsp;<?php printRadioButton('if_hyperten',0); ?></font></td>
      <td align="right"><div class=fva2_ml10><?php echo $LDPregnantPossible ?> &nbsp;<?php echo $LDYes ?></div></td>
  ...
  <?php echo $LDRequestingDoc ?>:
	...
	<tr bgcolor="<?php echo $bgc1 ?>">
		<td  colspan=2 bgcolor="#cccccc"><div class=fva2_ml10><font color="#000099">
		 <?php echo $LDXrayNumber ?></font><font face="courier" size=2 color="#000000">
	...
	<tr bgcolor="<?php echo $bgc1 ?>">
		<td colspan=2 align="right"><div class=fva2_ml10><font color="#000099">
		 <?php echo $LDDate ?>&nbsp;</font><font face="courier" size=2 color="#000000">
        <?php 
