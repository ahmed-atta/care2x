...
echo '
					<td width=20%>';
					if ($stored_request['priority']==0) {
						echo '<font color="green"><b>NORMAL';
					}
					if ($stored_request['priority']==3) {
						echo '<font color="blue"><b>PRIORITY';
					}
					if ($stored_request['priority']==5) {
						echo '<font color="orange"><b>URGENT';
					}
					if ($stored_request['priority']==7) {
...
echo'<td width=20%>
					...
					<font color="purple">'.$LDPatientID.'
						<font color="#ffffee" class="vi_data"><b>'.$person['pid'].'
					</td>
					<td width="20%">
