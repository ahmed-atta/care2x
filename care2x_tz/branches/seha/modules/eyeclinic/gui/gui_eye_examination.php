...
<table width="750" border="0">
  ...
  <tr>
    <td bgcolor="#F0F8FF"><select name='vart1'><option value='6/5'>6/5</option><option value='6/6'>6/6</option><option value='6/9'>6/9</option><option value='6/12'>6/12</option><option value='6/18'>6/18</option><option value='6/24'>6/24</option><option value='6/36'>6/36</option><option value='6/60'>6/60</option></select> </td>
<td bgcolor="#F0F8FF"><select name='valt1'><option value='6/5'>6/5</option><option value='6/6'>6/6</option><option value='6/9'>6/9</option><option value='6/12'>6/12</option><option value='6/18'>6/18</option><option value='6/24'>6/24</option><option value='6/36'>6/36</option><option value='6/60'>6/60</option></select> </td>
  </tr>
  <tr>
<td bgcolor="#F0F8FF"><select name='vart2'><option value='CF'>CF</option><option value='HM'>HM</option><option value='PLP'>PLP</option><option value='PL'>PL</option><option value='NPL'>NPL</option></select> </td>

<td bgcolor="#F0F8FF"><select name='valt2'><option value='CF'>CF</option><option value='HM'>HM</option><option value='PLP'>PLP</option><option value='PL'>PL</option><option value='NPL'>NPL</option></select> </td>
  </tr>
  <tr>
    <td bgcolor="#F0F8FF"><input name="vart3" type="radio" value="unaided" />
      Unaided <input name="vart3" type="radio" value="glasses"/>
      Glasses <input name="vart3" type="radio" value="pinhole"/>
      Pinhole </td>
    <td bgcolor="#F0F8FF"><input name="valt3" type="radio" value="unaided" />
      Unaided <input name="valt3" type="radio" value="glasses" >
      Glasses<input name="valt3" type="radio" value="pinhole"/>
      Pinhole  </td>
  </tr>
</table>
</fieldset>
...
<tr><td width="643"><a href="eye_examination_test2.php<?php echo URL_APPEND ?>&pid=<?php echo $_GET['pid']?>&mode=new" >Go to next page</a></td></tr>
       </table>
	  </fieldset>
</form>
    </p>
