...
<FONT  COLOR="<?php echo $cfg['top_txtcolor']; ?>"  SIZE=+2  FACE="Arial"><STRONG>&nbsp;&nbsp;&nbsp;<?php echo $LDDentalReport ?></STRONG></FONT></td>
...
<tr  valign=top>
    <td colspan="5">
	<?php require("gui/gui_dental_poorfund_billing_search.php"); //style="border:1px solid #ccc; padding:3px; font:normal 12px Tahoma, Monospace; width:150px;" ?>   </td>
  </tr>
<tr  valign=top>
...
<tr  valign=bottom>
  ...
  <?php	($type == $LDStaff) ? print $LDStaffBillingReport . $real_dts :  print $LDFundBillingReport . $real_dts;

		$obj->GetRowsFromSpecial($_GET['mnth'],$_GET['yrs'],$_GET['type'],'whiterow','colorrow','main');
...
<tr  valign=top>
  <td colspan="5"><div style="margin-left:10px; float:left; width:60%; text-align:right; ">
    <input name="print" type="submit" class="btn" value="Print &raquo;" onClick = "Javascript:window.open('../reporting_tz/gui/gui_dental_billing_print.php?mnth=<?php echo $_GET['mnth']; ?>&yrs=<?php echo $_GET['yrs']; ?>&type=<?php echo $_GET['type']; ?>', 'dentalBilling','width=700, height=500,scrollbars=yes')">
  </div></td>
</tr>
<tr  valign=top>
  <td colspan="5">&nbsp;</td>
