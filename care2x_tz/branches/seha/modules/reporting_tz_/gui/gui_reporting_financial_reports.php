	...
	<TR>
		<TD><table cellpadding=3 cellspacing=1>
			  ...
			  <tr>
                ...
                <tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="ipd_cash_financial.php"><?php echo $LDIPDCashFinancialReport; ?></a></td>
                  <td><?php echo $LDIPDCashFinancialReport; ?></td>
                </tr>

				<tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="opd_cash_financial.php"><?php echo $LDOPDCashFinancialReport; ?></a></td>
                  <td><?php echo $LDOPDCashFinancialReport; ?></td>
                </tr>
            ...
            <!--  poor fund dennis from softweb  -->

				<tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="../reporting_tz/dental_poorfund_billing.php"><?php echo 'Special billing Program'; ?></a></td>
                  <td><?php echo 'Patient Billing Reports'; ?></td>
                </tr>
