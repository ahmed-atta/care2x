...
<table border=0 cellspacing=1 cellpadding=2 width=100%>
  ...
  <tr>
	<td bgcolor="#ffffff">
	    ...
	    &nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path,'redpfeil.gif','0','absmiddle') ?>><FONT  color="#0000cc" FACE="verdana,arial" size=2><a href="edv_patient_numbers.php<?php echo URL_APPEND ?>" target="SYSADMIN_WFRAME"> <?php echo $LDGeneralSettings; ?></a></FONT><br>
...
<!--   <tr>
 ...
 -->
  ...
  <!--
  	DOCTORS ROOM LIST
  	installed by Dennis Mollel
	requirement for SEHA (ARUSHA)
	-->

  <tr>
	<td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><?php echo $LDDoctorRooms; ?></b> </FONT></td>
  </tr>
  <tr>
	<td bgcolor="#ffffff" valign="top">
	<FONT  color="#0000cc" FACE="verdana,arial" size=2>
	&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path,'redpfeil.gif','0','absmiddle') ?>> <a href="<?php echo $root_path; ?>modules/dept_admin/room.php<?php echo URL_APPEND; ?>&fw=new&mode=add" target="SYSADMIN_WFRAME"><?php echo $LDCreate ?> New</a><br>
	&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path,'redpfeil.gif','0','absmiddle') ?>>
	<a href="<?php echo $root_path; ?>modules/dept_admin/room.php<?php echo URL_APPEND; ?>&fw=list" target="SYSADMIN_WFRAME"> Room Lists</a><br />
	&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path,'redpfeil.gif','0','absmiddle') ?>>
	<a href="<?php echo $root_path; ?>modules/dept_admin/room.php<?php echo URL_APPEND; ?>&fw=conf&mode=view" target="SYSADMIN_WFRAME"> Assign Doctor to a Room</a>
	</td>
  </tr>
