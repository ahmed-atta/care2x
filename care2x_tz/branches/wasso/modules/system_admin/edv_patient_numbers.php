<?php
	...
	if ($_POST['hospNo']){
		...
		# extract hospital numbers
		($_POST['ppid']==1)? $vc  = '1|' : $vc .= '0|';
		($_POST['penc']==1)? $vc .= '1|' : $vc .= '0|';
		($_POST['hno']==1) ? $vc .= '1|'  : $vc .= '2|';
		($_POST['ctc']==1) ? $vc .= '1|'  : $vc .= '0|';
		($_POST['billing']==1) ? $vc .= '1|'  : $vc .= '0|';
		($_POST['yletter']==1) ? $vc .= '1' :  $vc .= '2';
