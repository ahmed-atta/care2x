    ...
    <tr>
      <td><table width="470"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#D2DFD0" class="style3">
        <tr align="center" bgcolor="#E7EEE6">
          <td height="38" colspan="3" bgcolor="#C0D2BD"><div align="center" class="style5" style="text-transform:uppercase;">Add Patient notes</div></td>
        </tr>
        <tr bgcolor="#E7EEE6">
          <td width="111" height="30" align="right" bgcolor="#E7EEE6"><strong>Date:</strong></td>
          <td colspan="2" bgcolor="#FFFFFF"><input name="date" type="text" value="<?php echo date('d/m/Y'); ?>" size="25" readonly="true" />
          </td>
        </tr>
        ...
        <tr align="center" valign="top" bgcolor="#FFFFFF">
          ...
          <td colspan="2" align="left" bgcolor="#FFFFFF" class="style7"><input name="short" type="text" id="short" size="35" maxlength="100">
          </td>
        </tr>
        <tr align="center" valign="top" bgcolor="#FFFFFF">
          <td align="right" valign="top" nowrap bgcolor="#E7EEE6"><strong>Full Description:</strong></td>
          <td width="265" align="left" nowrap bgcolor="#FFFFFF" class="style7"><textarea name="notes" cols="40" rows="5" id="notes"></textarea>
          </td>
        ...
        <tr align="center" valign="top" bgcolor="#C0D2BD">
          <td colspan="3" align="right" valign="middle">
            ...
            <input name="Close2" type="button" id="Close25" value="Cancel" class="button2" onClick="javascript:window.location.href='<?php echo $url[0].'?pid='.$url[1]; ?>'" >
          </td>
        </tr>
      </table></td>
    </tr>
