  ...
  <table width="600"  border="0" align="center" cellpadding="4" cellspacing="1" class="style3">
    ...
    <tr bgcolor="#FFFFFF">
	  ...
	  <div id="prnttop">
		  <div id="prntcc">
		  	...
		  	<input name="New" type="button" id="Close2" value="New Notes &raquo;" class="button" onClick="navigate('<?php echo $encounter_nr; ?>&url=<?php echo '../dental/gui_patient_history.php|'.$pid; ?>', '../dental/gui_dental_addnotes.php')" >
    ...
    <tr align="left" valign="top">
	  ...
	  <div id="prnt">
		  ...
		  <div id="prntcc">
		  	<input name="Print" type="button" id="Print2" value="Print this &raquo;" class="button" onClick="printPage();" >
		  	<input name="New" type="button" id="Close2" value="New Notes &raquo;" class="button" onClick="navigate('<?php echo $_GET['encounter']; ?>&url=<?php echo '../dental/gui_patient_history.php|'.$pid; ?>', '../dental/gui_dental_addnotes.php')" >
		  	<input name="Close" type="button" id="Close2" value="<?php ($_GET['frm'] == 'chart')?  print '&laquo; back' : print 'Close'; ?>" class="button2" onClick="javascript:window.<?php ($_GET['frm'] == 'chart')?  print 'history.back()' : print 'close()'; ?>;" >
		  </div>
	  </div>
	  </td>
