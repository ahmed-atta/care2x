...
{
	if (!x) x="";
	urlholder="../../main/help-router.php?sid=52310d9ec54f1b038859157b14bc5b5c&lang=$lang&helpidx="+x+"&src="+s+"&x1="+x1+"&x2="+x2+"&x3="+x3+"&x4="+x4;
...
function popPic(pid,nm){
 ...
 if(pid!="") regpicwindow = window.open("../../main/pop_reg_pic.php?sid=52310d9ec54f1b038859157b14bc5b5c&lang=$lang&pid="+pid+"&nm="+nm,"regpicwin","toolbar=no,scrollbars,width=180,height=250");
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  ...
  <td bgcolor="#99ccff" align=right><a
   ...
   href="apotheke.php?ntid=false&lang=$lang" ><img src="../../gui/img/control/default/en/en_close2.gif" border=0 width="103" height="24" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this,1)" onMouseOut="hilite(this,0)"></a>  </td>
...
<TR>
	...
	<TD class="submenu_item"><nobr><a href="../../modules/products/products-datenbank-functions-such.php?ntid=false&lang=$lang&userck=ck_prod_db_user&cat=pharma">Search</a></nobr></TD>
...
<p>
<a href="apotheke.php?ntid=false&lang=$lang"><img src="../../gui/img/control/default/en/en_close2.gif" border=0 width="103" height="24" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this,1)" onMouseOut="hilite(this,0)"></a>
</blockquote>									
		</td>
	</tr>
...
//  Script End -->
 ...
 <a href="javascript:openCreditsWindow()"> Credits </a> ::.<br>
	    ...
	    Page generation time: 0.10575914382935
	    </font>
    </td>
   <tr>
  </table>
