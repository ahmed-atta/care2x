				...
				<TD>
                    ...
                    <TBODY class="submenu">
                      <TR> 
                        ...
                        <TD class="submenu_item"><nobr><a href="purchase_items_step1.php">Purchase Items</a></nobr></TD>
                        <TD>Purchase new items from suppliers</TD>
                      </tr>
                      <TR> 
                        <td align=center><img src="../../gui/img/common/default/waiting.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="receive_items_step1.php">Receive Items</a></nobr></TD>
                        <TD>To put incoming shipments into stock</TD>
                      </tr>
                      <TR> 
                        <td height="26" align=center><img src="../../gui/img/common/default/common_infoicon.gif" border=0 width="16" height="16"></td>
                        <TD class="submenu_item"><nobr><a href="manage_stock_status.php">Manage stock</a></nobr></TD>
                        <TD>Inventory and more</TD>
                      </tr>
                      <TR> 
                        <td align=center><img src="../../gui/img/common/default/xchange.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="assignments_step1.php">Assignments</a></nobr></TD>
                        <TD>Transfer items between stocks</TD>
                      </tr>
                      ...
                      <TR> 
                        <td height="26" align=center><img src="../../gui/img/common/default/hammer.gif" border=0 width="16" height="16"></td>
						<TD class="submenu_item"><nobr><a href="#"><i><s>Manage Druglist</s></i></a></nobr></TD>
                        <TD><s>Insert/Edit/Delete basic druglist data</s></TD>
                      </tr>
                      <TR> 
                        <td height="26" align=center><img src="../../gui/img/common/default/patdata.gif" border=0 width="16" height="16"></td>
						<TD class="submenu_item"><nobr><a href="#"><i>Manage Dealers</i></a></nobr></TD>
                        <TD>Insert/Edit/Delete dealer lists</TD>
                      </tr>
                      <TR> 
                        <td height="26" align=center><img src="../../gui/img/common/default/settings_tree.gif" border=0 width="16" height="16"></td>
                       <TD class="submenu_item"><nobr><a href="setup.php" >Stock setup</a></nobr></TD>
						
						<TD>Manage basic stock info like behaviour</TD>
                      </tr>
