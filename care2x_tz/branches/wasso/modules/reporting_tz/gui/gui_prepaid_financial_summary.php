...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'Prepaid Financial Summary'; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">
                          ...
                          <?php $rep_obj->DisplayPrepaidFinancialTableHead();?>

						  <?php $rep_obj->DisplayPrepaidBillingTestSummary($start_timeframe, $end_timeframe);?>
						  <?php $rep_obj->DisplayPrepaidBillingResultRows($start_timeframe, $end_timeframe);?>
                          </table>
				</form>
