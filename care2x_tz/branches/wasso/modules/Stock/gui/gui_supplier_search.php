   ...
   <a href= "./index.php" ><img src="../../gui/img/control/default/en/en_close2.gif" border=0 width="103" height="24" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this,1)" onMouseOut="hilite(this,0)"></a>  </td>
	...
	<tr>
      ...
      <td height="321" valign=top bgcolor=#ffffff> <ul>
          <p> <br>
          <form action="supplier_search.php" method="post" name="suchform" onSubmit="return pruf(this)">
            <table border=0 cellspacing=2 cellpadding=3>
              <tr bgcolor=#ffffdd>
                <td colspan=2> <FONT color="#800000"><?php echo "Enter a search keyword for example:* for all Suppliers or a keyword for Company name or Contact Person"; ?></font> <br> <p> </td>
              </tr>
              <tr bgcolor=#ffffdd>
          ...
          <table width="70%" border="0" bgcolor=#ffffdd align="center">
            <tr>
              <td width="10%"><?php echo "Company Number"; ?></td>
              <td width="30%"><?php echo "Company Name"; ?></td>
              <td width="10%"><?php echo "Contact Person"; ?></td>
              <td width="5%"><?php echo "Show"; ?></td>
              <td width="5%"><?php echo "Edit"; ?></td>
              <td width="5%"><?php echo"Delete"; ?></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
