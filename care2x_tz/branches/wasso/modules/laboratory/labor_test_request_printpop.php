...
$sql="SELECT care_person.pid, name_first, name_last FROM care_person LEFT JOIN care_encounter ON care_person.pid=care_encounter.pid
	LEFT JOIN care_test_request_".$db_request_table." ON care_encounter.encounter_nr=care_test_request_".$db_request_table.".encounter_nr WHERE batch_nr='".$batch_nr."'";
...
div.fa2_ml10 {font-family: verdana,arial; font-size: 12; margin-left: 10;}
div.fva2_ml3 {font-family: verdana; font-size: 12; margin-left: 3; }
div.fa2_ml3 {font-family: verdana,arial; font-size: 12; margin-left: 3; }
