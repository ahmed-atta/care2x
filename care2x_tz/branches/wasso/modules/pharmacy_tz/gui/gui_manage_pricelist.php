  ...
  <tbody class="main">
	...
	<tr>
      <td height="321" valign=top bgcolor=#ffffff>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="csvtable">
            <caption>
              <strong><?php echo $LDStoredPriceList_header;?></strong>
            </caption>
            <tr>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column1;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column2;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column3;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column4;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column5;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column6;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column7;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column8;?></p></th>
              ...
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column11;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column12;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column13;?></p></th>
              <th width="100" bgcolor="#999933" scope="col"><p><?php echo $column14;?></p></th>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
