...
function hidetab(){
	...
	document.getElementById("hyd").innerHTML='';
	alert('tayari');
...
.greenbtn{ background:darkgreen;}

.hidebtn{background:#99CCFF;}

.greenbtn, .hidebtn{
	 border:1px solid blue; width:146px; padding: 5px 17px 5px 17px; color:white; font:bold 11px Tahoma, Monospace;
}

.billing{border:1px solid blue; background:maroon; padding: 5px 17px 5px 17px; color:white; font:bold 11px Tahoma, Monospace;}
a.billing, a.greenbtn, a.hidebtn{text-decoration:none;}
.billing:hover, .greenbtn:hover, .hidebtn:hover{border:1px solid black; background: white; color:black;}
...
<!--
	...
	modified by Dennis Mollel, October - 2008
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
            <td bgcolor="#99ccff" > &nbsp;&nbsp;<font color="#330066"><?php echo $LDPendingBills; ?> (<?php echo $encoded_batch_number=$enc_obj->ShowPID($batch_nr); ?>)</font> </td>
  <td bgcolor="#99ccff" align=left>
    <a href="javascript:window.back()"><img src="../../gui/img/control/default/en/en_back2.gif" border=0 width="75" height="24" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this,1)" onMouseOut="hilite(this,0)"></a>
