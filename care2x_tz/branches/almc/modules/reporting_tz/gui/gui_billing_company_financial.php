...
$rep_obj->DisplayInsuranceCompanyBillingTableHead($company_id);
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo $LDReportingDailyFinancialRecord; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">				
							...
							<?php require_once($root_path.$top_dir.'include/inc_gui_timeframe_company_selection.php'); ?>			
						  <br><br><br>
                          <table width="95%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffdd">


                     			<?php $rep_obj->DisplayInsuranceCompanyBillingTableHead($company_id);?>

					<?php $rep_obj->DisplayInsuranceCompanyTestSummary($start_timeframe, $end_timeframe, $company_id, $admission);?>

					<?php $rep_obj->DisplayBillingResultRows($start_timeframe, $end_timeframe);?>
