...
$rep_obj->DisplayDeletedQuotationsTableHead();
$rep_obj->DisplayDeletedQuotationsSummary($start_timeframe, $end_timeframe, $admission, $pricelist);
$rep_obj->DisplayDeletedQuotationsResultRows($start_timeframe, $end_timeframe);
echo '</table>';
echo '</html></body>';
exit();
}
...
function gethelp(x,s,x1,x2,x3,x4)
{
    ...
    {
    	urlholder="./deleted_quotations_report.php?printout=TRUE&start_timeframe="+start_timeframe+"&end_timeframe="+end_timeframe;
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'Deleted Bill Quotations Report'; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<?php require_once($root_path.$top_dir.'include/inc_gui_timeframe_pricelist.php'); ?>
						  <br><br><br>
                          <table width="95%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffdd">
                          <?php $rep_obj->DisplayDeletedQuotationsTableHead();?>

						  <?php $rep_obj->DisplayDeletedQuotationsSummary($start_timeframe, $end_timeframe, $admission,$pricelist);?>
						  <?php $rep_obj->DisplayDeletedQuotationsResultRows($start_timeframe, $end_timeframe);?>
                          </table>
				</form>
