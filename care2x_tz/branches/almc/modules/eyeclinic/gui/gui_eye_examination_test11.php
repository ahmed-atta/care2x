...
<table width="750" border="0">
  ...
  <tr>
    <td bgcolor="#F0F8FF"><input type='checkbox' name='lr1'></td>
<td bgcolor="#F0F8FF" align='center'>Normal</td>
<td bgcolor="#F0F8FF"><input type='checkbox' name='ll1'></td>
  </tr>

</tr>
  <tr>
    <td bgcolor="#F0F8FF"><input type='checkbox' name='lr2'></td>
<td bgcolor="#F0F8FF" align='center'>nuclear opacity</td>
<td bgcolor="#F0F8FF"><input type='checkbox' name='ll2'></td>
  </tr>

</tr>
  <tr>
    <td bgcolor="#F0F8FF"><input type='checkbox' name='lr3'></td>
<td bgcolor="#F0F8FF" align='center'>Posterior subcapsular opacity</td>
<td bgcolor="#F0F8FF"><input type='checkbox' name='ll3'></td>
  </tr>

</tr>
  <tr>
    <td bgcolor="#F0F8FF"><input type='checkbox' name='lr4'></td>
<td bgcolor="#F0F8FF" align='center'>cortical opacity</td>
<td bgcolor="#F0F8FF"><input type='checkbox' name='ll4'></td>
  </tr>

</tr>
  <tr>
    <td bgcolor="#F0F8FF"><input type='checkbox' name='lr5'></td>
<td bgcolor="#F0F8FF" align='center'>dense cataract</td>
<td bgcolor="#F0F8FF"><input type='checkbox' name='ll5'></td>
  </tr>

<tr>
    <td bgcolor="#F0F8FF"><input type='checkbox' name='lr6'></td>
<td bgcolor="#F0F8FF" align='center'>complicatied cataract</td>
<td bgcolor="#F0F8FF"><input type='checkbox' name='ll6'></td>
  </tr>

  <tr>
    <td bgcolor="#F0F8FF"><input type='checkbox' name='lr7'></td>
<td bgcolor="#F0F8FF" align='center'>The lens is dislocated</td>
<td bgcolor="#F0F8FF"><input type='checkbox' name='ll7'></td>
  </tr>

  <tr>
    <td bgcolor="#F0F8FF"><input type='checkbox' name='lr8'></td>
<td bgcolor="#F0F8FF" align='center'>The lens is absent (Aphakia)</td>
<td bgcolor="#F0F8FF"><input type='checkbox' name='ll8'></td>
  </tr>
  <tr>
    <td bgcolor="#F0F8FF"><input type='checkbox' name='lr9'></td>
<td bgcolor="#F0F8FF" align='center'>There is an Intraocular lens (Pseudophakia)</td>
<td bgcolor="#F0F8FF"><input type='checkbox' name='ll9'></td>
  </tr>
	   ...
	   <table width="750">
         ...
         <tr>
           ...
           <td colspan="2" bgcolor="#F0F8FF"><input name="registration_id" type="hidden" value="<?php echo $values['registration_id']?>" />
			...
			<input type="submit" value="ADD" name="addtest11" onclick="return submitForm();"/> &nbsp;<input type="reset" value="Reset"> </td>
         </tr>
<tr><td width="643"><a href="eye_examination_test12.php<?php echo URL_APPEND ?>&pid=<?php echo $_GET['pid']?>&mode=new" >Go to next page</a></td>
<td  bgcolor="#F0F8FF">&nbsp;</td>
         <td width="643"><a href="eye_examination_test10.php<?php echo URL_APPEND ?>&pid=<?php echo $_GET['pid']?>&mode=new" >Go to previous page</a></td>
</tr>
       </table>
	  </fieldset>
</form>
