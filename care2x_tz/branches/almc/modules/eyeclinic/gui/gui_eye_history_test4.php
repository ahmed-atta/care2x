...
<tr>
    <td width="275" bgcolor="#F0F8FF">Patient Complains</td>
    <td colspan="6" bgcolor="#F0F8FF"> which Eye?</td>
    <td colspan="10" bgcolor="#F0F8FF">Duration of symptoms</td>
    </tr>


  <tr>
    <td bgcolor="#F0F8FF"></td>
    <td width="35" bgcolor="#F0F8FF">Both </td>
    <td width="21" bgcolor="#F0F8FF">R</td>
    <td colspan="2" bgcolor="#F0F8FF">L</td>
    <td colspan="2" bgcolor="#F0F8FF"></td>

    <td width="39" bgcolor="#F0F8FF">Today</td>
    <td width="56" bgcolor="#F0F8FF">up to 1 </br>Week</td>
    <td width="59" bgcolor="#F0F8FF">up to 1 </br>Month</td>
...
<tr>
    ...
    <td bgcolor="#F0F8FF"></td>
    <td bgcolor="#F0F8FF"></td>
    <td width="77" bgcolor="#F0F8FF"></td>
    <td colspan="2" bgcolor="#F0F8FF"></td>
    <td width="33" colspan="2" bgcolor="#F0F8FF"></td>
    </tr>
</table>
</fieldset>
...
<td width="643"><a href="eye_history_test3.php<?php echo URL_APPEND ?>&pid=<?php echo $_GET['pid']?>&mode=new" >Go to previous page</a></td>
</tr>
       </table>
	  </fieldset>
</form>
