...
echo '<ul><form name="mailform" action="intra-email.php" method="post">
    ...
    <tr>
      <td width="20%" bgcolor="#f9f9f9" align=right><FONT size=1 color="#000080">'.$LDFrom.':</td>
	...
	if ($content['attachment']!=''){
    	...
    	$uv = explode('/',$content['attachment']);

		echo '
		    <tr>
		      <td bgcolor="#f9f9f9" align=right><FONT size=1 color="#000080">'.$LDattached.':</td>
		      <td  bgcolor="#f9f9f9"><FONT size=1 >' .
		      		'<a href="./attachments/'.$content['attachment'].'" target="_blank">' .
		      				'<img src="./gui/download.gif" align="absmiddle" border=0> '.
		      				(($uv[1]!='')?$uv[1]:$content['attachment']) .
		      		'</a></td>
		    </tr>';
	}
