...
<form ENCTYPE="multipart/form-data" action="pharmacy_tz_new_product.php" method="get" name="inputform">
	      ...
	      <td align=right width=103><?php echo $LDAdultList; ?></td>
		    ...
		    <option selected value=""></option>
                    ...
                    <option value="minor_proc_op" <?PHP if ($purchasing_class=="minor proc op") echo "selected";?>>minor proc op</option>
                    <option value="obgyne_op" <?PHP if ($purchasing_class=="obgyne op") echo "selected";?>>obgyne op</option>
		    <option value="ortho_op" <?PHP if ($purchasing_class=="ortho op") echo "selected";?>>ortho op</option>
                    <option value="surgical_op" <?PHP if ($purchasing_class=="surgical op") echo "selected";?>>surgical op</option>
