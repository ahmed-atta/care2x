...
$LDOldNr='Old';
$LDAmbulance = 'Ambulance';
$LDFileNr='Hospital file nr';

$LDEyeNr = 'Patient No';
$LDDiabeticNr = 'Diabetic Number';
$LDnhifNr = 'NHIF Number';
$LDhivNr = 'HIV Number';
$LDctcNr = 'CTC Number';
$LDinsuaranceNr = 'Insuarance';
$LDRefferedby = 'Referred by: ';

// added by Dennis Mollel from softweb tech dennis.mollel@yahoo.com
$LDDischargedDate = 'Discharge Date';
$LDDischargedType = 'Discharge Type';
$LDDischargedBy = 'Discharged By';
...
$LDSelectDepartment='-- select Department --';
