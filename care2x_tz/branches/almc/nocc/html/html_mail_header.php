...
if (($content['prev'] != '') && ($content['prev'] != 0))
	$prev = "<a href=\"$PHP_SELF?action=aff_mail&amp;mail=".$content["prev"]."&amp;verbose=".$verbose."&amp;lang=".$lang."&amp;sort=".$sort."&amp;sortdir=".$sortdir."\"><img src=\"themes/".$theme."/img/left_arrow.gif\" alt=\"$alt_prev\" width=\"12\" height=\"12\" border=\"0\"></a>";
