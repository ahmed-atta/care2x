...
//addr_citytown_nr='$addr_citytown_nr',
				if(($update && $sss_nr!='-1' && $nat_id_nr!='-1')) {
...
?>
		...
		function chkform(d) {
			if(d.selian_pid.value==""){
			...
			else if(d.name_middle.value==""){
				alert("<?php echo 'Please Enter Balozi'; ?>");
				d.name_middle.focus();
				return false;
				...
				return false;
			}else if(d.email.value=="-1"){
				alert("<?php echo 'Please select region'; ?>");
				d.email.focus();
				return false;
			}else if(d.sss_nr.value=="-1"){
				alert("<?php echo 'Please select district'; ?>");
				d.sss_nr.focus();
				return false;
			}else if(d.nat_id_nr.value=="-1"){
				alert("<?php echo 'Please select ward'; ?>");
				d.nat_id_nr.focus();
				return false;
			}
...
<?php if (!$person_email_hide){
			...
			<tr>
				<td class="reg_item"><FONT SIZE=-1  FACE="Arial,verdana,sans serif">
				<?php if($errormaiden) { echo '<font color="FF0000">'; } echo '* '.'Region'; ?></td>
				<td  class="reg_input" colspan=1>
