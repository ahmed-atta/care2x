...
if(IS_TANZANIAN)
{
	...
	$SQLStatement = "SELECT id , name FROM care_tz_laboratory_param WHERE group_id = -1 AND status NOT IN ('deleted','hidden') ORDER BY sort_nr";
...
else
{
	...
	$LD_Elements = array('tx_1'=>'Clinical Chem.',
									  ...
									  '_emx_ptt_'=>'PTT',
									  '_beta2_microglobulin_i_s_'=>'�2-�Glob.i.S.',
									  '_cea_'=>'CEA',
									  ...
									  '_primidon_'=>'Primidon',
									  '_beta_2_microglobulin_in_urine_'=>'�2 Mikroglob.i.U.',
									  ...
									  '_alpha_1_microglobulin_'=>'a-1 �globulin',
									 ...
									 '_aminolevulin_in_urine_'=>'Aminol�vulin i.U.',
									 ...
									 '_roeteln_immune_status_'=>'R�t-Immunstat.',
