...
$LDAdminOk='The system admin is now created. Please delete the create_admin.php script from the root path of this application, otherwise Care2x refuses to run.';
