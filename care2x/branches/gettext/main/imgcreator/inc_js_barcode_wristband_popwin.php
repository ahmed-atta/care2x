...
{
	urlholder="barcode-labels.php<?php echo URL_REDIRECT_APPEND."&full_en=".$_SESSION['sess_full_en']; ?>&en="+en;
	bclabel=window.open(urlholder,"bclabel","menubar=no,resizable=yes,scrollbars=yes");
}

function makeWristBands(en)
{
	urlholder="barcode-wristbands.php<?php echo URL_REDIRECT_APPEND."&full_en=".$_SESSION['sess_full_en']; ?>&en="+en;
