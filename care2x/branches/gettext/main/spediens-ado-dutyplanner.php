...
<table width=100% border=0 height=100% cellpadding="0" cellspacing="0">
	...
	<tr valign=top>
		...
		<?php echo createComIcon(CARE_BASE ,'icon_pencil.gif','0') ?>> <?php echo $LDDutyPlanner ?>
		<p>
			...
			<?php echo createComIcon(CARE_BASE ,'l-arrowgrnlrg.gif','0') ?>> <?php echo $LDPrevMonth ?></a></font>
		<b>&nbsp;&nbsp;<?php echo $monat[(int)$month]." ".$year; ?>&nbsp;&nbsp;</b>
		<font size=1><a
			href="spediens-ado-dutyplanner.php?sid=<?php echo "$sid&lang=$lang&month=$month&year=$year" ?>&mondir=1"><?php echo $LDNextMonth ?>
		<img <?php echo createComIcon(CARE_BASE ,'bul_arrowgrnlrg.gif','0') ?>></a></font>
