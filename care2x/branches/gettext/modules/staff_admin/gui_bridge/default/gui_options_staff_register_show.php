...
<!-- 				 <a href="javascript:alert('Function not  available yet');"><?php echo $LDAssignDoctorDept; ?></a>
 -->				 <a href="<?php echo $root_path; ?>modules/doctors/doctors-select-dept.php<?php echo URL_APPEND."&target=plist&nr=$staff_nr&user_origin=staff_admin"; ?>"><?php echo $LDAssignDoctorDept; ?></a>
				   </FONT></TD>
                </TR>
           ...
           <?php Spacer(); ?>
             ...
             <TR bgColor=#eeeeee><td align=center><img <?php echo createComIcon($root_path,'nurse.gif','0') ?>></td>
				...
				<a href="<?php echo $root_path; ?>modules/nursing_or/nursing-or-select-dept.php<?php echo URL_APPEND."&target=plist&nr=$staff_nr&user_origin=staff_admin"; ?>"><?php echo $LDAssignNurseDept; ?></a>
				   </FONT></TD>
                </TR>
           ...
           <?php Spacer(); ?>
			 ...
			 <a href="<?php echo $root_path.'modules/phone_directory/phone_edit.php'.URL_APPEND.'&user_origin=pers&nr='.$staff_nr; ?>"><?php echo $LDAddPhoneInfo ?></a>
				   </FONT></TD>
                </TR>				 
