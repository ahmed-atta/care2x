...
<tr bgcolor="white" >
<td valign="top" class="adm_item">&nbsp;<?php echo $LDstaffNr ?>:
</td>
<td class="adm_input">
...
echo $staff_obj->formattedAddress_DE();
...
<td colspan=2 class="adm_input">&nbsp;<?php if ($create_id) echo $create_id ;  ?> 
    ...
    <td valign="top">
		<?php include('./gui_bridge/default/gui_options_staff_register_show.php'); ?>
	</td>
  </tr>
</table>
<p>
&nbsp;
<a href="<?php echo $updatefile.URL_APPEND.'&staff_nr='.$staff_nr.'&update=1'; ?>"><img <?php echo createLDImgSrc($root_path,'update_data.gif','0','top') ?>></a>
</td>
</tr>
</table>        
<p>
