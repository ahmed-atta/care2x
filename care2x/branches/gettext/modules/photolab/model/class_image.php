...
class Image extends Core{
	...
	* @var string
	*/
	var $def_root_path='uploads/photos/encounter/';
	/**
	...
	*/
	var $fld_image=array('nr',
									...
									'create_time');
	/**
	* Field names of care_encounter_img_diagnostic table
	* @var array
	*/
	...
	*/
	...
	/**
	* Saves all data to care_encounter_img_diagnostic table.
	*
	...
	*/
	function saveImgDiagnosticData(&$data){
	    global $db;
		# set core to care_encounter_img_diagnostic
	...
	*/
	...
	/**
	* Sets the value of max_nr of care_encounter_img_diagnostic table.
	* @access public
	* @param int Primary key number of image record.
