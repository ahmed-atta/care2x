...
$LDStationManTxt='Create a ward, initialize parameters like number of beds, staff, etc.';
...
$LDSearchPrompt='Please enter a search keyword. For example: a name, a Given name, or both, etc.';
$LDSearch='Search';
$LDCancel='Cancel';
...
$LDShowStationDataTxt='Show, edit, create, description, number of beds etc.';
$LDLockBedTxt='or free a bed';
$LDAccessRightsTxt='Create, lock, change,activate, delete, usw.';
...
$LDEnterAllFields ='The fields marked with * must be filled.';
$LDPlsSelect='Please select a department';
$LDStationExists='The ward ~station~ exists already! Please use another wards name.';
...
$LDEditProfile='Edit wards profile';
...
$LDNoListYet='Todays list is not yet created!';
$LDLastList='Last occupancy list.';
$LDNotToday='(Not today!!)';
$LDFromYesterday='(Yesterdays list!!)';
...
$LDShowPatData='Open patients charts folder';
...
$LDSave='Save';
$LDNurse='Nurse';
$LDYesSure='Yes, Im sure. Discharge the patient.';
$LDFtpNoLink='FTP login failed';
$LDJustReleased='The patient was discharged. Click Close to go back to wards occupancy list.';
...
$LDPatDataFolder='Patients charts folder';
...
$LDDocsPrescription='Physicians orders';
...
$LDSFormatPrompt='Enter the new information here or edit the current entries: Maximum 16 characters.';
$LDDosage='Dosage';
...
$LDInsertDate='Insert todays date';
...
$LDSearchFound='Search found ~nr~ patients.';
...
$LDDoctorInfo='Doctors info, instructions';
...
$LDBloodProgram='Blood sample\transfusion';
...
$LDNursesListTxt='List, View, Create, and Edit Nurses List';
/* 2003-04-18 */
...
$LDWardNoClose='The ~str~ ward  cannot be closed because patients are still admitted.You need to discharge all patients from the ward before closing it.';
$LDBackToWardProfile='To go back to wards profile';
$LDShowWardOccupancy='To display the wards occupancy list';
...
$LDRoomShortDescription='Rooms short description';
...
$LDClinic='Clinic';
$LDOwnPatient='This wards patient';
$LDNonOwnPatient='Not this wards patient';
# 2003-08-04 EL
...
$LDTogglePreviewOrig='Click to show in original size';
$LDToggleOrigPreview='Click to show in reduced size';
...
$LDShowMyOvertime='Show when I worked overtime.';
$LDShowMyWorkTime='Show details of my work schedule.';
$LDPlanSched='Plan appointment on this day.';
$LDPlanDuty='Plan duty on this day.';
