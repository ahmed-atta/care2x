...
$smarty->assign('sNewPlan',"<a href=\"nursing-or-main-pass.php".URL_APPEND."&target=dutyplan&dept_nr=$dept_nr&pmonth=$pmonth&pyear=$pyear&retpath=$retpath\" class=\"button icon add\">Add a new Plan</a>");
