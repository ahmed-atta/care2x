...
$thisfile='nursing-ward-patientdata-todo.php';
...
function getinfo(patientID){
	urlholder="nursing-ward.php?<?php echo "sid=$sid&lang=$lang" ?>&route=validroute&patient=" + patientID + "&user=<?php echo $_COOKIE[$local_user.$sid].'"' ?>;
