...
function rx(){
	...
	if ($edit) return 'onClick="javascript:pullRosebar(this)"></a>';
       ...
       /* Now create the first group of color event signaller */
		...
		echo '<td><input type="button" onClick="javascript:enlargewin();window.location.href=\''.$root_path.'modules/photolab/photos-start.php'.URL_REDIRECT_APPEND.'&pn='.$pn.'&station='.$station.'&fileroot='.$fr.'&edit='.$edit.'\'" value="'.$LDPhotos.'"></td></tr></table></td></tr></table>';
