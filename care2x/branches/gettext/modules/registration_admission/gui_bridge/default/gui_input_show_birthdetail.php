...
# Load the template
$smarty->assign('TP_PARENT_ENR',$TP_PARENT_ENR);
$smarty->assign('TP_PENR',$TP_PENR);
$smarty->assign('TP_DELIV_NR',$TP_DELIV_NR);
$smarty->assign('TP_DNR',$TP_DNR);
$smarty->assign('TP_DELIV_PLACE',$TP_DELIV_PLACE);
$smarty->assign('TP_DPLACE',$TP_DPLACE);
$smarty->assign('TP_DELIV_MODE',$TP_DELIV_MODE);
$smarty->assign('TP_DMODE_RADIOS',$TP_DMODE_RADIOS);
$smarty->assign('TP_CES_REASON',$TP_CES_REASON);
$smarty->assign('TP_CREASON',$TP_CREASON);
$smarty->assign('TP_BB_ARRIVAL',$TP_BB_ARRIVAL);
$smarty->assign('TP_BB_AR_YES',$TP_BB_AR_YES);
$smarty->assign('TP_BB_AR_NO',$TP_BB_AR_NO);
$smarty->assign('TP_FACE_PRES',$TP_FACE_PRES);
$smarty->assign('TP_FACE_PRES_YES',$TP_FACE_PRES_YES);
$smarty->assign('TP_FACE_PRES_NO',$TP_FACE_PRES_NO);
$smarty->assign('TP_POS_OCCI',$TP_POS_OCCI);
$smarty->assign('TP_POS_OCCI_YES',$TP_POS_OCCI_YES);
$smarty->assign('TP_POS_OCCI_NO',$TP_POS_OCCI_NO);
$smarty->assign('TP_DELIV_RANK',$TP_DELIV_RANK);
$smarty->assign('TP_DRANK',$TP_DRANK);
$smarty->assign('TP_APGAR1',$TP_APGAR1);
$smarty->assign('TP_APGAR1_RADIOS',$TP_APGAR1_RADIOS);
$smarty->assign('TP_APGAR5',$TP_APGAR5);
$smarty->assign('TP_APGAR5_RADIOS',$TP_APGAR5_RADIOS);
$smarty->assign('TP_APGAR10',$TP_APGAR10);
$smarty->assign('TP_APGAR10_RADIOS',$TP_APGAR10_RADIOS);
$smarty->assign('TP_SPONTANRESP',$TP_SPONTANRESP);
$smarty->assign('TP_SP_RESP',$TP_SP_RESP);
$smarty->assign('LDMinutes',$LDMinutes);
$smarty->assign('TP_CONDITION',$TP_CONDITION);
$smarty->assign('TP_COND',$TP_COND);
$smarty->assign('TP_WEIGHT',$TP_WEIGHT);
$smarty->assign('TP_WT',$TP_WT);
$smarty->assign('TP_LENGTH',$TP_LENGTH);
$smarty->assign('TP_LEN',$TP_LEN);
$smarty->assign('TP_HEAD_CIRC',$TP_HEAD_CIRC);
$smarty->assign('TP_HCIRC',$TP_HCIRC);
$smarty->assign('TP_GEST_AGE',$TP_GEST_AGE);
$smarty->assign('TP_GAGE',$TP_GAGE);
$smarty->assign('TP_FEEDING',$TP_FEEDING);
$smarty->assign('TP_FEED_RADIOS',$TP_FEED_RADIOS);
$smarty->assign('TP_CONG_ABNORM',$TP_CONG_ABNORM);
$smarty->assign('TP_CABNORM',$TP_CABNORM);
$smarty->assign('TP_CLASSIFICATION',$TP_CLASSIFICATION);
$smarty->assign('TP_CLASSIF',$TP_CLASSIF);
$smarty->assign('TP_IMG_ADD',$TP_IMG_ADD);
$smarty->assign('TP_IMG_CLEAR',$TP_IMG_CLEAR);
$smarty->assign('TP_OUTCOME',$TP_OUTCOME);
$smarty->assign('TP_OUT_RADIOS',$TP_OUT_RADIOS);
$smarty->assign('TP_DIS_CAT',$TP_DIS_CAT);
