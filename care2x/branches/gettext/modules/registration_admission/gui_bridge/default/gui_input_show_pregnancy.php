...
# Load the template
$smarty->assign('TP_PREG_NR',$TP_PREG_NR);
$smarty->assign('TP_PNR',$TP_PNR);
$smarty->assign('LDDate',$LDDate);
$smarty->assign('TP_PREGDATE',$TP_PREGDATE);
$smarty->assign('TP_IMG_PDATE',$TP_IMG_PDATE);
$smarty->assign('LDTime',$LDTime);
$smarty->assign('TP_PTIME',$TP_PTIME);
$smarty->assign('TP_GRAVIDA',$TP_GRAVIDA);
$smarty->assign('TP_GRAV',$TP_GRAV);
$smarty->assign('TP_PARA',$TP_PARA);
$smarty->assign('TP_PARA_VAL',$TP_PARA_VAL);
$smarty->assign('TP_GEST_AGE',$TP_GEST_AGE);
$smarty->assign('TP_GAGE',$TP_GAGE);
$smarty->assign('TP_NR_FETUSES',$TP_NR_FETUSES);
$smarty->assign('TP_NFETUS',$TP_NFETUS);
$smarty->assign('TP_CHILD_ENR',$TP_CHILD_ENR);
$smarty->assign('TP_SEPARATE',$TP_SEPARATE);
$smarty->assign('TP_CH_ENR',$TP_CH_ENR);
$smarty->assign('TP_DELIV_MODE',$TP_DELIV_MODE);
$smarty->assign('TP_DMODE_RADIOS',$TP_DMODE_RADIOS);
$smarty->assign('TP_ISBOOKED',$TP_ISBOOKED);
$smarty->assign('TP_ISBOOKED_YES',$TP_ISBOOKED_YES);
$smarty->assign('TP_ISBOOKED_NO',$TP_ISBOOKED_NO);
$smarty->assign('TP_VDRL',$TP_VDRL);
$smarty->assign('TP_VDRL_VAL',$TP_VDRL_VAL);
$smarty->assign('TP_RH',$TP_RH);
$smarty->assign('TP_RH_VAL',$TP_RH_VAL);
$smarty->assign('TP_BPSYS',$TP_BPSYS);
$smarty->assign('TP_BPSYS_VAL',$TP_BPSYS_VAL);
$smarty->assign('TP_BPDIAST',$TP_BPDIAST);
$smarty->assign('TP_BPDIAST_VAL',$TP_BPDIAST_VAL);
$smarty->assign('TP_PROTEINURIA',$TP_PROTEINURIA);
$smarty->assign('TP_PROT_YES',$TP_PROT_YES);
$smarty->assign('TP_PROT_NO',$TP_PROT_NO);
$smarty->assign('TP_LABOUR_DUR',$TP_LABOUR_DUR);
$smarty->assign('TP_LABOUR_VAL',$TP_LABOUR_VAL);
$smarty->assign('TP_INDUCT_METHOD',$TP_INDUCT_METHOD);
$smarty->assign('TP_INDUCT_RADIOS',$TP_INDUCT_RADIOS);
$smarty->assign('TP_INDUCT_INDIC',$TP_INDUCT_INDIC);
$smarty->assign('TP_INDUCT_VAL',$TP_INDUCT_VAL);
$smarty->assign('TP_ANAESTH',$TP_ANAESTH);
$smarty->assign('TP_ANAESTH_RADIOS',$TP_ANAESTH_RADIOS);
$smarty->assign('TP_COMPLICATION',$TP_COMPLICATION);
$smarty->assign('TP_COMPLIC',$TP_COMPLIC);
$smarty->assign('TP_PERINEUM',$TP_PERINEUM);
$smarty->assign('TP_PERINEUM_RADIOS',$TP_PERINEUM_RADIOS);
$smarty->assign('TP_BLOODLOSS',$TP_BLOODLOSS);
$smarty->assign('TP_BLOSS',$TP_BLOSS);
$smarty->assign('TP_BLOSS_OPTIONS',$TP_BLOSS_OPTIONS);
$smarty->assign('TP_RETPLACENTA',$TP_RETPLACENTA);
$smarty->assign('TP_RETPLACENTA_YES',$TP_RETPLACENTA_YES);
$smarty->assign('TP_RETPLACENTA_NO',$TP_RETPLACENTA_NO);
$smarty->assign('TP_POST_LABOUR',$TP_POST_LABOUR);
$smarty->assign('TP_PLABOUR',$TP_PLABOUR);
$smarty->assign('TP_OUTCOME',$TP_OUTCOME);
