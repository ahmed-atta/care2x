...
?>
  ...
  <tr  bgcolor="<?php echo $bgc; ?>"  valign="top">
    ...
    <td><FONT SIZE=-1  FACE="Arial"><?php if($row['staff_nr']) echo $row['staff_nr']; ?></td>
...
<a href="<?php echo $thisfile.URL_APPEND.'&pid='.$_SESSION['sess_pid'].'&target='.$target.'&mode=new&type_nr='.$type_nr; ?>"> 
