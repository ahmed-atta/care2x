...
*/
define('MODULE','insurance_co');
define('LANG_FILE_MODULAR','insurance_co.php');
...
$smarty->assign('pbHelp',CARE_GUI . "modules/" . MODULE . "/help/" . $lang . "/insurance_manage.html"); 
 # href for close button
 $smarty->assign('breakfile',$breakfile);

 # Window bar title
 $smarty->assign('sWindowTitle',"$LDInsuranceCo :: $LDManager");
