...
$LDContactPersonPhoneNr='Contact Persons Phone Nr.';
$LDContactPersonFaxNr='Contact Persons Fax Nr.';
$LDContactPersonEmailAddr='Contact Persons Email Address.';
$LDPlsEnterInfo='Please enter the information';
$LDAlertFirmID='The insurance companys ID is missing!';
$LDAlertFirmName='The insurance companys name is missing!';
...
$LDFirmInfoSaved='The firms data was successfully saved.';
$LDPlsCheckData='Please check the data.';
$LDManager='Manager';
$LDNewDataTxt='Enter new insurance firms data';
$LDListAllTxt='List all available insurance firms';
$LDSearch='Search';
$LDSearchTxt='Search for an insurance firm';
$LDSearchPrompt='Please enter a firms name, ID, or email address';
