...
require_once($root_path.'include/helpers/inc_config_color.php'); // this is important for determining to expand the window
...
<?php if($cfg['dhtml'])
	...
	echo '
			...
			h=650;';
?>
	logbuchwin<?php echo $sid ?>=window.open("op-care-logbuch-xtsuch-start.php?sid=<?php echo "$sid&lang=$lang&dept_nr=$dept_nr";?>&user=<?php echo str_replace(" ","+",$op_pflegelogbuch_user);?>","logbuchwin<?php echo $sid ?>","menubar=no,resizable=yes,scrollbars=yes, width=" + (w-15) + ", height=" + (h-60));
