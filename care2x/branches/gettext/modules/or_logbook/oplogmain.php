...
if(!$datafound)
{
	...
	echo '
			<MAP NAME="catcom">
			<AREA SHAPE="RECT" COORDS="158,90,230,110" HREF="op-care-log-xtsuch-start.php?sid='.$sid.'&lang='.$lang.'&mode=fresh&dept_nr='.$dept_nr.'&saal='.$saal.'&child=1"  target="_parent"  title="'.$LDSearchPatient.' ['.$LDOrLogBook.']" >
...
<?php
		...
		$buffy=str_replace(" ","+",$_SESSION['sess_user_name']); 
		 echo '<img src="'.$root_path.'include/imgcreator/catcom.php?lang='.$lang.'&person='.$buffy.'">';
	}
}
?>
<a name="bot"></a>
