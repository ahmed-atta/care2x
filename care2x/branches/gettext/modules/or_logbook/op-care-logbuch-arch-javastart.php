...
<?php if($cfg['dhtml'])
	...
	echo '
			...
			h=650;';
?>
	logbuchwin=window.open("op-care-logbuch-arch-start.php?sid=<?php echo "$sid&lang=$lang&dept_nr=$dept_nr";?>","archlogbuchwin","menubar=no,resizable=yes,scrollbars=yes, width=" + (w-15) + ", height=" + (h-60));
