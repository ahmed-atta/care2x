...
<b>Achtung!</b>
<ul>Wenn Sie abbrechen m�chten klickt den <img <?php echo createLDImgSrc('../','close2.gif','0') ?>> Knopf an.
</ul>
<?php endif;?>
<?php if($src=="report") : ?>
<p>
...
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Wie kann ich technische Berichte �ffnen zum lesen?</b></font>
<ul> 
		<b>Achtung! </b>Technische Berichte die noch nicht gelesen bzw. nicht gedruckt wurden werden sofort aufgelistet.<p>
<b>Schritt 1: </b>Klickt den  <img src="../img/upArrowGrnLrg.gif" border=0 width=16 height=16 align="absmiddle"> Knopf des Berichts den Sie lesen m�chten. <br>
</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Wie finde ich einen bestimmten Bericht?</b></font>
<ul> <b>Schritt 1: </b>Gibt entweder eine vollst�ndige Information oder deren erste Zeichen in das entsprechende Feld ein.<br>
	<ul type=disc> 
...
<b>Schritt 3: </b>Die Ergebnisse werden aufgelistet. Klickt das Symbol <img src="../img/upArrowGrnLrg.gif" border=0 width=16 height=16 align="absmiddle">  des Berichtes an den Sie �ffnen m�chten. <br>
...
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
Wie komme ich zum Suchen im Archiv zur�ck?</b></font>
<ul> <b>Schritt 1: </b>Klickt den  <input type="button" value="<< Zur�ck"> Knopf an.<p>
</ul>
<?php endif;?>
