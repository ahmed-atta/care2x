...
if (stristr($PHP_SELF, 'inc_passcheck.php')) die('<meta http-equiv="refresh" content="0; url=../">');
/*------end------*/
...
/*if(!isset($db) || !$db || !$dblink_ok) include_once(CARE_BASE .'include/helpers/inc_db_makelink.php');
