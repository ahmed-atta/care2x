{{* login_configu.tpl   Workstation config page after successful login *}}
		...
		<tr>
			<td>
				...
				<tbody class="submenu">
					...
					<tr>
						<td>{{$sWardORIcon}}</td>
						<td><input type="text" name="thispc_room_nr" size=20 maxlength=25 value="{{$sWardORValue}}" disabled></td>
						<td>{{$LDWardOR}}</td>
					</tr>
					
					<tr>
						<td>{{$sPhoneNrIcon}}</td>
						<td><input type="text" name="thispc_phone" size=20 maxlength=25 value="{{$sPhoneNrValue}}" disabled></td>
						<td>{{$LDPhoneNr}}</td>
					</tr>
					
					<tr>
						<td>{{$sIntercomNrIcon}}</td>
						<td><input type="text" name="thispc_intercom" size=20 maxlength=25 value="{{$sIntercomNrValue}}" disabled></td>
						<td>{{$LDIntercomNr}}</td>
					</tr>
