...
//$returnfile="admin_modul_neu_2.php?sid=$sid&lang=$lang&ModulNeuBez=$ModulNeuBez";
...
//echo "Diese Datei heisst <strong>admin_modul_neu_3.php</strong>";										 
...
<INPUT type="image" <?php if($cfg['dhtml'])echo 'img '.createLDImgSrc($root_path,'continue.gif','0').'  class="fadeOut" >';?></a>
