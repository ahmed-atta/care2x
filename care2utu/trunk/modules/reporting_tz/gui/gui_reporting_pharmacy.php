...
$rep_obj->DisplayPharmacyTableHead();
$rep_obj->DisplayPharmacyResultRows($start_timeframe, $end_timeframe);
echo '</table>';
echo '</html></body>';
exit();
}
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">				
                          ...
                          <?php $rep_obj->DisplayPharmacyTableHead();?>
						  <?php $rep_obj->DisplayPharmacyResultRows($start_timeframe, $end_timeframe);?>
                          </table>
				</form>			  
						  <br><br><br>						  
