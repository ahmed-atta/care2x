...
$sql="CREATE TEMPORARY TABLE tmp_laboratory TYPE=HEAP (SELECT
  ...
  care_tz_laboratory_param.id as TestNr,
...
$sql="Select serial_value, add_value,UNIX_TIMESTAMP(create_time) as date from care_test_findings_chemlab ORDER BY create_time DESC";
