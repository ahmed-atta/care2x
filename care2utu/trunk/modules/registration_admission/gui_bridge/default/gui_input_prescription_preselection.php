    	...
    	<table border="0" width="100%" cellpadding="0" cellspacing="0">
    		<tr>
    			...
    			<?php
    				...
    				$categories1 = array('druglist', 'Supplies', 'supplies-lab', 'special-others', 'xray', 'service', 'dental', 'smallop', 'bigop', 'eye-service');
    				$categories2 = array('Drug List', 'Supplies', 'Supplies-Lab', 'Special Others', 'xray', 'service', 'dental', 'smallop', 'bigop', 'eye-service');
    				$categories3 = array('prescription_drugs.gif', 'prescription_supplies.gif', 'prescription_specialsupplies.gif', 'prescription_specialdrugs.gif', 'prescription_xray.gif',  'prescription_service.gif', 'prescription_dental.gif', 'prescription_smallop.gif', 'prescription_bigop.gif', 'eye.gif');
    				$categories4 = array('Drug List', 'Supplies', 'Special Supplies', 'Special Drugs', 'X-Ray', 'Service/Registration', 'Dental Services', 'Minor OP', 'Major OP', 'Eye Clinic');
