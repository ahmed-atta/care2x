...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'Procedures for '.$station; ?></font>
...
<?php
			...
			echo '<tr class="titlebar" bgcolor="#99ccff"><td><font color="#330066">Procedures for '.$prescr_date.'</font></td></tr>';
...
?>
			...
			<TR>
				<TD>
                    ...
                    <td class="submenu_item"><?php echo $LDProcedureName?></td>
                    <td class="submenu_item"><?php echo $LDExtraNotes?></td>
                    <td class="submenu_item"><?php echo $LDProcedureType?></td>
...
//			}
			...
			foreach ($coreObjOuter->result as $rowEncounter){
				...
				$sqlInner = "select * from care_encounter_prescription INNER JOIN care_tz_drugsandservices ON care_tz_drugsandservices.item_id=care_encounter_prescription.article_item_number" .
			                    " where encounter_nr = $encounterNr $crit and purchasing_class='minor_proc_op' or purchasing_class='obgyne_op' or purchasing_class='ortho_op' or purchasing_class='surgical_op'";
				...
				foreach ($coreObjInner->result as $rowPrescr){
					...
					$purchasing_class = $rowPrescr['purchasing_class'];
					$notes = $rowPrescr['notes'];
					$prescr .= $article.'</td><td>'.$purchasing_class.'</td><td>'.$notes;
					$prescr .= '</td></tr>';
