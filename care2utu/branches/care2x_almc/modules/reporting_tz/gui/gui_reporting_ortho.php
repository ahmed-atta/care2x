...
<title>'.$LDOrthoSummary.'</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>';
echo '<html><body>';
?>
<DIV align="center">
	<h1><?php echo $LDOrthoReport; ?><?php echo date('F Y',$start);?></h1>
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
          <td width="250" bgcolor="#99ccff" > &nbsp;&nbsp;<font color="#330066"><?php echo $LDReportingOrtho; ?></font></td>
