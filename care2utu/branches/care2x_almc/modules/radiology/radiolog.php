...
<?php
 ...
 $aSubMenuIcon=array(createComIcon($root_path,'bestell.gif','0'),
										...
										createComIcon($root_path,'torso_win.gif','0'),
...
$aSubMenuItem=array('LDTestRequestRadio' => "<a href=\"".$root_path."modules/laboratory/labor_test_request_pass.php".URL_APPEND."&target=radio&user_origin=lab\">$LDTestRequestRadio</a>",
										...
										'LDPatientResults' => "<a href=\"".$root_path."modules/radiology/radio_datasearch_pass.php".URL_APPEND."&target=admin&subtarget=radio&user_origin=lab\" >$LDPatientResults</a>",
										
										'LDEditResults' => "<a href=\"".$root_path."modules/radiology/radio_datainput_pass.php".URL_APPEND."&target=admin&subtarget=radio&user_origin=lab\" >$LDEditResults</a>",				
