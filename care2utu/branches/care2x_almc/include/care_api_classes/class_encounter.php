	...
	*/
	function OutPatientsBasic($sort="e.encounter_class_nr",$dept_nr=0){
		...
		if($dept_nr) $cond="e.current_dept_nr=$dept_nr AND";
			...
			//$cond='';
		$this->sql="SELECT e.encounter_nr,e.encounter_class_nr, e.encounter_date, e.pid,e.insurance_class_nr,p.selian_pid,p.name_last,p.name_first,p.date_birth,insurance_ID,p.sex, p.photo_filename,
