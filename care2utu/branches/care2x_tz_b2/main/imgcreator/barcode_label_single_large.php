...
*/
		...
		if ($pid<1) $pid = $dec->GetPidFromEncounter($en);

		$fileno = $dec->GetFileNoFromPID($pid);
		# get alergy and blood group
		$spec = explode('|',$dec->_GetAlergy($pid));    # 0=alergy, 1 = blood group, 2 = Rh.
