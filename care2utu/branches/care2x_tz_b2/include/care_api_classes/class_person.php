	...
	*/
	...
	function SearchSelect($searchkey='',$maxcount=100,$offset=0,$oitem='name_last',$odir='ASC',$fname=FALSE){
		...
		if(is_numeric($suchwort)) {
			...
			$sql2="	WHERE pid like '%$suchwort%' OR selian_pid like '%$suchwort%' OR ctc_nr like '%$suchwort%'";
		...
		#print $sql2.'<hr />';
		$this->sql='SELECT pid, selian_pid, name_2, name_first, date_birth, addr_zip, sex, death_date, status,name_last FROM '.$this->buffer.$sql3;
		#echo '<hr />'.$this->sql;
