		...
		<TD><table cellpadding=3 cellspacing=1>
              <tbody class="submenu">
				...
				<td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  ...
                  <td><?php echo 'IPD Admissions Summary Report'; ?></td>
                </tr>
				
				<td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="IPD_admissions.php"><?php echo 'IPD Occupancy Summary'; ?>
                    </a></td>
                  <td><?php echo 'IPD Occupancy Summary Report'; ?></td>
                </tr>
               ...
               <!-- <tr>
                ...
                <tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="ipd_cash_financial.php"><?php echo 'IPD Cash Financial Report'; ?></a></td>
                  <td><?php echo 'Daily Cash Financial Report for IPD'; ?></td>
                </tr>
				
				<tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="opd_cash_financial.php"><?php echo 'OPD Cash Financial Report'; ?></a></td>
                  <td><?php echo 'Daily Cash Financial Report for OPD'; ?></td>
                </tr>

                <tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="cash_billing_summary.php"><?php echo 'Cash Collection Report'; ?></a></td>
                  <td><?php echo 'Daily Cash Collection Report'; ?></td>
                </tr>

				<tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="credit_financial_report.php"><?php echo 'Credit Financial Report'; ?></a></td>
                  <td><?php echo 'Daily Credit Financial Record'; ?></td>
                </tr>

				<tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="credit_financial_summary.php"><?php echo 'Credit Financial Summary'; ?></a></td>
                  <td><?php echo 'Monthly Summary of Credit companies'; ?></td>
                </tr>
                <tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="company_billing_summary.php"><?php echo 'Company Financial Report'; ?></a></td>
                ...
                <tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="reporting_xray.php"><?php echo 'Radiology Revenue Report'; ?></a></td>
                  <td><?php echo 'Monthly Radiology Revenue Report'; ?></td>
                </tr>
                <tr>
				
				<tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="reporting_radiology.php"><?php echo 'Radiology Statistics Report'; ?></a></td>
                  <td><?php echo 'Monthly Radiology Statistics Report'; ?></td>
                </tr>
			...
			<tr>
                ...
                <tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="general_surgery_report.php"><?php echo 'General Surgeries Report'; ?></a></td>
				...
				<tr>
                  <td align=center><img src="../../gui/img/common/default/eyeglass.gif" border=0 width="17" height="17"></td>
                  <td class="submenu_item"><a href="procedures_summary.php"><?php echo 'Orthopedics Surgeries Report'; ?></a></td>
