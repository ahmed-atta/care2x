		...
		<TD><table cellpadding=3 cellspacing=1>
              <tbody class="submenu">
                <TR>
                 ...
                 <td align=center><img src="../../gui/img/common/default/pdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="laboratory.php"><?php echo $LDLaboratorySummary; ?></a></nobr></TD>
					  ...
					  <td align=center><img src="../../gui/img/common/default/pdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="reporting_pharmacy.php"><?php echo $LDPharmacyReport; ?></a></nobr></TD>
                      ...
                      <TR  height=1>
					   ...
					   <td align=center><img src="../../gui/img/common/default/pdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="reporting_dental.php"><?php echo $LDDentalReport; ?></a></nobr></TD>
					  ...
					  <td align=center><img src="../../gui/img/common/default/pdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="financial_reports_pass.php"><?php echo $LDFinReports; ?></a></nobr></TD>
                        <TD><?php echo $LDFinancialReports; ?></TD>
                      </tr>
                      <TR  height=1>
                        <TD colSpan=3 class="vspace"><IMG height=1 src="../../gui/img/common/default/pixel.gif" width=5></TD>
                      </TR>	  
