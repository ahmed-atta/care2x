...
<!--   <tr>
 ...
 <tr>
  ...
  <tr>
	...
	&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path,'redpfeil.gif','0','absmiddle') ?>> <a href="<?php echo $root_path; ?>modules/dept_admin/room.php<?php echo URL_APPEND; ?>&fw=list" target="SYSADMIN_WFRAME"> Room Lists</a>
	</td>
  </tr>
