...
if($is_transmit_to_weberp_enable == 1)
{
  ...
  $weberp_obj->transfer_patient_to_webERP_asCustomer($pid,$persondata);
  $weberp_obj->transfer_bill_to_webERP_asSalesInvoice($pid,$bill_number,$bill_obj->GetElemsOfArchivedBill($bill_number));
