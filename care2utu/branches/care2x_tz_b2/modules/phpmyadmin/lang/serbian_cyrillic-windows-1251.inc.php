<?php
/* $Id: serbian_cyrillic-windows-1251.inc.php,v 1.1 2006/01/13 13:39:38 irroal Exp $ */
...
$strBzError = 'phpMyAdmin није могао да компресује садржај базе због неисправне BZ2 екстензије у овој верзији PHP-а. Препоручује се да подесите <code>$cfg[\'BZipDump\']</code> директиву у вашем phpMyAdmin конфигурационом фајлу на <code>FALSE</code>. Ако желите да користите могућности BZ2 компресије, требало би да пређете на новију верзију PHP-а. Видите PHP извештај о грешкама %s за детаље.';
$strBzip = '"бзип-овано"';
...
$strConfigFileError = 'phpMyAdmin није могао да прочита ваш конфигурациони фајл!<br />Ово се може дестити ако PHP нађе грешку у процесирању или не може да пронађе фајл.<br />Позовите конфигурациони фајл директно користећи доњи линк у прочитајте поруке о грешци које добијате. У већини случајеве негде недостаје наводник или тачка-зарез.<br />Ако добијете празну страну, све је у реду.';
...
$strDumpSaved = 'Садржај базе је сачуван у фајл %s.';
...
$strIgnore = 'Игнориши';
$strIgnoringFile = 'Игноришем фајл %s';
$strImportDocSQL = 'Увоз docSQL фајлова';
$strImportFiles = 'Увоз фајлова';
...
$strInsecureMySQL = 'Ваш конфигурациони фајл садржи подешавања (root без лозинке) која одговарају стандардном MySQL привилегованом налогу. Ваш MySQL сервер ради са овим подешавањима, отворен је за упаде, и заиста треба да исправите овај сигурносни ризик.';
...
$strOverwriteExisting = 'Препиши постојеће фајлове';
...
$strShowPHPInfo = 'Прикажи информације о PHP-u';
