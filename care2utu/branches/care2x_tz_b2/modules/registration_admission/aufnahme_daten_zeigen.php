 ...
 */
 ...
 $smarty = new smarty_care('common');
	...
	($vct[1]==1)? $LDdnr = 'LDRegistryNr'  :  $LDdnr = 'encounter_nr';


# Title in the toolbar
 $smarty->assign('sToolbarTitle',$LDPatientData.' ('.$dnr.')');
 ...
 # Window bar title
 $smarty->assign('title',$LDPatientData.' ('.$dnr.')');
...
$smarty->assign($LDdnr,$LDdnr);
$smarty->assign($LDdnr,$dnr);
...
$smarty->assign('sRoomInput',($vct[8]==2)?$room:$LDNoRooms);
