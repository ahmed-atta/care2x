        ...
        <TR>
          <TD>
            ...
            border=0>
			 ...
			 <a href="<?php echo $root_path ?>modules/laboratory/labor_test_request_pass.php<?php echo URL_APPEND.'&target=generic&subtarget=14&user_origin=amb';  // 14= emergency ambulator department ?>"><?php echo $LDPendingRequest ?></a>
				  </B></FONT></TD>
          ...
          <TD>
            ...
            border=0>
              ...
              <TR bgColor=#eeeeee>  <td align=center><img <?php echo createComIcon($root_path,'waiting.gif','0') ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B>
			 <a href="<?php echo $root_path ?>modules/laboratory/labor_test_request_pass.php?sid=<?php echo $sid.'&lang='.$lang.'&target=generic&subtarget=15&user_origin=amb'; // 15 = general ambulatory department ?>"><?php echo $LDPendingRequest ?></a>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
                  size=2><?php echo $LDPendingRequestTxt ?></FONT></TD></TR>	
          ...
          <TD>
            ...
            border=0>
              ...
              <TR bgColor=#eeeeee>  <td align=center><img <?php echo createComIcon($root_path,'waiting.gif','0') ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B>
			 <a href="<?php echo $root_path ?>modules/laboratory/labor_test_request_pass.php?sid=<?php echo $sid.'&lang='.$lang.'&target=generic&subtarget=17&user_origin=amb'; // 17 = Sonography department ?>"><?php echo $LDPendingRequest ?></a>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
                  size=2><?php echo $LDPendingRequestTxt ?></FONT></TD></TR>
          ...
          <TD>
            ...
            border=0>
              ...
              <TR bgColor=#eeeeee>  <td align=center><img <?php echo createComIcon($root_path,'waiting.gif','0') ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B>
			 <a href="<?php echo $root_path ?>modules/laboratory/labor_test_request_pass.php?sid=<?php echo $sid.'&lang='.$lang.'&target=generic&subtarget=16&user_origin=amb'; // 16 = internal med ambulatory dept ?>"><?php echo $LDPendingRequest ?></a>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
                  size=2><?php echo $LDPendingRequestTxt ?></FONT></TD></TR>
          ...
          <TD>
            ...
            border=0>
              ...
              <TR bgColor=#eeeeee>  <td align=center><img <?php echo createComIcon($root_path,'waiting.gif','0') ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B>
			 <a href="<?php echo $root_path ?>modules/laboratory/labor_test_request_pass.php?sid=<?php echo $sid.'&lang='.$lang.'&target=generic&subtarget=18&user_origin=amb'; // 18 = nuclear diagnostics dept  ?>"><?php echo $LDPendingRequest ?></a>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
                  size=2><?php echo $LDPendingRequestTxt ?></FONT></TD></TR>
