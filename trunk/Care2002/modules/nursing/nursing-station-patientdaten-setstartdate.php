...
{
	window.opener.location.replace("nursing-station-patientdaten-kurve.php?sid=<?php echo $sid ?>&station=<?php echo $station ?>&pn=<?php echo $pn."&tag=\"+d.day.value+\"&kmonat=\"+d.month.value+\"&jahr=\"+d.year.value+\"&tagname=$tagname&dayback=$dayback\")"; ?>;
	window.close();
	return false;
}
