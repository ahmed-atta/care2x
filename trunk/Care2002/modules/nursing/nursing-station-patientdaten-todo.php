...
<td bgcolor="<?php echo $cfg['top_bgcolor']; ?>" height="10" align=right ><nobr><a href="javascript:gethelp('nursing_report.php','','docs','<?php echo $station ?>')"><img <?php echo createLDImgSrc($root_path,'hilfe-r.gif','0') ?>  <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a><a href="<?php echo $breakfile ?>" ><img <?php echo createLDImgSrc($root_path,'close2.gif','0') ?>  <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a></nobr></td>
</tr>
<tr>
...
echo '<font size="6"  >'.$LDDocsPrescription.' <p><font size=2>'.$LDPage.' 1/1
		...
		if($dd_date_range['fe_date']) echo formatDate2Local($dd_date_range['fe_date'],$date_format);
		echo ' <font size=1>'.$LDTo.'</font> ';
		if($dd_date_range['le_date']) echo formatDate2Local($dd_date_range['le_date'],$date_format).' ';
?>
</div></td></tr>
<?php
