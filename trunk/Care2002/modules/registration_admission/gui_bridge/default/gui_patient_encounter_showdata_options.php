...
<?php echo $LDOptsFor.' '.$LDAdmission ?>
</font>
...
<TABLE cellSpacing=0 cellPadding=0 bgColor=#999999 border=0>
          ...
          <TD>
           ...
           <?php Spacer(); ?>
                ...
                <TD vAlign=top ><FONT 
				 ...
				 <a href="show_diagnosis.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&target=<?php echo $target ?>"><?php echo $LDDRG ?></a>
				  </nobr> </FONT></TD>
                </TR>
      ...
      <?php Spacer(); ?>
              ...
              <TR bgColor=#eeeeee><td align=center><img <?php echo createComIcon($root_path,'new_group.gif','0') ?>></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2> <nobr>
				 <a href="show_notes_development.php<?php echo URL_APPEND ?>&pid=<?php echo $pid ?>&target=<?php echo $target ?>&type_nr=21"><?php echo $LDPatientDev.' '.$LDNotes ?></a>
				  </nobr> </FONT></TD>
                </TR>
