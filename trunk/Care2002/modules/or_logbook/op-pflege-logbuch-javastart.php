...
<?php if($cfg['dhtml'])
	...
	echo '
			...
			h=650;';
?>
	logbuchwin=window.open("<?php echo $root_path.$top_dir; ?>op-pflege-logbuch-start.php?sid=<?php echo "$sid&lang=$lang&internok=$internok&dept_nr=$dept_nr"; ?>","logbuchwin<?php echo $sid ?>","menubar=no,resizable=yes,scrollbars=yes, width=" + (w-15) + ", height=" + (h-60));
