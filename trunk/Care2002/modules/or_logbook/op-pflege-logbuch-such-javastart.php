...
<?php if($cfg['dhtml'])
	...
	echo '
			...
			h=650;';
?>
	logbuchwin=window.open("op-pflege-logbuch-xtsuch-start.php?sid=<?php echo "$sid&lang=$lang&dept_nr=$dept_nr";?>&user=<?php echo str_replace(" ","+",$op_pflegelogbuch_user);?>","suchlogbuchwin","menubar=no,resizable=yes,scrollbars=yes, width=" + (w-15) + ", height=" + (h-60));
