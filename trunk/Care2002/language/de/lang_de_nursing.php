...
$LDArchive="Archiv";
$LDStationMan="Stationsverwaltung";
$LDNews="Nachrichten";
$LDMemo="Rundbrief";
...
$LDOptions="Optionen";
$LDFreeBed="Freie Betten";
$LDNoOcc="Keine Stationsbelegung vorhanden!";
$LDClk2Archive="Klick hier zum Archiv";

$LDNrUnocc="Anzahl der freien Betten";
$LDEditStation="Belegung der Station ~station~ bearbeiten";
$LDSearchKeyword="Das Stichwort";
$LDWasFound="wurde in ~rows~ Belegungslisten gefunden!";
$LDPlsClk="Bitte klicken Sie die richtige an.";
$LDMoreFunctions="Weitere Funktionen";
$LDSrcKeyword="Stichwort";
$LDSearchArchive="Auch in Archive suchen.";
$LDSearchPrompt="Bitte ein Stichwort eingeben.<br>	Zum Biespiel: ein Name, oder Vorname, oder beide, u.s.w.";
$LDSearch="Suchen";
$LDCancel="Abbrechen";
$LDHow2Search="Hilfe! Wie kann ich ein Patient finden?";
...
$LDDirectSelect="Direktwahl";
$LDPlusYear="Jahr um 1 rauf";
...
$LDRoom2Nr="Nummer des letzten Zimmers";
$LDRoomPrefix="Vorzeichen der Zimmernummer";
$LDNrBeds="Anzahl der Betten im Zimmer";
$LDMaxBeds="Gesamte Anzahl der Betten";
$LDBed1Prefix="Bettenmarkierung des ersten Bettes";
$LDBed2Prefix="Bettenmarkierung des zweiten Bettes";
...
$LDStationExists="Die Station ~station~ ist bereits vorhanden!";
...
$LDExistStations="Vorhandene Stationen. Bitte die gewünchste Station anklicken.";
...
$LDNoOrigData="Die ursprüngliche Daten sind nicht gefunden!";
...
$LDFtpAttempted="Vervindungsversuch zum FTP server gescheitert.<br>Der Server könnte offline sein oder ist gerade überlastet.
							Falls dieses Problem für längere Zeit besteht, benachrichtigen Sie bitte die EDV";
...
$LDBpTemp="Temperatur/Blutdruck";
$LDPtAtgEtc="KG,ATG,usw";
$LDAntiCoag="Anticoagulant(ien)";
$LDExtraNotes="Angaben";
$LDMedication="Medikament";
$LDIvPort="iv.Zugang";
$LDPtAtgEtcTxt="Krankengymnastik, AT-Therapy, usw.";
$LDExtraNotesTxt="LOT, Charge nr., Material, etc.";
...
$LDPreview="Vorschau";
$LDShotDate="Aufnahmedatum";
$LDShotNr="Bildnummer";

$LDLastName="Name";
$LDName="Vorname";
$LDBirthDate="Geburtsdatum";
$LDLockThisBed="Dieses Bett sperren";
$LDClk2LockBed="Klick um dieses Bett zu sperren";
$LDAssignOcc="Bett belegen";
$LDSearchFound="Die suche hat <font color=red><b>~nr~</b></font> Patienten gefunden. ";
...
$LDDiagnosticTest="Konsilschein";
$LDRelayResult="Ergebnis an	Tel. bzw. Funk";
$LDSpeedCut="Schnellschnitt.";
$LDClk4Phone="Click um Tel/Funknummer zu zeigen";
$LDHour="Uhr";
$LDClkHere="Bitte hier anklicken";

$LDNoOccList="Keine letzte Belegungsliste";
$LDFromWard="von der Station ";
$LDWithinLast="innerhalb der letzten ";
$LDDays=" Tage";
$LDAvailable="vorhanden.";
