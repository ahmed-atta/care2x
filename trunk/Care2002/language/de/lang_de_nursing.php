...
$LDWasFound='wurde in ~rows~ Belegungslisten !';
$LDPlsClk='Bitte klicken Sie die Richtige an.';
$LDMoreFunctions='Weitere Funktionen';
$LDSrcKeyword='Stichwort';
$LDSearchArchive='Auch im Archiv suchen.';
$LDSearchPrompt='Bitte ein Stichwort eingeben.<br>	Zum Biespiel: Name, Vorname, oder Geburtsdatum.';
$LDSearch='Suchen';
$LDCancel='Abbrechen';
...
$LDFtpAttempted='Verbindungsversuch zum FTP server gescheitert.<br>Der Server könnte offline sein oder ist gerade überlastet. Falls dieses Problem für längere Zeit besteht, benachrichtigen Sie bitte die EDV';
...
$LDClk4Phone='Klick um Tel/Funknummer zu zeigen';
$LDHour='Uhr';
...
/* 2002-10-23 EL*/
$LDQueryDoctor='Frage an den Arzt';
...
$LDAnticoagProgram='Antikoagulantien';
