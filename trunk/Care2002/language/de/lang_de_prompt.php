<?php
$LDPlsEnterEndDate='Bitte das Enddatum eingeben';
$LDPlsEnterStartDate='Bitte das Startdatum eingeben';
$LDPlsEnterConfirmDate='Bitte das Feststellungsdatum eingeben';
$LDPlsEnterDiagnosis='Bitte die Diagnose eingeben';
$LDPlsSelectStyle='Bitte einen Druckmuster anklicken';
...
$LDCancelError='Fehler! Die Aufnahme konnte nicht storniert werden.';
$LDTellEdpIfPersist='Bitte benachrichtigen Sie die EDV Abteilung falls das Problem weiterhin besteht.';
$LDPlsFindPersonFirst='Bitte suchen Sie zuerst die Person.';
$LDEnterRelatedInfo='Falls vorhanden, bitte geben Sie Zusatzinformation hier.';
$LDRelatedEncNr='Verw. Fallnummer';
$LDRelatedDocsIds='Kennzeichen von verw. Dokumente';
$LDSeparateComma='Komma zur Trennung';
$LDPlsReadThis='Bitte lesen Sie hier';
# 2003-08-11 EL
