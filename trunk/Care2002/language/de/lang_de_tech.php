...
$LDReRepairTxt="Anforderung an die Technische Abteilung versenden";
$LDRepabotActivate="Repabot aktivieren";
$LDRepabotActivateTxt="Automatischer Empfang der Reparaturarbeitsanforderungen";
$LDRepairReport="Reparatur melden";
$LDRepairReportTxt="Fertige Reparaturarbeiten melden bzw. berichten";
$LDReportsArchive="Bericht - Archiv";
$LDReportsArchiveTxt="Eingegangene Reparaturberichte ansehen, verwalten, u.s.w.";
$LDQuestions="Fragen";
$LDQuestionsTxt="Fragen an die Technische Abteilung stellen";
$LDQBotActivate="Fragebot aktivieren";
$LDQBotActivateTxt="Automatischer Empfang der Fragen";
$LDInfo="Information";
$LDInfoTxt="Technische Information suchen bzw. lesen";
...
$LDPlsTypeReport="Beschreiben Sie hier die Art & Umfang der Reparatur, die Sie gemacht haben.";
$LDJobIdNr="Auftragskennnummer";
$LDTechnician="Techniker";
$LDPlsDoneOnly="(Bitte melden Sie hier nur die Reparaturarbeit an, die erledigt ist.)";
$LDName="Name";
$LDDept="Abteilung";
...
$LDFrom="von";
$LDTo="bis";
$LDAlertQuestion="Sie haben keine Fragen gestellt!";
$LDOn="am";
$LDOClock="Uhr";
$LDInquiry="Frage";
$LDReply="Antwort";
...
$reportindex=array("&nbsp;","&nbsp;","$LDRequest $LDFrom:","Eingegangen am:",$LDAt,"&nbsp;");
$requestindex=array("$LDRequest $LDFrom:",$LDAt,$LDOn,$LDDept,$LDTelephoneNr,$LDJobIdNr);
$queryindex=array("&nbsp;","&nbsp;","$LDInquiry $LDFrom:",$LDDept,"Eingegangen $LDOn:",$LDAt,"&nbsp;");
