...
$LDRemoveFromDb="Retirer de la base de donnée";
$LDDataRemoved="Le produit a été retieré de la base de donnée!";
...
$LDTitleFontBold='Taille de la fonte Titre';
$LDPrefaceFontBold='Lead summary font weight';
$LDDisplayWidth='Nouvelle hauteur d\'affichage (en pixel ou %)';
$LDBold='Gras';
$LDNoteDefault='Note: si vous entrer une valeur incorrecte, le systèmme la remplacera juste par la valeur par défaut.';
$LDUseDefault='Utiliser les valeurs par défaut';
$LDClkPickColor='Cliquer ici pour selectionner la couleur';
#2003-11-11 EL
$LDORAdmin='Administration OR ';
$LDListConfig='Afficher & configurer';
$LDOR='OR';
$LDORNr='Numéro OR';
$LDTempClosed='Est-ce fermé temporairement?';
$LDOwnerWard='Propriétaire de la chambre';
$LDOwnerDept='Propriétaire du départment';
$LDDateCreation='Date de création';
$LDDateClose='Date de cloture';
$LDOPTableNr='Numéro de la table OP';
$LDORName='Nom de la chambre OR';
$LDORNrExists='Ce numéro de chambre OR existe déjà!';
$LDToggle='Basculer';
$LDChange='Changer';
$LDClkNextNr='Cliquer pour utiliser le numéro suivant disponoble';
$LDOPTable='OP table';
?>
