...
$LDSendReport="Envíe Informe";
$LDSendInquiry="Envíe duda";
$LDReset="Borrar";
$LDRepairArea="Localización de la avería";
$LDReporter="Solicitado por";
$LDPersonnelNr="Empleado nr.";
$LDPhoneNr="Nº teléfono.  <font size=1>(Para resolver una duda eventual)</font>";
$LDPlsDescribe="Describa la avería";

$LDAlertName="Por favor introduzca su nombre.";
$LDAlertDept="Por favor introduzca departmento o localización de la avería.";
$LDAlertDeptOnly="Por favor introduzca su departmento.";
$LDAlertPNr="Por favor introduzca número personal";
...
$LDLogIn="Conexión";
$LDPlsNoRequest="(No haga los partes para reparación aquí. Si usted desea avisar de una avería y necesita una reparación haga click aquí.";
...
$LDClk2Read="Púlse en la flecha para leer el contenido.";
...
$LDMarkRead="Marca según lo 'leído'.";
$LDPrint="Imprimir";
$LDGoBack="Atrás";
$LDImRepabot="Soy repabot";
$LDImQBot="Soy Q-Bot";
...
$LDReportArrived="El parte de reparación a sido entregado!";
$LDShowRequest="Mostrar partes";
$LDNoDataFound="No se encontraron datos. Ocurrió un error en el proceso. Pulse el \"Close\" Botón e intente abrir la lista de peticiones de nuevo.  
Si este problema persiste a pesar de varios intentos comuniqueló a informática y al departamento de ayuda de técnica.";
$LDAckPrint="Selecione e imprima";
$LDPrintRequest="Imprimir Parte";
$LDArchiveRequest="Mover parte al archivo";
$LDAckBy="Reconocido por";
$LDAlertEnterName="Incorpore su nombre en el campo \"Acknowledged by\".";
$LDYourReply="Su contestación";
$LDNewInquiry="La qsiguiente es una nueva duda.";
$LDNewInquiryMany="Las siguientes son las dudas llegadas nuevamente .";
$LDClk2Reply="Click la flecha para leer y/o a contestar";
$LDSendReply="Enviar respuesta";
$LDMove2Archive="Mover a archivo";
$LDShow="Ver";
$LDShowInquiry="Ver duda";
$LDInquiryArrived="Una nueva duda a llegado!";
