...
$LDEntryDate='Innlagt dato';

$LDJournalNumber='Journal nummer';

$LDBlockNumber='Antall blokker';
...
$LDSpeedTest='Hasteresultat.';

$LDDiagnosticTest='Forespørsel på diagnosetest';

$LDRelayResult='Videresend diagnose til telefon/personsøker';

$LDSpeedCut='Express cut.';

$LDDate='Dato';

$LDOpDate='Dato for operasjon';
...
$LDForGynTests='For gynekologiske tester:';

$LDLastPeriod='Siste periode:';

$LDPeriodType='Periode type:';

$LDGravidity='Gravida:';

$LDMenopauseSince='Menopause since:';

$LDHormoneTherapy='Hormonbehandling:';

$LDContraceptive='Contraceptive:';

$LDIUD='IUD:';

$LDRepeatedTest='For gjentatt test:';

$LDRepeatedTestPls='Skriv inn tidligere journal nummer med dato';

$LDHysterectomy='Hysterectomy:';

$LDClinicalInfo='Klinisk informasjon';

$LDReqTest='Forespurt diagnose test';

$LDNotesTempReport='Notater / Initielle funn:';

$LDRequestingDoc='Forespurt av lege';

$LDReportingDoc='Rapporterende lege';

$LDXrayNumber='Røntgen Nr.:';
...
$LDPatMobile='Er pasienten mobil(flyttbar?)?';

$LDAllergyKnown='Er alergi kjent?';

$LDHyperthyreosisKnown='Hyperthyreosis known?';

$LDPregnantPossible='Mulig graviditet?';



$LDDiagnosesInquiries='Diagnose / Forespørsler:';

$LDDeptReport='Avdelingen\'s Rapport:';

$LDRequestTo='Forespørsel til';

$LDDepartment='avdeling';

$LDVisitRequested='Besøk forespurt';
...
$LDRequestedTest='Forespurt test';
...
$LDRequestOf='Forespørsel for ';

$LDTelephone='Telefon';

$LDToBloodBank='Til blodbanken';

$LDWithMatchTest='with match test sample(s)';

$LDByBloodBank='fra blodbanken:';



$LDBloodGroup='blodgruppe:';
...
$LDRedBloodCon='Konsentrasjon av røde blodlegemer';
...
$LDPlsSelectPatientFirst='Søk etter pasient først.';
...
$LDPlsEnterPhone='Skriv inn telefon eller personsøker nummer.';

$LDPlsEnterOpDate='Please enter the op date.';

$LDPlsEnterDoctorName='Skriv inn legen\\\'s navn.';



/* 2002-09-08 EL */

$LDPlsEnterBloodGroup='Skriv inn blod gruppe.';
...
$LDPlsEnterDate='Skriv inn dato.';

/* 2002-09-09 EL */

$LDPlsEnterDiagnosisQuiry='Skriv inn diagnose eller forespørsel.';

$LDPlsSelectDept='Velg en avdeling.';

$LDPlsSelectDeptShort='Velg en avdeling';

/* 2002-12-09 EL */

$LDPendingTestRequest='Venter på test forespørsel';

/* 2002-09-13 EL */

$LDPrevRequest='Tidligere forespørsler';

$LDNextRequest='Neste forespørsel';

$LDEnterResult='Skriv inn funn/resultat for denne forespørsel';

$LDPrintOut='Skriv ut skjema';

$LDSaveEntry='Lagre resultat';

/* 2002-09-14 EL */

$LDNoPendingRequest='Det er ingen ventende forespørsler.';

/* 2002-09-15 EL */

$LDTestFindings='Test funn';

$LDCaseNr='Saksnummer';

$LDFamilyName='Etternavn';
...
$LDAddFindings='Tillegsnotat';

$LDXrayDate='Røntgen dato';

$LDPlsEnterTransfusionDate='Skriv inn data for overføring.';
