...
$LDClose='Kapat';
$LDTech='Teknik';
$LDTechRepair='Teknik onarým';
$LDTechMaint='Teknik bakým';
...
$LDRepairReport='Onarýmý rapor et';
$LDRepairReportTxt='Bitmiþ onarým iþlerini rapor et.';
$LDReportsArchive='Rapor arþivi';
...
$LDAt='saat';
$LDAtTech='. Teþekkürler. <i>Teknik destek ekibi.</i>';
$LDRequest='istem';
$LDReport='rapor';
...
$bcatindex=array('&nbsp;','&nbsp;',$LDTechnician,$LDDept,'Alýndýðý tarih',$LDAt,'&nbsp;');
$blistindex=array("Rapor $LDFrom",$LDOn,$LDAt,$LDDept,$LDJobIdNr);
$reportindex=array('&nbsp;','&nbsp;',"$LDRequest $LDFrom:",'Alýndýðý saat:',$LDAt,'&nbsp;');
$requestindex=array("$LDRequest $LDFrom:",$LDAt,$LDOn,$LDDept,$LDTelephoneNr,$LDJobIdNr);
$queryindex=array('&nbsp;','&nbsp;',"$LDInquiry $LDFrom:",$LDDept,'Alýndý $LDOn:',$LDAt,'&nbsp;');
...
$LDShowRequest='Ýstemi göster';
$LDNoDataFound='Hiçbir veri bulunamadý. Bir yerde bir hata oldu. Lütfen [Kapat] düðmesini týklayýn ve istem listesini tekrar açmayý deneyin.
Bu problem birkaç kez denemenize raðmen sürer ise lütfen bilgi iþlem ve teknik destek bölümlerini haberdar ediniz.';
$LDAckPrint='Ýstemi kabul et ve yazdýr';
$LDPrintRequest='Ýstemi yazdýr';
$LDArchiveRequest='Ýstemi arþive gönder';
$LDAckBy='Kabul eden';
$LDAlertEnterName='Lütfen adýnýzý  [Kbul eden] alanýna yazýnýa.';
$LDYourReply='Yanýtýnýz';
$LDNewInquiry='Yeni gelen sorgu aþaðýdadýr.';
$LDNewInquiryMany='Yeni gelen sorgular aþaðýdadýr.';
$LDClk2Reply='Okumak ve/veya yanýtlamak için ok düðmesini týklayýnýz';
$LDSendReply='Yanýt gönder';
$LDMove2Archive='Arþive gönder';
$LDShow='Göster';
...
$LDNoFound='Aranan anahtar kelime ile ilgili hiçbirþey bulamadým. <br>Lütfen tekrar deneyiniz ve daha fazla bilgi giriniz.';
/* 2003-02-11*/
$LDCancel='Ýptal';
?>
