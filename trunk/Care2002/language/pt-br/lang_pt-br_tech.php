...
$LDAt="at";
$LDAtTech=". Obrigado. <i>Seu suporte técnico.</i>";
...
$LDClk2Read="Clique no botão para ler o conteúdo.";
$LDLikeSearch=" isto corresponde a procura da palvra-chave.";
$LDLikeSearchMany=" isto corresponde a procura das palvras-chave.";

$LDTelephoneNr="Nr do fone.";

$bcatindex=array("&nbsp;","&nbsp;",$LDTechnician,$LDDept,"Recebido em",$LDAt,"&nbsp;");
$blistindex=array("Report $LDFrom",$LDOn,$LDAt,$LDDept,$LDJobIdNr);
$reportindex=array("&nbsp;","&nbsp;","$LDRequest $LDFrom:","Recebid às:",$LDAt,"&nbsp;");
$requestindex=array("$LDRequest $LDFrom:",$LDAt,$LDOn,$LDDept,$LDTelephoneNr,$LDJobIdNr);
$queryindex=array("&nbsp;","&nbsp;","$LDInquiry $LDFrom:",$LDDept,"Recebido $LDOn:",$LDAt,"&nbsp;");

$LDMarkRead="Marcar com 'Lido'.";
$LDPrint="Imprimir";
$LDGoBack="Voltar";
$LDImRepabot="Eu sou o repabot";
$LDImQBot="Eu sou o Q-Bot";
$LDNewReport="A seguir está a nova requisiçao chegada para reparo. ";
...
$LDAlertEnterName="Por favor entre com o seu nome no campo\"Reconhecimento de\".";
$LDYourReply="Sua resposta";
$LDNewInquiry="A seguir é uma nova indagação chegada.";
$LDNewInquiryMany="A seguir são as novas indagações chegada";
$LDClk2Reply="Clique no botão para ler e/ou responder";
$LDSendReply="Enviar resposta";
$LDMove2Archive="Mover para arquivo";
$LDShow="Exibir";
$LDShowInquiry="Exibir indagação";
$LDInquiryArrived="Uma nova indagaçaõ chegou!";
$LDSearchWordPrompt="Entre com uma palavra-chave";
$LDInfoCat=array(
						"Requesitando para um reparo",
						"Reportando um dano",
						"Calor",
						"Uso",
						"CPD",
						...
						"Ambiente de gerenciamento, Manutenção",
						"Limpando",
						"Eletricidade",
						"Sistema telefônico",
						"Água, Suprimentos"
