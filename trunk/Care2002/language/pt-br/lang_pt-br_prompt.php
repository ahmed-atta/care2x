<?php
$LDPlsEnterEndDate='Por favor, digite a data final';
$LDPlsEnterStartDate='Por favor, digite a data do início';
$LDPlsEnterConfirmDate='Por favor, digite a data de confirmação';
$LDPlsEnterDiagnosis='Por favor, digite o diagnóstico';
...
$LDPlsEnterPurpose='Por favor, digite o motivo';
$LDAppointNotToday='Este compromisso não está agendado para hoje!';
$LDSureAdmitAppoint='Você tem certeza que deseja admitir este paciente para hoje?';
$LDPatientIsDischarged='Este paciente já recebeu alta';
$LDPersonIsAdmitted='Esta pessoa está atualmente em atendimento';
$LDEncounterClosed='Esta visita está encerrada no momento';
# 2003-08-02 EL
$LDNoOutpatients='Não há pacientes externos no momento.';
$LDGoToAppointments='Por favor, clique aqui para verificar compromissos pendentes.';
