...
$LDSqlDbTxt="Acesso direto SQL. <b>ATENÇÃO</b> somente para usuários avançados";
$LDSysOpLogin="SysOp Login";
$LDSysOpLoginTxt="Login como operador de sistema";
$LDEDP="CPD";
$LDNewAccess="Criar uma nova permissão de acesso";
$LDListActual="Listar atuais permissõs de acesso";
$LDName="Nome";
$LDPassword="Senha";
$LDUserId="Nome do login do usuário";
$LDArea="Área";
