...
?></b>
<form action="install_db_create_mask.php" method="post">
...
<a href="install_db_remove_old_2.php" target="_top"><input type="button" value="<< Go back to previous step"  onClick="javascript:window.location.replace('install_db_remove_old_2.php')"></a> <input type="submit" value="Proceed to next step >>">
