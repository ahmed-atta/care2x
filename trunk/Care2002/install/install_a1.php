...
<font face="Verdana, Arial" color=#000080>I am going to remove the tables except the ICD and OPS tables from an  old database of Care 2002. <p>
Please enter the name of the existing database<p>


<form action="install_db_remove_old_1.php" method="post" onSubmit="return chkDBName(this)">
