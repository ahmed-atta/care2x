...
CREATE TABLE care_appointment (
   ...
   to_dept_nr smallint(5) unsigned NOT NULL,
   to_personell_nr int(11) NOT NULL,
   to_personell_name varchar(60),
   purpose text NOT NULL,
   urgency tinyint(2) unsigned NOT NULL,
   remind tinyint(1) unsigned NOT NULL,
   remind_email tinyint(1) unsigned NOT NULL,
   remind_mail tinyint(1) unsigned NOT NULL,
   remind_phone tinyint(1) unsigned NOT NULL,
   appt_status varchar(35) DEFAULT 'pending' NOT NULL,
   cancel_by varchar(255) NOT NULL,
   cancel_date date,
   cancel_reason varchar(255),
   encounter_class_nr int(1) NOT NULL,
