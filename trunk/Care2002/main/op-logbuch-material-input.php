...
function sendnum(d)
{
	...
	{	window.parent.OPMLISTFRAME.location.replace('op-logbuch-material-list.php?sid=<? print "$ck_sid&lang=$lang&op_nr=$op_nr&dept=$dept&saal=$saal&patnum=$patnum&pday=$pday&pmonth=$pmonth&pyear=$pyear"; ?>&mode=search&material_nr='+d.material_nr.value);
	return false;
	}
}
// -->
