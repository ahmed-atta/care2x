...
$thisfile='pflege-station-patientdaten-doconsil-baclabor.php';
...
{
?>
<a href="<?php echo $thisfile."?sid=$sid&lang=$lang&station=$station&user_origin=$user_origin&status=$status&target=baclabor&subtarget=baclabor&noresize=$noresize"; ?>"><img <?php echo createLDImgSrc('../','newpat2.gif','0') ?>></a>
&nbsp;
<?php
}
