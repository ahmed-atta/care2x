            ...
            border=0>
              ...
              <TR bgColor=#eeeeee>
                <TD vAlign=top width=180><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B>
				<img src="../img/blaupfeil.gif" border=0 width=4 height=7 align="middle"> 
				 <a href="ucons.php<?php echo "?lang=$lang" ?>"><?php echo $LDEnterPrioParams ?>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
              ...
              <TR bgColor=#eeeeee>
                <TD vAlign=top width=180><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B>
				<img src="../img/blaupfeil.gif" border=0 width=4 height=7 align="middle"> 
				 <a href="ucons.php<?php echo "?lang=$lang" ?>"><?php echo $LDEnterNorms ?></a>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
              ...
              <TR bgColor=#eeeeee>
                <TD vAlign=top width=180><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B><nobr>
				<img src="../img/blaupfeil.gif" border=0 width=4 height=7 align="middle">
				<a href="ucons.php<?php echo "?lang=$lang" ?>"><?php echo $LDOtherOptions ?></a></nobr>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
              ...
              <TR bgColor=#eeeeee>
                <TD vAlign=top width=180><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B><nobr>
				<img src="../img/blaupfeil.gif" border=0 width=4 height=7 align="middle">
				<a href="ucons.php<?php echo "?lang=$lang" ?>"><?php echo $LDMemo ?></a></nobr>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
