...
$thisfile='pflege-station-patientdaten-doconsil-blood.php';
		  ...
		  switch($mode)
		  {
				     case 'save':
                                 ...
                                 $sql="INSERT INTO care_test_request_".$db_request_table." 
										   ...
										   '".$HTTP_COOKIE_VARS[$local_user.$sid]."',NULL)";
...
<!--  Black divider line  -->
	<tr bgcolor="<?php echo $bgc1 ?>">
        <td  colspan=3 bgcolor="#000000"><img src="../gui/img/common/default/pixel_blk.gif" border=0 width=745 height=4 align="absmiddle"></td>
	</tr>	
