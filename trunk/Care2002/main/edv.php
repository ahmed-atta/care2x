...
setcookie(ck_edv_mysql_user,"");
setcookie(ck_edv_admin_user,"");
            ...
            border=0>
              ...
              <TR bgColor=#eeeeee><td align=center><img src="../img/lockfolder.gif" border=0 width=16 height=17></td>
                <TD vAlign=top ><FONT 
				 ...
				 <a href="edv-accessplan-pass.php?sid=<? print "$ck_sid&lang=$lang"; ?>"><?=$LDManageAccess ?></a>
				  </nobr></B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
                  size=2><?=$LDManageAccessTxt ?></FONT></TD>
              ...
              <TR bgColor=#eeeeee><td align=center><img src="../img/hfolder.gif" border=0 width=18 height=17></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B> 
   				<a href="edv-main-pass.php?sid=<? print "$ck_sid&lang=$lang"; ?>&target=sqldb"><?=$LDSqlDb ?></a></B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
                  size=2><nobr><?=$LDSqlDbTxt ?></nobr></FONT></TD></TR>
               <TR bgColor=#dddddd height=1>
                <TD colSpan=3><IMG height=1 
                  src="../img/pixel.gif" 
                  width=5></TD></TR>
               ...
               <TR bgColor=#eeeeee><td align=center><img src="../img/pers_tree.gif" border=0 width=16 height=17></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B>
				  <a href="edv-main-pass.php?sid=<? print "$ck_sid&lang=$lang"; ?>&target=adminlogin"><?=$LDSysOpLogin ?></a>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
                  size=2><nobr><?=$LDSysOpLoginTxt ?></nobr></FONT></TD></TR>
              ...
              <TR bgColor=#eeeeee><td align=center><img src="../img/bubble.gif" border=0 width=15 height=14></td>
                <TD vAlign=top ><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B>
				  <a href="newscolumns.php?sid=<?="$ck_sid&lang=$lang&target=edp&title=$LDEDP" ?>"><?=$LDNews ?></a>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
