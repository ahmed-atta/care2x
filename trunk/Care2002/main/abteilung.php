...
<?php if($cfg['dhtml'])echo'<a href="#" onClick=history.back()><img '.createLDImgSrc('../','back2.gif','0').'  style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)></a>';?>
...
echo '<tr bgcolor="#ffffff"><td><font face=verdana,arial size=2><a href="newscolumns.php?sid='.$sid.'&lang='.$lang.'&target='.$target[$i].'&user_origin=dept"> '.$dept[$i].'</a></td>
		<td><font face=verdana,arial size=2><a href="newscolumns.php?sid='.$sid.'&lang='.$lang.'&target='.$target[$i].'&user_origin=dept"><img '.createComIcon('../','info.gif','0').' alt="'.$LDClk4Info.' '.$dept[$i].'."></a></td>		
...
<p>
<a href="javascript:window.history.back()"><img <?php echo createLDImgSrc('../','back2.gif','0') ?>  alt="<?php echo $LDBackTxt ?>" align="absmiddle"></a>
