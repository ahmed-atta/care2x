...
switch($passtag)
{
case 1:$errbuf=$errbuf.$LDWrongEntry; echo '<img src=../img/'.$lang.'/'.$lang.'_cat-fe.gif align=left>';break;
case 2:$errbuf=$errbuf.$LDNoAuth; echo '<img src=../img/'.$lang.'/'.$lang.'_cat-noacc.gif align=left>';break;
default:$errbuf=$errbuf.$LDAuthLocked; echo '<img src=../img/'.$lang.'/'.$lang.'_cat-sperr.gif align=left>'; 
}
