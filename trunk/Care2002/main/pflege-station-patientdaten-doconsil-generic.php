...
$thisfile="pflege-station-patientdaten-doconsil-generic.php";
...
function chkForm(d){
   ...
   if(d.testing_dept.value=='generic')
	{
...
<table border=0>
  <tr>
    ...
    <td valign="bottom"><img src="../img/angle_down_r.gif" border=0 width=51 height=49></td>
  </tr>
</table>
<?php
}
?>
      ...
      <select name="testing_dept" size=1>
       <option value="prompt"><?php echo $LDPlsSelectDeptShort ?></option>
<?php
...
<?php
	...
	<tr bgcolor="<?php echo $bgc1 ?>">
		...
		<img src="../gui/img/common/default/gray_pixel.gif" border=0 width=675 height=120></div><br>
				</td>
		</tr>	
		</table>
