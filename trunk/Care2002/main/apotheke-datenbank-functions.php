...
<?php if($cfg['dhtml'])echo'<a href="javascript:window.history.back()"><img '.createLDImgSrc('../','back2.gif','0').'  style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a><a href="javascript:gethelp('submenu1.php','<?php echo "$LDPharmacy $LDPharmaDb" ?>')"><img <?php echo createLDImgSrc('../','hilfe-r.gif','0') ?>  <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a><a href="<?php echo $breakfile;?>"><img <?php echo createLDImgSrc('../','close2.gif','0') ?> alt="<?php echo $LDClose ?>"  <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a></td>
</tr>
<tr valign=top >
...
{
echo '<img '.createMascot('../','mascot1_r.gif','0','absmiddle').'> ';
$curtime=date("H.i");
            ...
            border=0>
              ...
              <TR bgColor=#eeeeee><td align=center><img <?php echo createComIcon('../','settings_tree.gif','0') ?>></td>
                <TD vAlign=top width=150><FONT 
				 ...
				 <a href="products-datenbank-functions-eingabe.php?sid=<?php echo  "$sid&lang=$lang&userck=$userck" ?>&cat=pharma"><?php echo $LDNewProduct ?></a>
				  </nobr></B></FONT></TD>
              ...
              <TR bgColor=#eeeeee><td align=center><img <?php echo createComIcon('../','eyeglass.gif','0') ?>></td>
                <TD vAlign=top width=150><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B> 
   				<a href="products-datenbank-functions-such.php?sid=<?php echo  "$sid&lang=$lang&userck=$userck" ?>&cat=pharma"><?php echo $LDSearch ?></a></B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
              ...
              <TR bgColor=#eeeeee><td align=center><img <?php echo createComIcon('../','discussions.gif','0') ?>></td>
                <TD vAlign=top width=150><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B>
				<a href="products-datenbank-functions-manage.php?sid=<?php echo  "$sid&lang=$lang&userck=$userck" ?>&cat=pharma"><nobr><?php echo $LDManage ?></nobr></a>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
			 ...
			 <nobr><a href="ucons.php<?php echo "?lang=$lang" ?>"><?php echo $LDInfo ?></a></nobr>
              ...
              <TR bgColor=#eeeeee> <td align=center><img <?php echo createComIcon('../','icn_rad.gif','0') ?>></td>
                <TD vAlign=top width=150><FONT 
                  face="Verdana,Helvetica,Arial" size=2><B><nobr>
				<a href="ucons.php<?php echo "?lang=$lang" ?>"><?php echo $LDReports ?></a></nobr>
				  </B></FONT></TD>
                <TD><FONT face="Verdana,Helvetica,Arial" 
