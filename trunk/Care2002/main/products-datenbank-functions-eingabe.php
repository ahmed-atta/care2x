...
<?php if($cfg['dhtml'])echo'<a href="javascript:window.history.back()"><img '.createLDImgSrc('../','back2.gif','0').'  style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a><a href="javascript:gethelp('products_db.php','input','<?php echo $mode ?>','<?php echo $cat ?>')"><img <?php echo createLDImgSrc('../','hilfe-r.gif','0') ?>  <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a><a href="<?php echo $breakfile;?>"><img <?php echo createLDImgSrc('../','close2.gif','0') ?> alt="<?php echo $LDClose ?>"  <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a></td>
</tr>
<tr valign=top >
...
<img <?php echo createMascot('../','mascot1_r.gif','0','absmiddle') ?>> <?php echo $LDOrderNrExists ?>
<?php endif ?>
...
<a href="<?php echo $breakfile ?>"><img <?php if($saveok) echo createLDImgSrc('../','close2.gif','0','left') ; else echo createLDImgSrc('../','cancel.gif','0','left') ; ?> alt="<?php echo $LDBack2Menu ?>"></a>
 	</td>
	 </tr>
 	</table>
</FONT>
