...
require("../include/inc_passcheck_f2f.php"); // loads the validarea and logentry functions
...
<p>
<img <?php echo createComIcon('../','small_help.gif','0') ?>> <a href="ucons.php<?php echo "?lang=$lang" ?>">Was ist der Bestellbot?.</a><br>
<img <?php echo createComIcon('../','small_help.gif','0') ?>> <a href="ucons.php<?php echo "?lang=$lang" ?>">Was kann der Bestellbot?</a><br>
<HR>
<p>

<?php
// write the copyright thing
require("../include/inc_copyrite.php");
 ?>
