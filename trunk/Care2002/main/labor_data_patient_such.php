...
<img <?php echo createComIcon('../','micros.gif','0','absmiddle') ?>><FONT  COLOR="<?php echo $cfg[top_txtcolor] ?>"  SIZE=5  FACE="verdana"> <b><?php echo "$LDMedLab - "; if($mode=="edit") echo "$LDNewData"; else echo "$LDSeeData"; ?></b></font>
<table width=100% border=0 cellpadding="0" cellspacing="0">
<tr>
<td colspan=3><img <?php echo createLDImgSrc('../','such-b.gif') ?>></td>
</tr>
<tr >
...
<a href="javascript:gethelp('lab.php','search','<?php echo $mode ?>','<?php echo $linecount ?>','<?php echo $datafound ?>')"><img <?php echo createLDImgSrc('../','hilfe-r.gif','0') ?>></a>
</FORM>
<p>
<?php 
			...
			echo "<table border=0 cellpadding=3 cellspacing=1> <tr bgcolor=#9f9f9f>";
					...
					while($zeile=mysql_fetch_array($ergebnis))
					{
						...
						*/
						...
						<img 	'.createComIcon('../','update2.gif','0','absmiddle').' alt="'.$LDEnterData.'">';
						}
						else
						{
						   echo'
							...
							<img '.createComIcon('../','update2.gif','0','absmiddle').' alt="'.$LDClk2See.'">';
						}
					...
					if($linecount>15)
					{
						...
						<INPUT type="image"  '.createLDImgSrc('../','searchlamp.gif','0','absmiddle').'></font></FORM>
						<p>';
					}
}
