<?  if (($username=="bong")&&($keyword=="bobong")) {header("Location: op-doku-start.php"); exit;}
			else {$passtag="wrong";};
?>
...
<hr>
<p>
<img src="../img/varrow.gif" width="20" height="15"> <a href="ucons.php">Einführung in das OP Logbuch</a><br>
<img src="../img/varrow.gif" width="20" height="15"> <a href="ucons.php">Wie mache ich was mit OP Logbuch?</a><br>
<HR>
