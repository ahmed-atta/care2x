...
if($retpath=="calendar_opt") 
 {
	$append="?sid=$sid&lang=$lang&dept_nr=$dept_nr&retpath=$retpath&pday=$pday&pmonth=$pmonth&pyear=$pyear"; 
	$breakfile="calendar-options.php?sid=$sid&lang=$lang&dept_nr=$dept_nr&retpath=$retpath&day=$pday&month=$pmonth&year=$pyear";
 }
 	 else 
	 {
		$append=URL_APPEND; 
