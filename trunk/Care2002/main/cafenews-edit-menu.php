	 ...
	 switch($mode)
	 {
	 	case 'save':
				...
				if($ergebnis=mysql_query($sql,$link))
       				{
					    if(!$update) $item=mysql_insert_id($link);
...
<img <?php echo createComIcon('../','basket.gif','0') ?>><b><?php echo $LDCafeMenu ?></b></FONT>
...
<?php for ($i=0,$acttag=$day,$dyidx=$daytag-1;$i<7;$i++,$acttag++,$dyidx++)
	...
	echo '<a href="';
	if($spot) echo "#\""; else echo 'cafenews-edit-menu.php?sid='.$sid.'&lang='.$lang.'&week='.$week.'&myear='.$year.'&mmonth='.$month.'&mday='.$acttag.'" ';
...
if($mode=="saveok") {
?>
<img <?php echo createMascot('../','mascot1_r.gif','0','bottom') ?> align="absmiddle"><FONT  SIZE=4  FACE="verdana,Arial" color="#990000"><?php echo $LDMenuSaved ?></font>
<?php
}
?>
...
<table border=0 cellspacing=0>
 ...
 <tr>
	...
	<a href="cafenews-edit-menu-select-week.php?sid=<?php echo $sid ?>&lang=<?php echo $lang ?>"><img <?php echo createLDImgSrc('../','back2.gif','0') ?>></a>
