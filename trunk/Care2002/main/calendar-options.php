...
<li><a href="op-pflege-dienstplan-day.php?sid=<?php echo "$sid&lang=$lang&pday=$day&pmonth=$month&pyear=$year" ?>&retpath=calendar_opt"><?php echo "$LDDutyPerson $LDOn (".formatDate2Local($i_date,$date_format).")" ?></a></li>
...
<li><a href="#"><?php echo "$LDDocsOnDuty (".formatDate2Local($i_date,$date_format).")" ?></a></li>
	<?php if($year.$month.$day==date("Ymd"))
		...
		<li><a href="op-pflege-logbuch-pass.php?target=entry&sid=';
			echo "$sid&lang=$lang&pday=$day&pmonth=$month&pyear=$year&dept=$dept";
...
<p><br>
<a href="javascript:window.close()"><img <?php echo createLDImgSrc('../','close2.gif','0','absmiddle') ?> onClick="window.opener.focus()"></a>
</body>
</html>
