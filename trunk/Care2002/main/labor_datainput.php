...
<?php if($saved) echo '<img '.createLDImgSrc('../','close2.gif','0').'>';
else echo '<img  '.createLDImgSrc('../','cancel.gif','0').'>'; ?>
</a>
</td>
</tr>
</table>
...
<FONT SIZE=-1  FACE="Arial">&nbsp;<input  type="image" <?php echo createLDImgSrc('../','auswahl2.gif','0') ?>>
</td>
</tr>
</tr>
...
<tr>
<td valign=top><a href="Javascript:gethelp('lab.php','input','param')"><img <?php echo createComIcon('../','small_help.gif','0') ?>></a></td>
<td><FONT SIZE=1  FACE="Arial"><?php echo $LDParamNoSee ?></td>
</tr>
<tr>
<td valign=top><a href="Javascript:gethelp('lab.php','input','few')"><img <?php echo createComIcon('../','small_help.gif','0') ?>></a></td>
<td><FONT SIZE=1  FACE="Arial"><?php echo $LDOnlyPair ?></td>
</tr>
<tr>
<td valign=top><a href="Javascript:gethelp('lab.php','input','save')"><img <?php echo createComIcon('../','small_help.gif','0') ?>></a></td>
<td><FONT SIZE=1  FACE="Arial"><?php echo $LDHow2Save ?></td>
</tr>
<tr>
<td valign=top><a href="Javascript:gethelp('lab.php','input','correct')"><img <?php echo createComIcon('../','small_help.gif','0') ?>></a></td>
<td><FONT SIZE=1  FACE="Arial"><?php echo $LDWrongValueHow ?></td>
</tr>
<tr>
<td valign=top><a href="Javascript:gethelp('lab.php','input','note')"><img <?php echo createComIcon('../','small_help.gif','0') ?>></a></td>
<td><FONT SIZE=1  FACE="Arial"><?php echo $LDVal2Note ?></td>
</tr>
<tr>
<td valign=top><a href="Javascript:gethelp('lab.php','input','done')"><img <?php echo createComIcon('../','small_help.gif','0') ?>></a></td>
