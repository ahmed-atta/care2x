...
<?php if(($mode!="")) : ?>
    ...
    <frame name="LOGINPUT"  src="<?php echo "oploginput.php?sid=$sid&lang=$lang&internok=$internok&mode=$mode&patnum=$patnum&op_nr=$op_nr&dept=$dept&saal=$saal&pyear=$pyear&pmonth=$pmonth&pday=$pday";?>">
  </frameset>
  <frameset cols="15%,*">
