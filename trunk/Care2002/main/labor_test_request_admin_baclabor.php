...
require_once('../include/inc_test_request_vars_baclabor.php'); ///* load variable elements */
...
{	
	 ...
	 if(!isset($mode))   $mode="";
		  ...
		  {
		                $sql="SELECT batch_nr,patnum,send_date,dept FROM care_test_request_".$db_request_table." 
