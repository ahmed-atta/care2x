...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Alle Dokumente von Patienten mit bestimmten weiteren Angaben über die Krankenkasse zeigen</b></font>
<ul> <b>Schritt 1: </b>Geben Sie die Angaben in das Feld "weitere Angaben:" ein. <br>
		<b>Schritt 2: </b>Lassen Sie die andere Eingabefelder leer.<br>
		<b>Schritt 3: </b>Den <input type="button" value="SUCHEN">  anklicken um die Suche zu starten.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Alle Dokumente aller männlichen Patienten zeigen </b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Alle Dokumente aller Patienten mit Aufklärung zeigen </b></font>
<ul> <b>Schritt 1: </b>Den radio button  "Aufklärung <input type="radio" name="r" value="1">Ja" anklicken. <br>
		<b>Schritt 2: </b>Lassen Sie die andere Eingabefelder leer.<br>
		<b>Schritt 3: </b>Den <input type="button" value="SUCHEN">  anklicken um die Suche zu starten.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Alle Dokumente aller  Patienten OHNE Aufklärung zeigen </b></font>
