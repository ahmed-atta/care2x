...
<ul> <b>Schritt 1: </b>Den <img src="../img/plus2.gif" border=0> Knopf der Zimmernummer und Bett anklicken.
		...
		<b>Schritt 4: </b>Den <img src="../img/de/de_searchlamp.gif" border=0> Knopf anklicken.<br>
...
<ul> <b>Schritt 1: </b>Klickt den <img src="../img/bestell.gif" width=16 height=16 border=0> Knopf des Patienten.
                                                                     <br>
		...
		"<input type="checkbox" name="g" ><span style="background-color:yellow" > Ja, ich bin sicher. Ich möchte den Patient entlassen.</span>" an um ihn zu aktivieren.<br>
       	...
       	<b>Achtung! </b>Wenn Sie abbrechen möchten klickt den <img src="../img/de/de_cancel.gif"> Knopf an und der Patient wird nicht entlassen.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
Wie sperre ich ein Bett?</b></font>
<ul> <b>Schritt 1: </b>Klickt den <img src="../img/plus2.gif" border=0> Knopf des zu sperrenden Bettes.
                                                                     <br>
		...
		<b>Schritt 3: </b>Klickt den "<span style="background-color:yellow" > <img src="../img/delete2.gif" border=0 align="absmiddle"> <font color="#0000ff">Dieses Bett sperren</font> </span>" an.<br>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Was bedeuten diese  <img src="../img/s_colorbar.gif" border=0> Farbbalken? </b></font>
<ul> <b>Achtung! </b>
...
<img src="../img/frage.gif" border=0 align="absmiddle">
 <font color="#990000"><b>Was bedeutet dieses Symbol <img src="../img/patdata.gif" border=0> ? </b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> 
<font color="#990000"><b>Was bedeutet dieses Symbol <img src="../img/bubble2.gif" border=0> ? </b></font>
<ul> <b>Achtung! </b>Dies ist das Vermerk. Wenn es angeklickt wird öffnet sich ein kleines Fenster mit einem Eingabefeld für Vermerke oder Notizen über den Patient.<br>
			Das normal Symbol <img src="../img/bubble2.gif" border=0> bedeutet daß es noch kein Vermerk beinhaltet. Um ein Vermerk zu schreiben klickt dieses Symbol an.<br>
			Das andere Symbol <img src="../img/bubble3.gif" border=0> bedeutet daß es Vermerk beinhaltet. Um den Vermerk zu lesen bzw. zu ergänzen klickt dieses Symbol an.
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle">
...
<ul> <b>Schritt 1: </b>Den <img src="../img/plus2.gif" border=0> Knopf des Bettes anklicken.
                                                                     <br>
		<b>Schritt 2: </b>Ein kleines Fenster zum Suchen von Patienten öffnet sich.<br>
		<b>Schritt 3: </b>Suche zuerst den Patient. Geben Sie die Information in das entsprechende Eingabefeld ein wie folgt:<br>
		Wenn Sie den patient suchen...<ul type="disc">
...
<ul>
		...
		<b>Schritt 2: </b>Den <img src="../img/de/de_searchlamp.gif" border=0> Knopf anklicken.<br>
		<b>Schritt 3: </b>Wenn die Suche ein Ergebnis bzw. mehrere Ergebnisse liefert wird eine Liste gezeigt.<br>
		<b>Schritt 4: </b>Um den richtigen Patient auszuwählen klickt den nebensteheden &nbsp;<button><img src="../img/post_discussion.gif" width=20 height=20 border=0></button> Knopf an.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
Wie sperre ich ein Bett??</b></font>
<ul>
		<b>Schritt 1: </b>Klickt den "<span style="background-color:yellow" > <img src="../img/delete2.gif" border=0 align="absmiddle"> <font color="#0000ff">Dieses Bett sperren</font> </span>" an.<br>
...
<ul> <b>Schritt 1: </b>Wählen Sie die Art der Entlassung. Klickt die entsprechende Auswahl an.<br>
	<ul><br>
		...
		<b>Schritt 6: </b>Klickt den <img src="../img/de/de_close2.gif" border=0 align="absmiddle"> Knopf um in die Belegungsliste zurück zu gehen.<p>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
