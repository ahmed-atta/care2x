...
<ul> 
	...
	<b>Adım 4: </b>Ad doyad ilk harflerinizi "<span style="background-color:yellow" > İmza: <input type="text" name="d" size=3 maxlength=3 value="ela"> </span>" alanına giriniz.<br>
...
<ul> 
	...
	<b>Adım 3: </b>Ad soyadınızın ilk harflerini "<span style="background-color:yellow" > İmza: <input type="text" name="d" size=3 maxlength=3 value="ela"> </span>" alanına giriniz.<br>
