...
<?php if($src=="select") : ?>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Ho bisogno di aggiornare i dati visualizzati</b></font>
<ul> Selezionare il bottone <input type="button" value="Modifica dati"> per iniziare le modifiche.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Voglio effettuare una nuova ricerca in archivio</b></font>
...
Per visualizzare le informazioni sul paziente che si sta cercando, premere o il bottone <img src="../img/R_arrowGrnSm.gif" border=0 height=12 border=0> corrispondente, 
...
<?php else : ?>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Mi serve la lista dei pazienti accettati oggi</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Mi serve la lista dei pazienti accettati in un certo arco di tempo</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Ho bisogno della lista di tutti i pazienti maschi accettati</b></font>
<ul> <b>1: </b>Selezionare 'maschio' nel campo "Sesso <input type="radio" name="r" value="1">". <br>
		<b>2: </b>Lasciare gli altri campi vuoti.<br>
		<b>3: </b>Selezionare il bottone <input type="button" value="Cerca">  per iniziare la ricerca.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Ho bisogno della lista di tutti i pazienti femmine accettati</b></font>
<ul> <b>1: </b>Selezionare 'femmina' nel campo "Sesso <input type="radio" name="r" value="1">". <br>
		<b>2: </b>Lasciare gli altri campi vuoti.<br>
		<b>3: </b>Selezionare il bottone <input type="button" value="Cerca">  per iniziare la ricerca.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Mi serve la lista dei pazienti accettati deambulanti</b></font>
<ul> <b>1: </b>Selezionare il campo "<input type="radio" name="r" value="1">Deambulante". <br>
		<b>2: </b>Lasciare gli altri campi vuoti.<br>
		<b>3: </b>Selezionare il bottone <input type="button" value="Cerca">  per iniziare la ricerca.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Mi serve la lista dei pazienti accettati non deambulanti</b></font>
<ul> <b>1: </b>Selezionare il campo "<input type="radio" name="r" value="1">Non deambulante". <br>
		<b>2: </b>Lasciare gli altri campi vuoti.<br>
		<b>3: </b>Selezionare il bottone <input type="button" value="Cerca">  per iniziare la ricerca.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Voglio la lista di tutti i pazienti che sostengono da soli le spese</b></font>
<ul> <b>1: </b>Selezionare il campo "<input type="radio" name="r" value="1">Proprio carico". <br>
		<b>2: </b>Lasciare gli altri campi vuoti.<br>
		<b>3: </b>Selezionare il bottone <input type="button" value="Cerca">  per iniziare la ricerca.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Voglio la lista dei pazienti con assicurazione privata</b></font>
<ul> <b>1: </b>Selezionare il campo "<input type="radio" name="r" value="1">Ass. privata". <br>
		<b>2: </b>Lasciare gli altri campi vuoti.<br>
		<b>3: </b>Selezionare il bottone <input type="button" value="Cerca">  per iniziare la ricerca.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Voglio la lista di tutti i pazienti mutuati</b></font>
<ul> <b>1: </b>Selezionare il campo "<input type="radio" name="r" value="1">Mutuato". <br>
		<b>2: </b>Lasciare gli altri campi vuoti.<br>
		<b>3: </b>Selezionare il bottone <input type="button" value="Cerca">  per iniziare la ricerca.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Mi serve la lista dei pazienti assicurati con una certa compagnia</b></font>
<ul> <b>1: </b>Inserire l'acronimo della compagnia assicurativa nel campo "Assicurazione". <br>
		<b>2: </b>Lasciare gli altri campi vuoti.<br>
		<b>3: </b>Selezionare il bottone <input type="button" value="Cerca">  per iniziare la ricerca.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Mi occorre la lista dei pazienti in base ad una certa parola chiave</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>Sto cercando un certo paziente tramite una parola chiave</b></font>
<ul> <b>1: </b>Inserire la parola chiave nel campo corrispondente. Non è necessario sia una parola intera, bastano poche lettere. <br>
		<ul><font size=1 color="#000099" >
