...
<ul> <b>Step 1: </b>Click on the chart area corresponding to the chosen date.<br>
		...
		<b>Step 5: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the newly entered data.<br>
...
<ul> 
	...
	<b>Step 1: </b>Click on the <img src="../img/l_arrowGrnSm.gif" width=12 height=12 border=0> icon on the <span style="background-color:yellow" >leftmost</span> date column of the chart.<p>
	<li><font color="#660000"><b>To move the date one day forward:</b></font><br>
	<b>Step 1: </b>Click on the <img src="../img/bul_arrowGrnSm.gif" width=12 height=12 border=0> icon on the <span style="background-color:yellow" >rightmost</span> date column of the chart.
                                                                     <p>
	<li><font color="#660000"><b>To directly set the chart's starting date:</b></font><br>
	<b>Step 1: </b>Click the <span style="background-color:yellow" >right mouse button</span> on the <img src="../img/l_arrowGrnSm.gif" width=12 height=12 border=0> icon on the <span style="background-color:yellow" >leftmost</span> date column of the chart.<br>
	...
	<b>Step 1: </b>Click the <span style="background-color:yellow" >right mouse button</span> on the <img src="../img/bul_arrowGrnSm.gif" width=12 height=12 border=0> icon on the <span style="background-color:yellow" >rightmost</span> date column of the chart.<br>
	<b>Step 2: </b>Click <input type="button" value="OK"> when asked for confirmation.<br>
...
<ul> <b>Step 1: </b>Click on the "<span style="background-color:yellow" > Diet plan </span>" corresponding to the chosen date.<br>
		...
		<b>Step 4: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the newly entered diet plan.<br>
  		<b>Note: </b>If you want to cancel, click the button <img src="../img/en/en_cancel.gif" border=0 align="absmiddle">.<br>
...
<ul> 
	<b>Step 1: </b>Click the <img src="../img/clip.gif" width=20 height=10 border=0> (clip) icon on the "<span style="background-color:yellow" > Allergy <img src="../img/clip.gif" width=20 height=10 border=0> </span>".<br>
	...
	<b>Step 3: </b>Type the allergy or CAVE information in the<br> "<span style="background-color:yellow" > Please enter new information here: </span>" field.<br>
  		...
  		<b>Note: </b>If you want to cancel, click the button <img src="../img/en/en_cancel.gif" border=0 align="absmiddle">.<br>
		<b>Step 4: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the information.<br>
...
<ul> 
	<b>Step 1: </b>Click the <img src="../img/clip.gif" width=20 height=10 border=0> (clip) icon on the "<span style="background-color:yellow" > Diagnosis/Therapy <img src="../img/clip.gif" width=20 height=10 border=0> </span>".<br>
...
<ul> 
	<b>Step 1: </b>Click the <img src="../img/clip.gif" width=20 height=10 border=0> (clip) icon on the "<span style="background-color:yellow" > Notes, extra diagnoses <img src="../img/clip.gif" width=20 height=10 border=0> </span>".<br>
...
<ul> 
	<b>Step 1: </b>Click the <img src="../img/clip.gif" width=20 height=10 border=0> (clip) icon on the "<span style="background-color:yellow" > Anticoagulants <img src="../img/clip.gif" width=20 height=10 border=0> </span>".<br>
...
<ul> 
	<b>Step 1: </b>Click the <img src="../img/clip.gif" width=20 height=10 border=0> (clip) icon on the "<span style="background-color:yellow" > Notes <img src="../img/clip.gif" width=20 height=10 border=0> </span>".<br>
...
<ul> 
	...
	<b>Step 6: </b>Enter your name in the "<span style="background-color:yellow" > Nurse: </span>" field.<br> 
  		<b>Note: </b>If you want to cancel, click the button <img src="../img/en/en_cancel.gif" border=0 align="absmiddle">.<br>
		<b>Step 7: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the medication plan.<br>
		...
		<b>Step 9: </b>If you are finished, click the button <img src="../img/en/en_close2.gif" border=0> to close the window and go back to the chart.<br>
		<font color="#000099" size=1><a href="#howto"><img src="../img/arrow-t.gif" width=12 height=12 border=0> Back to "How to...?"</a></font>
</ul>
...
<ul> 
	...
	<b>Step 4: </b>Type either the dosage, applicator information, or start/end symbols in the field.<br>
		...
		<b>Step 6: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the information.<br>
		...
		<b>Step 8: </b>If you are finished, click the button <img src="../img/en/en_close2.gif" border=0> to close the window and go back to the chart.<br>
		<font color="#000099" size=1><a href="#howto"><img src="../img/arrow-t.gif" width=12 height=12 border=0> Back to "How to...?"</a></font>
</ul>
