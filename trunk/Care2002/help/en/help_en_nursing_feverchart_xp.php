...
<ul> <b>Step 1: </b>Enter the time and data.<br>
		...
		<b>Step 3: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the newly entered data.<br>
...
<ul> <b>Step 1: </b>Enter the diet plan in the<br> "<span style="background-color:yellow" > Enter the new information here or edit the current entries </span>" field.<br>
		<b>Step 2: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the new diet plan.<br>
