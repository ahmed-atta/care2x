...
<ul>       	
 	...
 	<b>Step 2: </b>To save the document, click the button <img src="../img/<?="$lang/$lang" ?>_savedisc.gif"  border=0> .<br> 
	</ul>
...
<ul>       	
 	...
 	<b>Step 2: </b>Click the button <img src="../img/<?="$lang/$lang" ?>_searchlamp.gif"  border=0> to start searching for the patient.<p> 
<ul>       	
	...
	operation in their correspondings fields.<br> 
 	<b>Step 4: </b>To save the document, click the button <img src="../img/<?="$lang/$lang" ?>_savedisc.gif"  border=0> .<br> 
	</ul>
	<? endif ?>
<? endif ?>
...
<ul>       	
 	<b>Step 1: </b>Enter in the "<span style="background-color:yellow" > Search keyword: eg. name or family name <input type="text" name="m" size=20 maxlength=20> </span>" field either a
		complete information or the first few letters of the patient's family name or given name. <br>
 	<b>Step 2: </b>Click the button <img src="../img/<?="$lang/$lang" ?>_searchlamp.gif"  border=0> to start searching for the patient's document.<p> 
<ul>       	
...
<ul> <b>Step 1: </b>Enter the operation's date in the field "<span style="background-color:yellow" > Operation date: </span>". <br>
		...
		<b>Step 3: </b>Click the button <img src="../img/<?="$lang/$lang" ?>_searchlamp.gif"  border=0>  to start the search.<br>
</ul>
...
<ul> You can combine several search conditions. For example: If you want to list all inpatients who were operated by the surgeon "Smith" 
		...
		<b>Step 4: </b>Click the button <img src="../img/<?="$lang/$lang" ?>_searchlamp.gif"  border=0>  to start the search.<p>
