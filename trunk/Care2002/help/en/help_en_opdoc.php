...
<ul>       	
 	...
 	<b>Step 2: </b>To save the document, click the button <img src="../img/<?php echo "$lang/$lang" ?>_savedisc.gif"  border=0> .<br> 
	</ul>
...
<ul>       	
 	...
 	<b>Step 2: </b>Click the button <img src="../img/<?php echo "$lang/$lang" ?>_searchlamp.gif"  border=0> to start searching for the patient.<p> 
<ul>       	
	...
	operation in their correspondings fields.<br> 
 	<b>Step 4: </b>To save the document, click the button <img src="../img/<?php echo "$lang/$lang" ?>_savedisc.gif"  border=0> .<br> 
	</ul>
	<?php endif ?>
<?php endif ?>
...
<ul>       	
 	<b>Step 1: </b>Enter in the "<span style="background-color:yellow" > Search keyword: eg. name or family name <input type="text" name="m" size=20 maxlength=20> </span>" field either a
		complete information or the first few letters of the patient's family name or given name. <br>
 	<b>Step 2: </b>Click the button <img src="../img/<?php echo "$lang/$lang" ?>_searchlamp.gif"  border=0> to start searching for the patient's document.<p> 
<ul>       	
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all  documents  of operations done on a certain date</b></font>
<ul> <b>Step 1: </b>Enter the operation's date in the field "<span style="background-color:yellow" > Operation date: </span>". <br>
		...
		<b>Step 3: </b>Click the button <img src="../img/<?php echo "$lang/$lang" ?>_searchlamp.gif"  border=0>  to start the search.<br>
</ul>

<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all OR documents of a certain patient</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all OR documents done by a certain surgeon.</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all OR documents of outpatients </b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all OR documents of inpatients </b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all OR documents of generally insured patients </b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all OR documents of privately insured patients </b></font>
<ul> <b>Step 1: </b>Click the radio button "<span style="background-color:yellow" ><input type="radio" name="r" value="1">Private</span>". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <img src="../img/<?php echo "$lang/$lang" ?>_searchlamp.gif"  border=0>  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all OR documents of self-paying patients </b></font>
<ul> <b>Step 1: </b>Click the radio button "<span style="background-color:yellow" ><input type="radio" name="r" value="1">Self pay</span>". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <img src="../img/<?php echo "$lang/$lang" ?>_searchlamp.gif"  border=0>  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all OR documents with a certain keyword</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all documents with a certain classification of operation</b></font>
<ul> <b>Step 1: </b>Enter the keyword in the corresponding field. It can be a full word or phrase or  the first few letters of a word. <br>
		<ul><font size=2 color="#000099" >
...
<img src="../img/warn.gif" border=0 align="absmiddle"><b><font color="#990000"> Note:</font></b>
<ul> You can combine several search conditions. For example: If you want to list all inpatients who were operated by the surgeon "Smith" 
		...
		<b>Step 4: </b>Click the button <img src="../img/<?php echo "$lang/$lang" ?>_searchlamp.gif"  border=0>  to start the search.<p>
...
If the search finds a single result, the complete document will be displayed immediately.<br>
		...
		To open the document for the patient you are looking for, click either the button <img src="../img/R_arrowGrnSm.gif" border=0 height=12 border=0> corresponding to it, or
