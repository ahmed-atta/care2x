...
<ul> 
	<b>Step 1: </b>Enter the date in the "<span style="background-color:yellow" > Date: <input type="text" name="d" size=10 maxlength=10 value="10.10.2002"> </span>" field in the "<?php if($x1=="docs") print "Doctor's directives"; else print "Nursing report"; ?>" column.<br>
		...
		<li>Or click on the button <img src="../img/arrow-t.gif" width=12 height=12 border=0> below the field. The current date will appear automatically in the date field.
	...
	<b>Step 4: </b>Enter your name initials in the "<span style="background-color:yellow" > Sign: <input type="text" name="d" size=3 maxlength=3 value="ela"> </span>" field.<br>
  		<b>Note: </b>If you want to cancel, click the button <img src="../img/en/en_close2.gif" border=0>.<br>
		<b>Step 5: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the information.<br>
...
<ul> 
	...
	<b>Step 3: </b>Enter your name initials in the "<span style="background-color:yellow" > Sign: <input type="text" name="d" size=3 maxlength=3 value="ela"> </span>" field.<br>
		...
		<b>Step 5: </b>If you are finished, click the button <img src="../img/en/en_close2.gif" border=0> to close the window and go back to the patient's data folder.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
NOTE:</b></font>
<ul> 
...
<ul> 
	<b>Step 1: </b>Type the information in the<br> "<span style="background-color:yellow" > Please enter new information here: </span>" field.<br>
		...
		<b>Step 2: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the information.<br>
...
<ul> 
	...
	<b>Step 4: </b>Enter your name in the "<span style="background-color:yellow" > Nurse: </span>" field.<br> 
  		<b>Note: </b>If you want to cancel, click the button <img src="../img/en/en_cancel.gif" border=0 align="absmiddle">.<br>
		<b>Step 5: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the medication plan.<br>
...
<ul> 
		<b>Step 1: </b>Click the button <img src="../img/en/en_close2.gif" border=0> to close the pop-up window and go back to the chart.<br>
	...
	<b>Step 7: </b>Enter your name in the "<span style="background-color:yellow" > Nurse: </span>" field.<br> 
  		<b>Note: </b>If you want to cancel, click the button <img src="../img/en/en_cancel.gif" border=0 align="absmiddle">.<br>
		<b>Step 8: </b>Click the button <img src="../img/en/en_savedisc.gif" border=0> to save the medication plan.<br>
