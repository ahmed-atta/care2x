...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I am searching for a certain medocs document of a certain patient</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all medocs documents with a certain insurance organization</b></font>
<ul> <b>Step 1: </b>Enter the insurance organization's acronym in the field "Insurance:". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="Search">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all medocs documents with a certain additional insurance info</b></font>
<ul> <b>Step 1: </b>Enter the keyword in the field "Extra information:". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="Search">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all medocs documents of MALE patients </b></font>
<ul> <b>Step 1: </b>Click the radio button "<span style="background-color:yellow" >Sex <input type="radio" name="r" value="1">male</span>". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="Search">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all medocs documents of FEMALE patients </b></font>
<ul> <b>Step 1: </b>Click the radio button "<span style="background-color:yellow" ><input type="radio" name="r" value="1">female</span>". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="Search">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all medocs documents of   patients who have received the obligatory medical advice</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all medocs documents of   patients who have NOT received the obligatory medical advice</b></font>
<ul> <b>Step 1: </b>Click the radio button "<span style="background-color:yellow" ><input type="radio" name="r" value="1">No</span>". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="Search">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all medocs documents with a certain keyword</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all medocs documents written on a given date</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all medocs documents written by a certain person</b></font>
