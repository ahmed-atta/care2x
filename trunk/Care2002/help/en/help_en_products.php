...
<ul>       	
 	...
 	<b>Step 2: </b>Click the button <img src="../img/dwnArrowGrnLrg.gif" width=16 height=16 border=0>. The article will be added  in the catalog listing.<br>
 	<b>Step 3: </b>If you want to see first the complete information on the article, click either its name or its button <img src="../img/info3.gif" border=0>.<br>
...
<ul>       	
 	<b>Step 1: </b>Click the button <img src="../img/delete2.gif" border=0 align=absmiddle> of the article.<br>
</ul>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
How to order <? if($x2=="pharma") print "pharmaceutical products"; else print "products from medical depot"; ?>?
</b>
</font>
<ul>       	
 	<b>Step 1: </b>Click the menu option "<span style="background-color:yellow" > <img src="../img/bestell.gif" border=0> Ordering </span>" to switch over to ordering.<br>
	...
	password.<br>
 	...
 	<b>Step 3: </b>If asked, enter your username and password. Click the button <img src="../img/en/en_continue.gif" border=0>.<br>
 	...
 	<b>Step 5: </b>If the article you need is in the catalog list, click its button <img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0> to put <b>one piece</b> of the article to the basket (order list) on the left frame.<p>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
...
<ul>       	
 	...
 	<b>Step 4: </b>If you want to put one piece of the article in the order basket, click the button <img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0>. The article will be put in the basket and at the same it will be included in the catalog listing.<br>
 	<b>Step 5: </b>If you want to only add the article in the catalog listing, click the button <img src="../img/dwnArrowGrnLrg.gif" width=16 height=16 border=0>.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
I want to see more information about the article. What should I do?</b>
</font>
...
<ul>       	
 	<b>Step 1: </b>You can proceed to sending the order list to the  <? if($x2=="pharma") print "pharmacy"; else print "medical depot"; ?>. <br>Click the button <input type="button" value="Finalize order list"> to start the procedure.<br>
 	...
 	<b>Step 6: </b>Click the button <input type="button" value="Send this order list to the <? if($x2=="pharma") print "pharmacy"; else print "medical depot"; ?>"> to send the order list.<br>
</ul>
...
<ul>     
 	<b>Step 1: </b>Click the link "<span style="background-color:yellow" > <img src="../img/arrow-blu.gif" border=0> End ordering </span>" to go back to the <? if($x2=="pharma") print "pharmacy"; else print "medical depot"; ?>'s submenu.<br>
</ul>	
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
I want to create a new order list. What should I do?</b>
</font>
<ul>     
 	<b>Step 1: </b>Click the link "<span style="background-color:yellow" > <img src="../img/arrow-blu.gif" border=0> Start a new order list </span>" to create an empty order basket.<br>
</ul>
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Note:</b></font> 
<ul>       	
 You can get detailed instructions on either the order basket or the catalog listing by clicking the button <img src="../img/frage.gif" border=0> within the window.
</ul>
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Note:</b></font> 
<ul>       	
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
How to order <? if($x2=="pharma") print "pharmaceutical products"; 
...
<ul>       	
 	...
 	<b>Step 2: </b>If the article you need is in the catalog list, click its button <img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0> to put <b>one piece</b> of the article to the basket (order list) on the left frame.<p>
</ul>
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Note:</b></font> 
<ul>       	
 You can get detailed instructions on either the order basket or the catalog listing by clicking the button <img src="../img/frage.gif" border=0> within the window.
...
<ul>       	
 	<b>Step 1: </b>If the article you need is in the catalog list, click its button <img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0> to put <b>one piece</b> of the article to the order list (basket) on the left frame.<p>
</ul>
...
<ul>       	
 	<b>Step 1: </b>If the article you need is in the catalog list, click its button <img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0> to put <b>one piece</b> of the article to the order list (basket).<br> The order list will
	be displayed automatically on the basket frame on the left.<p>
</ul>
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Note:</b></font> 
<ul>       	
 For detailed instructions on how to search, select, and put articles from catalog list into the basket, click the <img src="../img/frage.gif" border=0 align="absmiddle"> button within the order catalog frame on the right.<p>
</ul>
...
<ul>       	
 	<b>Step 1: </b>Click the button <img src="../img/info3.gif" border=0> of the article.<br>
 	<b>Step 2: </b>A window showing the complete information about the product will pop up.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
...
<ul>     
 	<b>Step 1: </b>Click the link "<span style="background-color:yellow" > <img src="../img/arrow-blu.gif" border=0> End ordering </span>" to go back to the pharmacy's submenu.<br>
</ul>	
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
I want to create a new order list. What should I do?</b>
</font>
...
<b>Step 3: </b>Click the button <input type="button" value="Search"> to find the article.<br>
 	...
 	<b>Step 5: </b>Click the order list's button <img src="../img/uparrowGrnLrg.gif" width=16 height=16 border=0>. The details of the order will be displayed<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> 
<font color="#990000"><b>Several orders are listed. How to see a particular order?</b></font>
<ul>  	
 	<b>Step 1: </b>Click the order's button <img src="../img/uparrowGrnLrg.gif" width=16 height=16 border=0>. The details of the order will be displayed<br>
</ul>

<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Note:</b></font> 
<ul>       	
 If you decide to end searching and close, click the button <img src="../img/en/en_close2.gif" border=0>.
</ul>
...
<ul>       	
 	<b>Step 1: </b>Click the article's <img src="../img/info3.gif" border=0> button.<br>
 	<b>Step 2: </b>A window showing the complete information about the product will pop up.<br>
</ul>
	<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
