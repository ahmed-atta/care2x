	...
	if(document.forms[0].elements['insurance_' + id])
	{
		...
		<?php/*
			$result = $bill_obj->GetNewQuotation_Prescriptions($_REQUEST['encounter_nr']);
		 	...
		 	{
		 		echo "if(id==".$row['nr'].") { \n";
		 		echo "	if (document.forms[0].insurance_".$row['nr']."[i].checked==true){ \n";
		 		echo "		sum = document.forms[0].insurance_".$row['nr']."[i].value * document.forms[0].elements['dosage_' + id].value;\n";
				echo "		sum_total = sum - document.forms[0].insurance_".$row['nr']."[i].value;\n";
				echo " 		document.getElementById('div_' + id).innerHTML='<table width=\"100%\" border=\"0\"><tr><td>' + document.forms[0].insurance_".$row['nr']."[i].value + ' x ' + document.forms[0].elements['dosage_' + id].value + ' = </td><td align=\"right\">' + sum + ' TSH</td></tr><tr><td>Insurance:</td><td align=\"right\">- ' + document.forms[0].insurance_".$row['nr']."[i].value + ' TSH</td></tr><tr><td><b>Sum:</b></td><td align=\"right\"><b>' + sum_total + ' TSH</b></td></tr></table><input type=\"hidden\" name=\"pressum_' + id + '\" value=\"'+ sum_total + '\">';\n";
