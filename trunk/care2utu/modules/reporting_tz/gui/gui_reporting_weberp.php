...
//$rep_obj->DisplayBillingTableHead();
//$rep_obj->DisplayBillingTestSummary($start_timeframe, $end_timeframe);
//$rep_obj->DisplayBillingResultRows($start_timeframe, $end_timeframe);
echo '</table>';
echo '</html></body>';
exit();
}
...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066"><?php echo 'webERP Failed Transaction'; ?></font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">
							...
							<?php require_once($root_path.$top_dir.'include/inc_gui_weberp_timeframe.php'); ?>
						  <br><br><br>
                          <table width="50%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffdd">
                          <?php
                          ...
                          {
							$what = $_REQUEST['transaction'];
                          }
                          $rep_obj->DisplaywebERPTableHead($what);
                          $rep_obj->DisplaywebERPShowFailedTransaction($start_timeframe, $end_timeframe, $what);
