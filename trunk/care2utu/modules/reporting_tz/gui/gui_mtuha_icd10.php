...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
          <td width="202" bgcolor="#99ccff" > &nbsp;&nbsp;<font color="#330066"><?php echo 'Mtuha-ICD10-Summary'; ?></font></td>
        ...
        <table width="644" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor=#ffffdd>
		 ...
		 //echo "Looking for test $TestID by time range: day: ".date("d.m.y", $start_timeframe)." starttime: ".date("d.m.y :: G:i:s",$start_timeframe)." endtime: ".date("d.m.y :: G:i:s", $end_timeframe)."<br>";
		  ...
		  while(list($u,$v)=each($res_array) )
		  {
			 ...
			 $greaterThan = $db_row_no_u_age['return_underage'];
			 $lessThan    = $db_row_no['return_underage'];
          ...
          <tr>
            ...
            <td width="51" bgcolor="#ffffaa" widtd="32"><?php echo $lessThan; ?></td>
			<td width="51" bgcolor="#ffffaa" widtd="32"><?php echo $greaterThan; ?></td>
