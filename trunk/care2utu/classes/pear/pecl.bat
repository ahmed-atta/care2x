...
FOR %%x IN ("C:\xampp\htdocs\/care2002_tz_mero_vps\classes\pear/PEAR") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\xampp\htdocs\/care2002_tz_mero_vps\classes\pear/PEAR"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\xampp\htdocs\/care2002_tz_mero_vps\classes\pear"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\xampp\htdocs\/care2002_tz_mero_vps\classes\pear"
GOTO :INSTALLED
