...
Come inserire <?=$person ?> tramite la lista di selezione rapida?</b>
</font>
<ul>       	
 	<b>Nota: </b>Se si è scelto <?=$person ?> in un'operazione precedente, il nome sarà mostrato nella lista di selezione rapida.<p>
 	...
 	<b>2: </b>Selezionare Cognome o Nome di <?=$person ?>, oppure 
	<nobr>"<span style="background-color:yellow" > <img src="../img/upArrowGrnLrg.gif" width=16 height=16 border=0> Inserire questa persona come link <?=$person ?>... </span>"</nobr>.
	Il chirurgo sarà automaticamente aggiunto nell'elenco "current entries".<p>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
<?=ucfirst($person) ?> non appare nella lista di selezione rapida: come inserirla?</b>
</font>
<ul>       	
 	<b>1: </b>Inserire il nome o il cognome (o le prime lettere che lo compongono) nel campo nome o cognome di <?=$person ?> nel campo "<span style="background-color:yellow" > Ricerca nuova <?=substr($person,2) ?>... </span>".<br>
 	<b>2: </b>Selezionare il bottone <input type="button" value="OK"> per iniziare la ricerca di <?=$person ?>.<br>
 	<b>3: </b>A fine ricerca appariranno i risultati: clickare il nome, il cognome o <nobr>"<span style="background-color:yellow" > <img src="../img/upArrowGrnLrg.gif" width=16 height=16 border=0> Inserire persona come<?=$person ?>... </span>"</nobr> corrispondente a <?=$person ?> per cui si inseriscono i dati.
</ul>


<img src="../img/frage.gif" border=0 align="absmiddle"> 
<font color="#990000"><b> Come cancellare <?=$person ?> dall'elenco?</b></font> 
<ul>       	
...
<ul>       	
 	Selezionare il bottone <img src="../img/en/en_close2.gif" border=0 align="absmiddle"> che appare dopo aver selezionato <?=$person ?>.<br>
 
</ul><img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Nota:</b></font> 
<ul>Premere <img src="../img/en/en_cancel.gif" border=0> per annullare l'operazione.</ul>
<? endif ?>
...
<ul>       	
 	<b>1: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare<br>
 	<b>2: </b>Al termine, selezionare il bottone <img src="../img/en/en_close2.gif" border=0> per chiudere la finestra e tornare al registro.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> 
...
<ul>       	
 	...
 	<b>3: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare.<br>
...
<ul>       	
 	...
 	<b>4: </b>Se si cambia il numero di pezzi, scegliere il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare.<p> 
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
...
<ul> 
 	...
 	<b>3: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif"  border=0> per aggiungere l'articolo nel documento<p> 
</ul>
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Nota:</b></font> 
<ul>Premere <img src="../img/en/en_cancel.gif" border=0> per annullare l'operazione.</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
...
<ul>       	
 	...
 	<b>3: </b>selezionare di nuovo il bottone <img src="../img/en/en_hilfe-r.gif" border=0> per altre istruzioni.<p> 
...
<ul>       	
 	<b>1: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0><br>
	</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
Come iniziare una nuova registrazione</b>
</font>
<ul>       	
 	<b>1: </b>Selezionare il bottone <img src="../img/en/en_newpat2.gif" border=0><br>
 	<b>2: </b>Selezionare nuovamente il bottone <img src="../img/en/en_hilfe-r.gif" border=0> per ulteriori informazioni.<br>
	</ul>
	
<b>Nota</b>
<ul>Per chiudere, selezionare il bottone <img src="../img/en/en_close2.gif" border=0>.
</ul>
	<? endif ?>
<? endif ?>
<? if($src=="search") : ?>
<? if(($x2!="")&&($x2!="0")) : ?>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
Come selezionare il paziente di cui voglio <? if($x1=="edit") print "modificare"; else print "visualizzare"; ?> il referto di laboratorio?</b>
</font>
<ul>       	
 	<b>1: </b>selezionare button&nbsp;<button><img src="../img/update2.gif" border=0> <font size=1>Referti lab</font></button> corrispondenti al paziente di cui si vuole <? if($x1=="edit") print "modificare"; else print "visualizzare"; ?> il referto.<p> 
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
...
Come cercare un paziente?</b>
	...
	"<span style="background-color:yellow" > Inserire una parola chiave <input type="text" name="m" size=20 maxlength=20> </span>". <br>
 	<b>2: </b>Selezionare il bottone <img src="../img/en/en_searchlamp.gif" border=0> per iniziare la ricerca sul paziente.<p> 
<ul>       	
 	<b>Nota: </b>Se la ricerca trova più risultati, apparirà una lista.<p>
	</ul>
	<? if(($x2=="")||($x2=="0")) : ?>
 	<b>3: </b>selezionare il bottone &nbsp;<button><img src="../img/update2.gif" border=0> <font size=1>Referti lab</font></button> corrispondenti al paziente di cui si vuole <? if($x1=="edit") print "modificare"; else print "visualizzare"; ?> il referto.<p> 
	<? endif ?>
</ul>
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Nota:</b></font> 
<ul>       	
...
<ul>       	
 	...
 	<b><? if($x2=="") 
		...
		?>: </b> Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare i valori.<p> 
 	<b>Nota: </b>Dopo il salvataggio, per chiudere selezionare <img src="../img/en/en_close2.gif" border=0>.<br> 
</ul>
	<? endif ?>
<? if($x1=="few") : ?>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
...
<ul>       	
 	...
 	<b>2: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare.<p> 
 	<b>Nota: </b>Dopo il salvataggio, per chiudere selezionare <img src="../img/en/en_close2.gif" border=0>.<br> 
</ul>
	<? endif ?>
	<? if($x1=="param") : ?>
...
<ul>       	
 	...
 	<b>2: </b>Selezionare il bottone <img src="../img/en/en_auswahl2.gif" border=0> per passare al gruppo di parametri scelto.<p> 
</ul>
	<? endif ?>
	<? if($x1=="save") : ?>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
...
<ul>       	
 	<b>1: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare.<p> 
 	<b>Nota: </b>Dopo il salvataggio, per chiudere selezionare <img src="../img/en/en_close2.gif" border=0>.<br> 
</ul>
	<? endif ?>
	<? if($x1=="correct") : ?>
...
<ul>       	
 	...
 	<b>2: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare il valore giusto.<p> 
 	<b>Nota: </b>Dopo il salvataggio, per chiudere selezionare <img src="../img/en/en_close2.gif" border=0>.<br> 
</ul>
	<? endif ?>
	<? if($x1=="note") : ?>
...
<ul>       	
 	...
 	<b>2: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare la nota.<p> 
 	<b>Nota: </b>Dopo il salvataggio, per chiudere selezionare <img src="../img/en/en_close2.gif" border=0>.<br> 
</ul>
	<? endif ?>
	<? if($x1=="done") : ?>
...
<ul>       	
 	Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare tutti i valori.<p> 
 	<b>Nota: </b>Selezionare il bottone <img src="../img/en/en_close2.gif" border=0>.<br> 
</ul>
	<? endif ?>
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Nota:</b></font> 
<ul>       	
