...
$title1 = 'Permessi';
$_a_0_all = 'Tutte le Aree';

// Group start
$title_adm = 'Accettazione';
$_a_1_admissionwrite = 'Accettazione pazienti, lettura e scrittura';
...
// Group start
$title4 = 'Laboratorio';
$_a_1_labresultswrite = 'Laboratorio lettura e scrittura';
...
// Group start
$title7 = 'Medocs';
$_a_1_medocswrite = 'Medocs lettura e scrittura';
...
// Group start
$title_bill = 'Billing';
$_a_1_billallwrite = 'Billing (all areas) lettura e scrittura';
$_a_2_billallread = 'Billing (all areas) sola lettura';
$_a_2_billpharmawrite = 'Billing (pharmacy) lettura e scrittura';
$_a_3_billpharmaread = 'Billing (pharmacy) sola lettura';
$_a_2_billserviceswrite = 'Billing (services) lettura e scrittura';
$_a_3_billservicesread = 'Billing (services) sola lettura';
$_a_2_billlabwrite = 'Billing (laboratory) lettura e scrittura';
$_a_3_billlabread = 'Billing (laboratory) sola lettura';
