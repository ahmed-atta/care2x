...
<p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
  ...
  <ul>
    ...
    una lista.<br>
    Para ver la información del paciente que busca, haga click ya sea en el botón 
  ...
  <ul>
    Si usted desea iniciar una nueva búsqueda, haga click en el botón 
    <input type="button" value="Nueva búsqueda en el archivo">
    . 
  </ul>
  <?php else : ?>
  ...
  <ul>
    ...
    <b>Paso 3: </b>Haga click en el botón 
  ...
  su cuenta (privados - sin cobertura)</b></font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Haga 
    click en la opción " 
    <input type="radio" name="r" value="1">
  ...
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
  <font color="#990000"><b>Deseo ver la lista de todos los pacientes con cobertura 
  privada (prepagos)</b></font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Haga 
    click en la opción " 
    <input type="radio" name="r" value="1">
    Cobertura Privada". <br>
    <b>Paso 2: </b>Deje todos los demás campos vacíos o sin llenar.<br>
    <b>Paso 3: </b>Haga click en el botón 
    <input type="button" value="BUSCAR">
    para empezar la búsqueda.<br>
  ...
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
  <font color="#990000"><b>Deseo ver la lista de todos los pacientes con Obra Social</b></font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Haga 
    click en la opción " 
    <input type="radio" name="r" value="1">
  ...
  <ul>
    ...
    <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: 
      ...
      <b>Paso 3: </b>Haga click en la opción "Género 
      <input type="radio" name="r" value="1">
      masculino". <br>
      <b>Paso 4: </b>Haga click en el botón 
      <input type="button" value="BUSCAR">
      para empezar la búsqueda.<br>
      </font>
  </ul>
  ...
  <ul>
    ...
    Para ver la información del paciente, haga click ya sea en el botón <img <?php echo createComIcon('../','r_arrowgrnsm.gif','0') ?>> 
  ...
  <b>Nota</b> </font>
  <ul>
    <font size="2"> Si desea cerrar esta ventana, haga click en el botón 
