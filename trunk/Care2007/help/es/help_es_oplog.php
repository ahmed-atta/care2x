...
<font face="Verdana, Arial" size=3 color="#0000cc"> <b> Bitácora de Quirófano 
- 
<?php
if($src=="create")
{
...
<form action="#" >
  ...
  ¿Como ingresar una <?php echo $person ?> por la via vista rápida?</b> 
  </font></font> 
  <ul>
    ...
    nombre está listado en la lista de vista rápida. </font> 
    <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: 
      </b>Verifique primero si aparece en la lista de vista rápida en &quot;Quirófano&quot;. 
      Si no, seleccione su función correcta de Quirófano.<br>
  ...
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
    la hora de entrada a quirófano en el campo "<span style="background-color:yellow" > 
    de: 
  ...
  <ul>
    ...
    <b>Paso 2: </b>Escriba la hora de término en el campo"<span style="background-color:yellow" >par</span><span style="background-color:yellow" >a: 
  ...
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  �Como documentar tiempos de reposición?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
    la hora de inicio en el campo "<span style="background-color:yellow" > de: 
  ...
  <?php endif ?>
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  ¿Como salvar la información?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Dé 
  ...
  <ul>
    ...
    clic en el botón &quot;Borrar datos&quot; solo borrará los datos 
  ...
  <ul>
    ...
    <b>Paso 2: </b>Y emergerá el folder de datos del paciente.<br>
    </font> 
  </ul>
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
...
while(list($x,$v)=each($Or2Dept))
  ...
  <?php if($x2=="material") : ?>
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  ¿Como documentar el material usado para la operación?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
  ...
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
  <font color="#990000"><b> ¿Como quitar un artículo de la lista?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Dé 
    clic al icono <img <?php echo createComIcon('../','delete2.gif','0','absmiddle') ?>> 
  ...
  forzar manualmente el ingreso de un artículo?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Dé 
  ...
  <?php if(($x1=="")||($x1=="fresh")) : ?>
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  ¿Cómo empezar un documento de registro para una operación?</b> 
  </font></font> 
  <ul>
  ...
  <font color="#990000"><b> �Como ingresar el diagnostico para la cirugía?</b> 
  </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
  ...
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
  <font color="#990000"><b> ¿Como ingresar la hora en varias secciones 
  ...
  <ul>
    ...
    <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Tiempo 
      ...
      Reposición <img <?php echo createComIcon('../','bul_arrowgrnsm.gif','0','absmiddle') ?>> 
      </span>" situada en la esquina inferior izquierda. </font> 
  ...
  <?php if(($x1=="fresh")||($x1=="")) : ?>
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  ¿Como buscar un documento de algún paciente en particular?</b> 
  </font></font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
    ...
    <input type="button" value="Buscar">
    para iniciar la búsqueda del documento del paciente. </font><font face="Verdana, Arial, Helvetica, sans-serif">
    <p><font size="2"><b>Nota: </b>Si la búsqueda encontró un resultado la información 
      básica del paciente será agregada inmediatamente en los campos correspondientes.. 
      </font></font> 
  ...
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  ¿Como mostrar un documento en particular?</b> </font></font> 
  <ul>
  ...
  <?php if(($x1=="get")||($x3=="1")) : ?>
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  ¿Como actualizar o editar el documento que está viendo?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Dé 
  ...
  <?php endif ?>
  <img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b> 
  ¿Como continuar buscando?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Escriba 
    ya sea la información completa o la primeras letras del nombre o apellido 
    del paciente o la fecha de nacimiento en el campo &quot;<span style="background-color:yellow" > 
  ...
  <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
    <font color="#990000"><b>Quiero ver entradas de registro archivadas otro día.</b></font></font> 
  </p>
  <ul>
  ...
  <ul>
    ...
    <b>Paso 3: </b>Dé clic en el botón 
    <input type="button" value="Cambiar">
    para cambiar a un nuevo quirófano o departamento.<br>
    </font> 
  </ul>
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
  <?php if(($x3!="")) : ?>
