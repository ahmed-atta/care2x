...
<!-- Biller section - end -->
	...
	{if $smarty.get.style === 'Itemised' || $smarty.get.style === 'Consulting' }
			...
			<!--	<td class="tbl1 col1" ><b>{$LANG.quantity_short}</b></td> -->
				<td class="tbl1 col1" ><b>{$LANG.category_tpl}</b></td>
			<!--	<td class="tbl1 col1" ><b>{$LANG.unit_price}</b></td>  -->
				...
				{foreach from=$invoiceItems_cat item=invoiceItem_cat}
			...
			<!--	<td class="tbl1">{$invoiceItem.quantity_formatted}</td> 
				...
				<td classs="tbll">{$preference.pref_currency_sign}{$invoiceItem_cat.category}</td>
				<td class="tbl1">{$preference.pref_currency_sign}{$invoiceItem_cat.gross_total}</td>
				<td class="tbl1">{$preference.pref_currency_sign}{$invoiceItem_cat.tax_amount}</td>
				<td class="tbl1">{$preference.pref_currency_sign}{$invoiceItem_cat.total}</td>
			</tr>
                <tr>
