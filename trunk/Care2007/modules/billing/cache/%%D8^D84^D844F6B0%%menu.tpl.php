<?php /* Smarty version 2.6.18, created on 2007-06-22 17:05:34
...
<div id="Header">
 ...
 +</a>
				<ul>
					...
					<li><a href="./index.php?module=category&view=manage"><?php echo $this->_tpl_vars['LANG']['category']; ?>
 +</a>
						<ul>
					<li><a href="./index.php?module=category&view=manage"><?php echo $this->_tpl_vars['LANG']['manage_category']; ?>
</a></li>
					<li><a href="./index.php?module=category&view=add"><?php echo $this->_tpl_vars['LANG']['add_category']; ?>
</a></li>
						</ul>
					</li>
					<li>
