<?php /* Smarty version 2.6.18, created on 2007-06-18 15:48:31
         compiled from ../templates/default/products/details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', '../templates/default/products/details.tpl', 108, false),)), $this); ?>
<form name="frmpost"
	action="index.php?module=products&view=save&submit=<?php echo $_GET['submit']; ?>
"
	method="post">
...
<?php if ($_GET['action'] == 'view'): ?>
	...
	<b><?php echo $this->_tpl_vars['LANG']['products']; ?>
 ::
	<a href="index.php?module=products&view=details&submit=<?php echo $this->_tpl_vars['product']['id']; ?>
&action=edit"><?php echo $this->_tpl_vars['LANG']['edit']; ?>
	...
	<table align="center">
	<tr>
		<td class="details_screen"><?php echo $this->_tpl_vars['LANG']['product_id']; ?>
</td><td><?php echo $this->_tpl_vars['product']['id']; ?>
</td>
	</tr>
	<tr>
...
</td><td><?php echo $this->_tpl_vars['product']['notes']; ?>
</td>
	</tr>
	<tr>
		<td class="details_screen"><?php echo $this->_tpl_vars['LANG']['product_enabled']; ?>
</td>
		<td><?php echo $this->_tpl_vars['product']['wording_for_enabled']; ?>
</td>
	</tr>
	</table>
...
<?php if ($_GET['action'] == 'edit'): ?>
	...
	<b><?php echo $this->_tpl_vars['LANG']['product_edit']; ?>
</b>
	<hr></hr>
	...
	<tr>
		...
		<td><input type="text" name="description" size="50" value="<?php echo $this->_tpl_vars['product']['description']; ?>
" /></td>
	</tr>
	<tr>
		<td class="details_screen"><?php echo $this->_tpl_vars['LANG']['product_unit_price']; ?>
...
" /></td>  -->
		<td><?php if ($this->_tpl_vars['categories'] == null): ?>
...
?>
				<option <?php if ($this->_tpl_vars['category']['name'] == $this->_tpl_vars['product']['custom_field1']): ?> selected <?php endif; ?> value="<?php echo $this->_tpl_vars['category']['name']; ?>
...
" /></td>
	...
	<tr>
		...
		<td><textarea name="notes" rows="8" cols="50"><?php echo $this->_tpl_vars['product']['notes']; ?>
</textarea></td>
	</tr>
	<tr>
		<td class="details_screen"><?php echo $this->_tpl_vars['LANG']['product_enabled']; ?>
...
" /> 
		<input type="submit" name="save_product" value="<?php echo $this->_tpl_vars['LANG']['save_product']; ?>
" /> 
		<input type="hidden" name="op" value="edit_product" /> 
<!--		<input type=hidden name="category_id" value="<?php echo $this->_tpl_vars['category']['id']; ?>
">   -->
	<?php endif; ?>
</form>