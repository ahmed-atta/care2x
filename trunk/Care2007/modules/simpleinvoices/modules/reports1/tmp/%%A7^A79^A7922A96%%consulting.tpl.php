<?php /* Smarty version 2.6.18, created on 2007-05-28 12:20:54
         compiled from ../templates/default/invoices/consulting.tpl */ ?>
<form name="frmpost" action="index.php?module=invoices&view=save" METHOD=POST onsubmit="return frmpost_Validator(this)">

<h3><?php echo $this->_tpl_vars['LANG']['inv']; ?>
 <?php echo $this->_tpl_vars['LANG']['inv_consulting']; ?>
</h3>
...
" size="5"></td><td input type=text name="description<?php echo $this->_sections['line']['index']; ?>
" size="50">
...
"><?php echo $this->_tpl_vars['product']['description']; ?>
			...
			<?php endif; ?>
                ...
                <tr class="text<?php echo $this->_sections['line']['index']; ?>
 hide">
        <td colspan=2 ><textarea input type=text name='description<?php echo $this->_sections['line']['index']; ?>
' rows=3 cols=80 WRAP=nowrap></textarea></td>
</tr>
...
</td><td input type=text name="tax" size=15>
