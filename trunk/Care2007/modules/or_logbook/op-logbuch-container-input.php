...
function sendnum(d)
{
	...
	{	window.parent.OPMLISTFRAME.location.replace('op-logbuch-container-list.php?sid=<?php echo "$sid&lang=$lang&op_nr=$op_nr&dept_nr=$dept_nr&saal=$saal&enc_nr=$enc_nr&pday=$pday&pmonth=$pmonth&pyear=$pyear"; ?>&mode=search&material_nr='+d.material_nr.value);
	return false;
	}
}
// -->
...
<img <?php echo createComIcon($root_path,'manfldr.gif','0','middle') ?>><br> <?php echo $LDShowLogbook ?>
</a>
</body>
</html>
