...
while ($iod=mysql_fetch_assoc($res)) {
	...
	<tr bgcolor="#99ccff">
		<td><div class=fva2_ml3 id="id_<?=$iod['nr']?>_indatetime_date"><?=date("d/m/Y",strtotime($iod['indatetime']))?></div></td>
		<td><div class=fva2_ml3 id="id_<?=$iod['nr']?>_indatetime_time"><?=date("H:i",strtotime($iod['indatetime']))?></div></td>
		<td><div class=fva2_ml3 id="id_<?=$iod['nr']?>_pint"><?=$iod['pint']?></div></td>
		<td><div class=fva2_ml3 id="id_<?=$iod['nr']?>_solution"><?=$iod['solution']?></div></td>
		<td align=right><div class=fva2_ml3 id="id_<?=$iod['nr']?>_solutionamount"><?=$iod['solutionamount']?></div></td>
		<td align=right><div class=fva2_ml3><?=$soltotal?></div></td>
		<td><div class=fva2_ml3 id="id_<?=$iod['nr']?>_initial"><?=$iod['initial']?></div></td>
		<td><div class=fva2_ml3 id="id_<?=$iod['nr']?>_oralfluid"><?=$iod['oralfluid']?></div></td>
		<td align=right><div class=fva2_ml3 id="id_<?=$iod['nr']?>_oralfluidamount"><?=$iod['oralfluidamount']?></div></td>
		<td align=right><div class=fva2_ml3><?=$oraltotal?></div></td>
		<td><div class=fva2_ml3 id="id_<?=$iod['nr']?>_urinetime"><?=date("H:i",strtotime($iod['urinetime']))?></div></td>
		<td align=right><div class=fva2_ml3 id="id_<?=$iod['nr']?>_urineamount"><?=$iod['urineamount']?></div></td>
