...
if ($saveok){
	...
	$smarty->assign('sDozaInput',$doza.'<input type="hidden" name="doza" value="'.$doza.'">');
	...
	$smarty->assign('sDozaInput','<input type="text" name="doza" value="'.$doza.'"  size=40 maxlength=40>');
