...
var cam4=new Image();
    ...
    cam1.src="<?php echo $cam_http_1 ?>cam_001.jpg";
	cam2.src="<?php echo $cam_http_2 ?>cam_002.jpg";
	cam3.src="<?php echo $cam_http_3 ?>cam_003.jpg";
	cam4.src="<?php echo $cam_http_4 ?>cam_004.jpg";
...
<table border=0>
  <tr>
    <td><img src="<?php echo $cam_http_1 ?>cam_001.jpg" border=0 width=320 height=240 name="pic1"><br>

<select name="Cam1" onChange="changeCamera(this,1)">
 	<option value="cam_001.jpg" selected> Camera 1</option>
