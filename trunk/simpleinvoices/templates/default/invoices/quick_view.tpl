...
{$LANG.actions}: 
		<a href="index.php?module=invoices&view=templates/template&submit={$invoice.id}&action=view&style={$invoice_type.inv_ty_description}" target="blank"> {$LANG.print_preview}</a>
		 :: 
...
<!-- #PDF end -->
	...
	<tr>
		...
		<td class=account>Advance:</td><td class=account><u>{$preference.pref_currency_sign}{$invoice.advance}</u></td>
		{else}
...
{if $invoice.owing lt 0}
		...
		<tr>
		 ...
		 <tr>
	                <td></td><td></td><td></td><td><b>Advance</b></td><td></td><td><b>{$LANG.total_uppercase}</b></td>
        	</tr>
		 <tr>
        	        <td></td><td></td><td></td><td>{$preference.pref_currency_sign}{$invoice.advance}</td><td></td><td><u>{$preference.pref_currency_sign}{$invoice.advance}</u></td>
	        </tr>
		<tr>
	                <td colspan=6><br></td>
        	</tr>
		...
		<tr>
                <td colspan=3></td><td align=left colspan=2><b>{$preference.pref_inv_wording} {$LANG.amount}</b></td><td colspan=2 align=right><u>{$preference.pref_currency_sign}{$invoice.advance}</u></td>
        </tr>
{else}
...
{if $smarty.get.style === 'Itemised' || $smarty.get.style === 'Consulting' }
     ...
     {if $smarty.get.style === 'Itemised' }
		...
		<!--	<td><b>{$LANG.category_tpl}</b></td><td><b>{$LANG.gross_total}</b></td><td><b>{$LANG.tax}</b></td><td><b>{$LANG.total_uppercase}</b></td>  -->
		        </tr>
	{/if}
