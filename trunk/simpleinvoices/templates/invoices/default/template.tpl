...
<link rel="stylesheet" type="text/css" href="{$css}">
	...
	<!-- Show the Invoice Custom Fields if valid -->
		...
		<tr>
				<td nowrap class="tbl1-left">{$customFieldLabels.invoice_cf1}:</td><td class="tbl1-right" colspan=3>{$invoice.consultant}</td>
		</tr>
		{/if}
		...
		{if $invoice.owing lt 0}
		<tr>
				<td nowrap class="tbl1-left tbl1-bottom">Advance</td><td class="tbl1-right tbl1-bottom" colspan=3 >{$preference.pref_currency_sign}{$invoice.advance}</td>
		</tr>
		{else}
		<tr>
...
<!-- Biller section - end -->
	...
	{if $invoice.owing lt 0}
		...
		<td align="right" class="tbl1-right" >{$preference.pref_currency_sign}{$invoice.advance}</td>
		</tr>
		<tr class="tbl1-left tbl1-right" >
		...
		<td  class="tbl1-bottom tbl1-right" align=right><u>{$preference.pref_currency_sign}{$invoice.advance}</u></td>
	...
	{if $smarty.get.style === 'Itemised' || $smarty.get.style === 'Consulting' }
			...
			<!--	<td class="tbl1 col1" ><b>{$LANG.quantity_short}</b></td> -->
				<td class="tbl1 col1" align=center colspan=2 ><b>{$LANG.category_tpl}</b></td>
			<!--	<td class="tbl1 col1" align=center ><b>{$LANG.unit_price}</b></td>  -->
				<td class="tbl1 col1"  align=center><b>{$LANG.gross_total}</b></td>
				<td class="tbl1 col1"  align=center><b>{$LANG.tax}</b></td>
				<td class="tbl1 col1" align=right colspan=2 ><b>{$LANG.total_uppercase}</b></td>
			</tr>
			
				{foreach from=$invoiceItems1 item=invoiceItem1}
			...
			<!--	<td class="tbl1">{$invoiceItem.quantity_formatted}</td> 
				...
				<td classs="tbll" align=center colspan=2>{$invoiceItem1.category}</td>
				<td class="tbl1"  align=right>{$preference.pref_currency_sign}{$invoiceItem1.gross_total}</td>
				<td class="tbl1"  align=right>{$preference.pref_currency_sign}{$invoiceItem1.tax_amount}</td>
				<td class="tbl1" align=right colspan=2>{$preference.pref_currency_sign}{$invoiceItem1.total}</td>
			</tr>
                <tr>
