...
$category_id=getcategory_id($category_name);
...
$sql = "INSERT into
		{$tb_prefix}products(id,description,unit_price,custom_field1,custom_field2,custom_field3,custom_field4,notes,enabled,category_id)
	VALUES
		(	
			'',
			'$_POST[description]',
	...
	if (isset($_POST['save_product'])) {
		$sql = "UPDATE
			...
			SET
				...
				notes = '$_POST[notes]',
				custom_field1 = '$_POST[category_name]',
