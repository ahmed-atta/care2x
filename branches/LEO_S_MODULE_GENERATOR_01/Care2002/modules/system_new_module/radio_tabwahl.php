...
<!-- Button erstellen für "Ja, den da" -->
   <input type="image" <?php if($cfg['dhtml'])echo 'img '.createLDImgSrc($root_path,'ok_small.gif','0').'  style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a>
...
<!-- Button erstellen für "Ja, den da" -->
   </br><input type="image" <?php if($cfg['dhtml'])echo 'img '.createLDImgSrc($root_path,'ok_small.gif','0').'  style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?>
</form>	 
</ul>
