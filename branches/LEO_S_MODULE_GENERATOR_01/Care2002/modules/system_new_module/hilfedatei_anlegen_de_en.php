...
$kommentar2="//Zeile und ersetzen Sie sie mit Code nach dem Schema aus der Datei /include/std_include_parts/std_hlp_file_example.php\n";
$text="require_once(\$root_path.\"include/std_include_parts/std_hlp_file_example.php\")\n";
$zeile2="?>\n";
fwrite($datei,$zeile1);
...
$kommentar2="//replace it with code with the sheme from the file /include/std_include_parts/std_hlp_file_example.php\n";
$text="require_once(\$root_path.\"include/std_include_parts/std_hlp_file_example.php\")\n";
$zeile2="?>\n";
fwrite($datei,$zeile1);
fwrite($datei,$kommentar1);
