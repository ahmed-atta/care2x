...
<FONT  COLOR="<?php echo $cfg['top_txtcolor']; ?>"  SIZE=+2  FACE="Arial"><STRONG> &nbsp; <?php echo "$LDAddress :: $LDUpdateData" ?></STRONG></FONT></td>
<td bgcolor="<?php echo $cfg['top_bgcolor']; ?>" height="10" align=right>
<?php if($cfg['dhtml'])echo'<a href="javascript:window.history.back()"><img '.createLDImgSrc($root_path,'back2.gif','0').'  style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a><a href="javascript:gethelp('address_update.php')"><img <?php echo createLDImgSrc($root_path,'hilfe-r.gif','0') ?>  <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a><a href="<?php echo $breakfile;?>"><img <?php echo createLDImgSrc($root_path,'close2.gif','0') ?> alt="<?php echo $LDCloseAlt ?>"  <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a></td>
</tr>
<tr valign=top >
...
<table border=0>
  <tr>
    <td class=pblock align=right background="<?php echo $bgc ?>"><?php echo $LDCityTownName ?>: </td>
    <td class=pblock bgcolor="<?php echo $bgc2 ?>" ><?php echo $name ?><br>
</td>
  </tr> 
  <tr>
    <td class=pblock align=right background="<?php echo $bgc ?>"></font><?php echo $LDISOCountryCode ?>: </td>
  ...
  <tr>
    <td class=pblock align=right background="<?php echo $bgc ?>"><font color=#ff0000></font><?php echo $LDWebsiteURL ?>: </td>
    <td class=pblock bgcolor="<?php echo $bgc2 ?>" ><input type="text" name="info_url"  size=50 maxlength=60 value="<?php echo $info_url ?>"></td>
  </tr>
   <tr>
    <td class=pblock align=right background="<?php echo $bgc ?>"></font><?php echo $LDUNECELocalCode ?>: </td>
    <td class=pblock bgcolor="<?php echo $bgc2 ?>" ><input type="text" name="unece_locode"  size=50 maxlength=60 value="<?php echo $unece_locode ?>"></td>
  </tr>
  <tr>
    <td class=pblock align=right background="<?php echo $bgc ?>"></font><?php echo $LDUNECEModifier ?>: </td>
    <td class=pblock bgcolor="<?php echo $bgc2 ?>" ><input type="text" name="unece_modifier"   size=50 maxlength=60 value="<?php echo $unece_modifier ?>"></td>
  </tr>
  <tr>
    <td class=pblock align=right background="<?php echo $bgc ?>"></font><?php echo $LDUNECELocalCodeType ?>: </td>
    <td class=pblock bgcolor="<?php echo $bgc2 ?>" ><input type="text" name="unece_locode_type" size=50 maxlength=60 value="<?php echo $unece_locode_type ?>"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class=pblock  align=right><a href="<?php echo $breakfile;?>"><img <?php echo createLDImgSrc($root_path,'cancel.gif','0') ?>></a></td>
  </tr>
</table>
