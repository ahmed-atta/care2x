...
Inserisci note
<br>
<input type="text" name="note" value="Note: Codice di presa in carico xxxxx. La persona assicurata non paga franchigia." size="65">
<br>
<br>
...
<input type="reset" value="Reimposta" name="B2"> 
  ...
  <br /><br /><br /><br />
  Modulo da riempire solo nel caso in cui si volesse intestare la fattura ad una societa'
  <br /><br />
  <table border=1>
  <tr>
  <td>
  ...
  <td>
  <input type="text" name="rag_soc" size="20" />
  </td>
  </tr>
  <tr>
  <td>
  ...
  <td>
  <input type="text" name="comune" size="20" />
  </td>
  </tr>
  <tr>
  <td>
  ...
  <td>
  <input type="text" name="cod_fis" size="20" />
  </td>
  </tr>
   <tr>
  <td>
  ...
  <td>
  <input type="text" name="piva" size="20" />
  </td>
  </tr>
  </table>
  </form>
