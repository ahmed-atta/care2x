...
function controlla()
{
a=(document.dati.rag_soc.value!="") && (document.dati.indirizzo.value!="") && (document.dati.civico.value!="") && (document.dati.cap.value!="") && (document.dati.comune.value!="") && ((document.dati.cod_fis.value!="") || (document.dati.piva.value!="") );
...
ciccio=window.prompt('ciao','');
//window.alert(ciccio);
document.dati.note.value='pippo'+ciccio;
}
//-->
</script>
<?
...
<form method="POST" action="../../invoice/fattura.php" name="dati" >
  ...
  <p><b>Inserisci note</b>
	...
	<input type="button" name="Prova" value="Ciao" onClick="javascript:gino()">
    <br>
    <br>
