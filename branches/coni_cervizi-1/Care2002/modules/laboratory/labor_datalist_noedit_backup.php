...
<td class="va12_n"> &nbsp;<nobr><a href="#">Quick</a></nobr> 
	...
	-->		
<tr bgcolor="#99ccff" >
     <td class="val12_n"><FONT SIZE=2  FACE="Verdana,Arial" color="black">&nbsp;<a href="#"><b><?php echo $mappa_lab[$d]['parametro'] ?></a></b>&nbsp;</td>
     <td  bgcolor="#99ccff" class="a12_b"><FONT SIZE=2  FACE="Verdana,Arial" color="black">&nbsp;<b><?php echo $mappa_lab[$d]['unita_di_misura'] ?></b>&nbsp;</td>
...
while (list($e,$f)=each($c))
 { $ok=true;
	...
	if($e==$matrice[$k]['job_id'])
    {
	   $ok=false;
      ?>
	  <td  bgcolor="#99ccff" class="a12_b"><FONT SIZE=2  FACE="Verdana,Arial" color="black">&nbsp;<b><?php echo $f ?></b>&nbsp;</td>
  	  <?php
	  $p++;
	  $k++;
    }
	...
	?>
  	  ...
  	  <td  bgcolor="#99ccff" class="a12_b"><FONT SIZE=2  FACE="Verdana,Arial" color="black">&nbsp;<b><?php echo " "  ?></b>&nbsp;</td>
  	<?php
   ...
   if($elementi==$p)
	{
		...
		while($i-$temp>0)
		{
		  ...
		  $temp++;
		   ...
		   ?>
			<td>
			<input type="checkbox" name="tk" value="<?php echo $check ?>">
			</td>
			<?
			$check++;
