...
<table border=0 cellpadding=0 cellspacing=0 width=325>
<tr><td bgcolor="#A0C6E5" style="padding:4px;"><!--<img src="http://207.68.162.24/i.p.cont.individual.gif" border=0 hspace="0">-->
 <font class="BB">Analisi Chimico-Cliniche</font></td></tr>


<td valign=top>
<form name=lista1>
<select name="lista11" size="12" width="325" style="width:325px;">
<option value="10"> Francesco </option>
<option value=<?echo "12";?>> <?php echo "ciccio"; ?> </option>
<option value="11">Marco</option>
<option value="13">Mucca</option>
<option value="16"> Francescosadf </option>
<option value=<?echo "17";?>> <?php echo "ciccio"; ?> </option>
<option value="18">Marcoaksldfjk</option>
<option value="19">Muccassss</option>
</select>
</form>
</td>				
...
<td valign=top>
<form name=lista2 >
<select name="lista21" size="12" width="325" style="width:325px;">
</select>
</form>
</td>
</tr>
