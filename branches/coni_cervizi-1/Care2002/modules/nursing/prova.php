...
// window.alert("elemento già inserito, COGLIONE!!!"+arr[document.lista1.lista11.options[document.lista1.lista11.selectedIndex].value]);
 ...
 document.lista2.lista21.options[indice].text="Q.tà ("+arr[document.lista1.lista11.options[document.lista1.lista11.selectedIndex].value]+") "+document.lista1.lista11.options[document.lista1.lista11.selectedIndex].text;
}
else
{
...
new1=new Option("Q.tà (1) "+document.lista1.lista11.options[document.lista1.lista11.selectedIndex].text,document.lista1.lista11.options[document.lista1.lista11.selectedIndex].value);
...
arr[document.lista2.lista21.options[document.lista2.lista21.selectedIndex].value]--;
 ...
 document.lista2.lista21.options[document.lista2.lista21.selectedIndex].text="Q.tà ("+ arr[document.lista2.lista21.options[document.lista2.lista21.selectedIndex].value]+") "+descrizione ;
...
<!--FINISCONO QUI LE FUNZIONI DA NOI AGGIUNTE-->
function chkForm(d)
{ 
   return true 
}
...
<input class="A" style="width: 75px;" type="button" value="Aggiungi &gt;&gt;"  onClick="javascript:aggiungi();">
<p>				
<input class="A" style="width: 75px;" type="button" value="&lt;&lt; Rimuovi" onClick="javascript:rimuovi();">
</td>
