...
if ($menufolge=="automatisch"){
    //echo " menufolge ist automatisch, Modul wird an letzter Stelle angefügt.</br>";
		...
		// neu gestetzt werden soll oder nicht(im Falle von false)
		$updateflag=false;
		//echo $sort_nr."</br>";
		}
else {
...
echo "<br/><Font FACE='Arial' color=".$cfg['top_txtcolor'].">$weiter_info";
...
?>
<br/><br/>
<a href="hinweise.txt"><?php echo $wichtige_info; ?></a>	
...
<br/><br/>
<!-- Formular wird mittels Bild übergeben an radio2.php -->
