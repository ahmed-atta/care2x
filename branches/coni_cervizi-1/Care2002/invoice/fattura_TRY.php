...
$tot.=$_POST['total']*100;
//echo $tot;
$fp=fopen("../Gesinf/temp/beneficiari/".date("d-m-Y")."BENEF.txt",'a');
...
$fp=fopen("../Gesinf/temp/fatture/".date("d-m-Y")."FATT.txt",'a');
if ($pagamento!=5)
{
...
fwrite($fp,$anno."3AF".$codice_fiscale_beneficiario."           ".date("dmY").$numero_fattura.$conto_bancario.$descrizione.$codice_clausola_prima_nota.$tot."610000000000000000000000000   000000000000000000000000   000000000000000000000000   000000000000".$tot."000000000000".$tot."CEA.01.01.08.01               FO.03.          FO.03.          GEN.            ".$tot."SPP.D.09.10.01                000000000000                                                                              000000000000                                                                              000000000000                                                                              000000000000   5".$p_iva.$tot_dumm."\n");
}
else
{
...
fwrite($fp,$anno."3AF".$codice_fiscale_beneficiario.$partita_iva.date("dmY").$numero_fattura.$conto_bancario.$descrizione.$codice_clausola_prima_nota.$tot."610000000000000000000000000   000000000000000000000000   000000000000000000000000   000000000000".$tot."000000000000".$tot."CEA.01.01.08.01                FO.03.          FO.03.          GEN.            ".$tot."SPP.D.09.10.01                000000000000                                                                              000000000000                                                                              000000000000                                                                              000000000000   5".$p_iva.$tot_dummy."\n");
}
