 ...
 */
class PEAR_Command_InstallSGL extends PEAR_Command_Common
{
    // {{{ properties
...
'),
     ...
     * @access public
     */
    function PEAR_Command_InstallSGL(&$ui, &$config)
    {
    ...
    function doInstallSGL($command, $options, $params)
    {
    ...
    function doUninstallSGL($command, $options, $params)
    {
        if (empty($this->installer)) {
            $this->installer = &$this->getInstaller($this->ui);
        }
    ...
    */
    ...
    function doBundleSGL($command, $options, $params)
    {
    ...
    function doRunScriptsSGL($command, $options, $params)
    {
        if (!isset($params[0])) {
