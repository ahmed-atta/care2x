...
/* ArticleMgr */
    ...
    // flow
    'approve'      => 'утвердить',       // actions
    'publish'      => 'опубликовать',
    'archive'      => 'архивировать',
    'For Approval' => 'Для утверждения', // statuses
...
/* ArticleViewMgr */
    ...
    'Related Articles'      => 'Схожие статьи',
    'Related Documents'     => 'Прикрепленные документы',
    'contributed by'        => 'автор', // написал / создал
    'full story'            => 'Продолжение', // ориг. - Continue reading
...
/* DocumentMgr */
    ...
    'showing results for' => 'показывать', //
    'Asset Name'          => 'Название файла',
    'Size'                => 'Размер',
    'Type'                => 'Тип',
    ...
    'close'               => 'закрыть',
    'preview'             => 'просмотр', // предварительный
    ...
    'There was an error attempting to download the file' => 'Ошибка загрузки файла',
    'The specified file does not appear to exist'        => 'Указанный файл не существует',

    // form alerts
    'Please wait until upload is finished' => 'Пожалуйста, подождите пока загрузка не закончится',
    'Please select a file to upload'       => 'Пожалуйста, укажите файл для загрузки',
    'Please wait while document uploads'   => 'Пожалуйста, подождите пока документ загружается',

    // messages
    'The asset has successfully been added'   => 'Файл успешно добавлен',
    'The asset has successfully been deleted' => 'Файлы успешно удалены',
...
/* FileMgr */
    ...
    // messages
    'You do not have read permissions for this file' => 'У Вас нет прав на чтение данного файла',


/* DocumentViewMgr */

    // titles
    'Document Browser' => 'Просмотр документов',
...
/* ContentTypeMgr */
    ...
    // titles
    'Content Type Manager' => 'Управление типами содержания',
    ...
    // actions
    'Add New Content Type' => 'Добавление нового типа содержания',
    'Editing Content Type' => 'Редактирование типа содержания',

    //
    // отсортировать и перевести; на данный момент здесь слишком много устаревших
    // ключевых слов, как и в английском варианте
    //

    'select a type to create a new article' => 'укажите тип для создания новой статьи',
