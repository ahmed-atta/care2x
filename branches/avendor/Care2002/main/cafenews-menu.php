<?
//if ((!$sid)||($sid!=$ck_sid)||!$week) {header("Location: invalid-access-warning.php"); exit;}; 
if(!$lang)
...
<a href="javascript:editcafe()"><img src="../img/basket.gif" width=74 height=70 border=0></a> <b><?=$LDCafeMenu ?></b></FONT>
...
<table border=0 cellspacing=1 cellpadding=3>
  <tr>
	...
	<FONT  SIZE=3 COLOR="#0000cc" FACE="verdana,Arial"><?=$LDThisWeek ?>
</font>
</td>
    <td colspan=7 bgcolor="#ccffff">
	<FONT  SIZE=3 COLOR="#0000cc" FACE="verdana,Arial"><?=$LDNextWeek ?>
</font>
</td>  
     <td colspan=7 bgcolor="#ccffff">
	<FONT  SIZE=3 COLOR="#0000cc" FACE="verdana,Arial"><?=$LD3rdWeek ?>
</font>
</td> 
</tr>
<tr bgcolor="#ccffff">
  
<? for ($i=0,$acttag=$day,$dyidx=$daytag-1;$i<21;$i++,$acttag++,$dyidx++)
	{
	...
	print '<a href="';
	if($spot) print "#\""; else print 'cafenews-menu.php?sid='.$ck_sid.'&week='.$week.'&myear='.$year.'&mmonth='.$month.'&mday='.$acttag.'" ';
...
<table border=0 cellspacing=0 cellpadding=10>
  <tr bgcolor="#ccffff" >
    <td colspan=3><FONT  SIZE=2  FACE="verdana,Arial"><b><?=$LDMenu ?></b><p>
<?=nl2br($content[menu]) ?>	
 </td>
  </tr>
...
<a href="cafenews.php?sid=<?="$ck_sid&lang=$lang" ?>"><img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0> <?=$LDBack2CafeNews ?></a></td>
  </tr>
 </table>
