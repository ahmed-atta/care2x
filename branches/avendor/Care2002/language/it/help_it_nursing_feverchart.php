...
<ul> <b>1: </b>Selezionare sul grafico in prossimit&agrave della data desiderata.<br>
		...
		<b>5: </b>Premere il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare i dati appena inseriti.<br>
		<b>6: </b>Se si desidera correggere un errore, clickare sul dato sbagliato e sostituirlo.<br>
		<b>5: </b>Alla fine, clickare il bottone <img src="../img/en/en_close2.gif" border=0> per chiudere la finestra e ritornare al grafico.<br>
...
<ul> <b>1: </b>Selezionare "<span style="background-color:yellow" >dieta</span>" in corrispondenza della data desiderata.<br>
		...
		<b>4: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare il nuovo piano.<br>
  		<b>Nota: </b>Per annullare l'operazione, clickare il bottone <img src="../img/en/en_cancel.gif" border=0 align="absmiddle">.<br>
		<b>5: </b>Per correggere un errore, clickare sul dato sbagliato e sostituirlo con quello giusto.<br>
		<b>6: </b>Al termine, clickare il bottone <img src="../img/en/en_close2.gif" border=0> per tornare al grafico.<br>
		<font color="#000099" size=1><a href="#howto"><img src="../img/arrow-t.gif" width=12 height=12 border=0> Tornare a "Come fare per ...."</a></font>
</ul>
...
<ul> 
	...
	<b>3: </b>Inserire allergie o CAVE nel campo<br> "<span style="background-color:yellow" > Inserire qui le nuove informazioni: </span>".<br>
  		...
  		<b>Nota: </b>Per annullare l'operazione, clickare il bottone <img src="../img/en/en_cancel.gif" border=0 align="absmiddle">.<br>
		<b>4: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare.<br>
...
<ul> 
	...
	<b>6: </b>Inserire il proprio nome nel campo "<span style="background-color:yellow" > Terapeuta: </span>".<br> 
  		<b>Nota: </b>Per annullare l'operazione, clickare il bottone <img src="../img/en/en_cancel.gif" border=0 align="absmiddle">.<br>
		<b>7: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> to save the medication plan.<br>
		<b>8: </b>Se si desidera correggere un errore, clickare sul dato sbagliato e sostituirlo.<br>
		<b>9: </b>Al termine, clickare il bottone <img src="../img/en/en_close2.gif" border=0> per tornare al grafico.<br>
		<font color="#000099" size=1><a href="#howto"><img src="../img/arrow-t.gif" width=12 height=12 border=0> Tornare a "Come fare per ...."</a></font>
</ul>
...
<ul> 
	...
	<b>4: </b>Inserire il dosaggio, il terapeuta e/o i simboli di inizio/fine.<br>
		...
		<b>6: </b>Selezionare il bottone <img src="../img/en/en_savedisc.gif" border=0> per salvare.<br>
		<b>7: </b>Se si desidera correggere un errore, clickare sul dato sbagliato e sostituirlo.<br>
		<b>8: </b>Al termine, clickare il bottone <img src="../img/en/en_close2.gif" border=0> per tornare al grafico.<br>
		<font color="#000099" size=1><a href="#howto"><img src="../img/arrow-t.gif" width=12 height=12 border=0> Tornare a "Come fare per ...."</a></font>
</ul>
...
<br>
		...
		<b>4: </b>Selezionare il bottone <img src="../img/en/en_searchlamp.gif" border=0> per avviare la ricerca.<br>
...
<ul><b>1: </b>Prima di tutto, cercare il paziente inserendo una parola chiave in uno dei tanti campi di ricerca.<br>
		...
		<b>2: </b>Selezionare il bottone <img src="../img/en/en_searchlamp.gif" border=0> per avviare la ricerca.<br>
...
<b>Nota: </b>Per annullare l'operazione, clickare il bottone <img src="../img/en/en_cancel.gif" border=0 align="absmiddle">.</ul>
<? elseif($src=="remarks") : ?>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
...
<ul>Selezionare il bottone <img src="../img/en/en_close2.gif" border=0 align="absmiddle"> per chiudere la finestra.<p>
</ul>
...
<ul><br>
		...
		<b>6: </b>Selezionare il bottone <img src="../img/en/en_close2.gif" border=0 align="absmiddle"> per ritornare alla lista occupazione letti.<p>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
