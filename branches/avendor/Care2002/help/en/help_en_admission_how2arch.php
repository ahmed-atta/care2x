...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all admitted patients between two dates inclusive</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all MALE admitted patients </b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all FEMALE admitted patients </b></font>
<ul> <b>Step 1: </b>Click the radio button "<input type="radio" name="r" value="1">female". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="SEARCH">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all ambulant admitted patients </b></font>
<ul> <b>Step 1: </b>Click the radio button "<input type="radio" name="r" value="1">Ambulant". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="SEARCH">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all stationary admitted patients</b></font>
<ul> <b>Step 1: </b>Click the radio button "<input type="radio" name="r" value="1">Stationary". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="SEARCH">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all self paying patients </b></font>
<ul> <b>Step 1: </b>Click the radio button "<input type="radio" name="r" value="1">Self pay". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="SEARCH">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all privately insured patients </b></font>
<ul> <b>Step 1: </b>Click the radio button "<input type="radio" name="r" value="1">Private". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="SEARCH">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all generally insured patients </b></font>
<ul> <b>Step 1: </b>Click the radio button "<input type="radio" name="r" value="1">Insurance". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="SEARCH">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all patients insured by a given insurance organization</b></font>
<ul> <b>Step 1: </b>Enter the insurance organizations' acronym in the field "Insurance". <br>
		<b>Step 2: </b>Leave all other fields blank or empty.<br>
		<b>Step 3: </b>Click the button <input type="button" value="SEARCH">  to start the search.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I want to list all patients with a certain keyword</b></font>
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>I am searching for a certain patient with a certain keyword</b></font>
<ul> <b>Step 1: </b>Enter the keyword in the corresponding field. It can be a full word or phrase or a few letters of a word. <br>
		<ul><font size=1 color="#000099" >
