...
<ul> <b>Schritt 1: </b>Klickt auf den Kurvenbereich des gewählten Datums.<br>
		...
		<b>Schritt 5: </b>Klickt den <img src="../img/de/de_savedisc.gif" border=0> Knopf um die neue Daten zu speichern.<br>
		...
		<font color="#000099" size=1><a href="#howto"><img src="../img/arrow-t.gif" width=12 height=12 border=0> Zurück zu "Wie kann ich...?"</a></font>
</ul>
...
<ul> 
	...
	<b>Schritt 1: </b>Klickt das <img src="../img/l_arrowGrnSm.gif" width=12 height=12 border=0> Symbol auf der <span style="background-color:yellow" >linken</span> Datum Spalte der Kurve.<p>
	<li><font color="#660000"><b>Um das Datum um ein Tag vorwärts zu schieben:</b></font><br>
	<b>Schritt 1: </b>Klickt das <img src="../img/bul_arrowGrnSm.gif" width=12 height=12 border=0> Symbol auf der <span style="background-color:yellow" >rechten</span> Datum Spalte der Kurve.
                                                                     <p>
	<li><font color="#660000"><b>Um das Anfangsdatum der Kurve direkt zu setzen:</b></font><br>
	<b>Schritt 1: </b>Klickt die <span style="background-color:yellow" >rechte Maustaste</span> auf das <img src="../img/l_arrowGrnSm.gif" width=12 height=12 border=0> Symbol auf der <span style="background-color:yellow" >linken</span> Datum Spalte der Kurve.<br>
	...
	<b>Schritt 1: </b>Klickt die <span style="background-color:yellow" >rechte Maustaste</span> auf das <img src="../img/bul_arrowGrnSm.gif" width=12 height=12 border=0> Symbol auf der <span style="background-color:yellow" >rechten</span> Datum Spalte der Kurve.<br>
	<b>Schritt 2: </b>Klickt den <input type="button" value="OK"> wenn Sie nach Bestätigung gefragt werden.<br>
	<b>Schritt 3: </b>Ein kleines Fenster mit Auswahlfelder für das Datum öffnet sich.<br>
	<b>Schritt 4: </b>Wählen Sie den Tag, Monat, und Jahr aus.<br>
	<b>Schritt 5: </b>Klickt den <input type="button" value="GO"> Knopf an um das Datum zu setzen.<br>
...
<ul> <b>Schritt 1: </b>Klickt den "<span style="background-color:yellow" > Kost </span>" des gewählten Datums.<br>
		...
		<b>Schritt 4: </b>Klickt den <img src="../img/de/de_savedisc.gif" border=0> Knopf an um den Kostplan zu speichern.<br>
  		<b>Achtung! </b>Wenn Sie abbrechen möchten klickt den<img src="../img/de/de_cancel.gif" border=0 align="absmiddle"> Knopf an.<br>
...
<ul> 
	<b>Schritt 1: </b>Klickt das Symbol <img src="../img/clip.gif" width=20 height=10 border=0> (clip) nach der "<span style="background-color:yellow" > Allergie <img src="../img/clip.gif" width=20 height=10 border=0> </span>" an.<br>
...
<ul> 
	<b>Schritt 1: </b>Klickt das Symbol <img src="../img/clip.gif" width=20 height=10 border=0> (clip) nach der "<span style="background-color:yellow" > Diagnose/Therapie <img src="../img/clip.gif" width=20 height=10 border=0> </span>" an.<br>
...
<ul> 
	<b>Schritt 1: </b>Klickt das Symbol <img src="../img/clip.gif" width=20 height=10 border=0> (clip) nach der "<span style="background-color:yellow" > Besonderheiten/Nebendiagnose <img src="../img/clip.gif" width=20 height=10 border=0> </span>" an.<br>
...
<ul> 
	<b>Schritt 1: </b>Klickt das Symbol <img src="../img/clip.gif" width=20 height=10 border=0> (clip) nach der "<span style="background-color:yellow" > Antikoagulant(ien) <img src="../img/clip.gif" width=20 height=10 border=0> </span>" an.<br>
...
<ul> 
	<b>Schritt 1: </b>Klickt das Symbol <img src="../img/clip.gif" width=20 height=10 border=0> (clip) nach der "<span style="background-color:yellow" > Angaben <img src="../img/clip.gif" width=20 height=10 border=0> </span>" an.<br>
...
<ul> 
	...
	<b>Schritt 6: </b>Geben Sie Ihren Namen in das Feld "<span style="background-color:yellow" > Schwester/Pfleger: </span>" ein.<br> 
  		<b>Achtung! </b>Wenn Sie abbrechen möchten klickt den<img src="../img/de/de_cancel.gif" border=0 align="absmiddle"> Knopf an.<br>
		<b>Schritt 7: </b>Klickt den <img src="../img/de/de_savedisc.gif" border=0> Knopf an um den Medikationsplan zu speichern.<br>
		...
		<b>Schritt 9: </b>Wenn Sie fertig sind klickt den <img src="../img/de/de_close2.gif" border=0> Knopf an um das Fenster zu schliessen und in die Kurve zurück zu gehen.<br>
		<font color="#000099" size=1><a href="#howto"><img src="../img/arrow-t.gif" width=12 height=12 border=0> Zurück zu "Wie kann ich...?"</a></font>
</ul>
...
<ul> 
	...
	<b>Schritt 4: </b>Geben Sie entweder die Verabreichung, Dosierung, Name des Verabreichers, oder Symbole für Beginn oder Ende der Verabreichung ein.<br>
		...
		<b>Schritt 6: </b>Klickt den <img src="../img/de/de_savedisc.gif" border=0> Knopf an um die Information zu speichern.<br>
		...
		<b>Schritt 8: </b>Wenn Sie fertig sind klickt den <img src="../img/de/de_close2.gif" border=0> Knopf an um das Fenster zu schliessen und in die Kurve zurück zu gehen.<br>
		<font color="#000099" size=1><a href="#howto"><img src="../img/arrow-t.gif" width=12 height=12 border=0> Zurück zu "Wie kann ich...?"</a></font>
</ul>
