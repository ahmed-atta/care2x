			...
			else
			{
				print "<p>".str_replace("~nr~",$linecount,$LDFoundNrData)."<br>$LDClk2SeeInfo<p>";
					...
					while($zeile=mysql_fetch_array($ergebnis))
					{
						...
						print '
									<td valign="top"><a href="'.$thisfile.'?sid='.$ck_sid.'&lang='.$lang.'&keyword='.$zeile[bestellnum].'&mode=search&from=multiple&cat='.$cat.'"><img src="../img/info3.gif" width=16 height=16 border=0 alt="'.$LDOpenInfo.$zeile[artikelname].'"></a></td>
									...
									<td valign="top"><a href="'.$thisfile.'?sid='.$ck_sid.'&lang='.$lang.'&keyword='.$zeile[bestellnum].'&mode=search&from=multiple&cat='.$cat.'"><font face=verdana,arial size=2 color="#800000"><b>'.$zeile[artikelname].'</b></font></a></td>
						...
						if($bcat) print'
									<td valign="top"><a href="'.$thisfile.'?sid='.$ck_sid.'&lang='.$lang.'&mode=save&artname='.str_replace("&","%26",strtr($zeile[artikelname]," ","+")).'&bestellnum='.$zeile[bestellnum].'&proorder='.str_replace(" ","+",$zeile[proorder]).'&hit=0&cat='.$cat.'"><img src="../img/dwnArrowGrnLrg.gif" width=16 height=16 border=0 alt="'.$LDPut2Catalog.'"></a></td>';				
						print    '
									</tr>';
					}
					print "</table>";
