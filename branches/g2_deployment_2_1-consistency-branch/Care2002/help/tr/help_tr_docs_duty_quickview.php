...
<ul>Tüm ayın nöbet listesini görmek için ilgili simgeyi tıklayınız &nbsp;<button><img <?php echo createComIcon('../','new_address.gif','0','absmiddle') ?>> <font size=1>Show</font></button>.<br>
...
<li><b>Nöbet planı</b> :<ul>Tıklanabilir simge. Bölümün bütün ay için nöbet planına bağlantı. Eğer bütüm ayın nöbet planını görmek, nöbet planı düzenlemek ya da oluşturmak ister iseniz &nbsp;<button><img <?php echo createComIcon('../','new_address.gif','0','absmiddle') ?>> <font size=1>Show</font></button> düğmesine tıklayınız.</ul>
