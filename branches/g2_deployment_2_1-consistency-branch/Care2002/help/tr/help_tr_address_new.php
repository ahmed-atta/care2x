...
<ul>
	...
	<b>Step 3:</b> Bilgiyi kaydetmek için <img <?php echo createLDImgSrc('../','savedisc.gif','0') ?>> düðmesini týklayýnýz.
</ul>
...
<ul>
Bu genellikle bir PostgreSQL veritabaný kullanýr ilen olur. En büyük olasýlýk "ISO Country Code" ülke kodu girdisini boþ býrakmanýzdan kaynaklanýr.
	<p>
