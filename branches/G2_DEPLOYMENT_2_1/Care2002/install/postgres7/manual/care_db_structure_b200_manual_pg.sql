...
CREATE TABLE "care_test_findings_chemlab" (
	"batch_nr" bigint DEFAULT nextval('"testfind_clab_bnr_seq"'::text) NOT NULL,
	"encounter_nr" bigint NOT NULL,
...
--
-- Data for TOC Entry ID 437 (OID 18848)
--
...
INSERT INTO "care_menu_main" VALUES (2,5,'Person','LDPerson','modules/registration_admission/patient_register_pass.php',1,'','','20030922232015','0');
