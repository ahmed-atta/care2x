...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			<b>Jin. Op. Dr. Bülent Potur</b> 
			<p>
			 Care 2X in Türkçe'ye çevirisi. Kadın doğum uzmanıdır. Gwbasic, ms cobol, ms access ve web dizaynı ile
...
İlk Medical Informatics çalışmaları Stanford Universitesinde<br>
2 yıl Aachen, Almanya da Grünenthal GmbH da Multimedia Projesi Liderliği </font><p>
phpMyAdmin in İspanyolcaya resmi çevirmeni<br>
Ekvador'un en büyük medikal web sitesi girişiminin(www.cmpichincha.med.ec) ve Ekuador Dermatoloji Derneği  (www.sociedadecuatorianadedermatologia.org.ec) nin webmasteri 
.<br>
Web sitesi: www.cerebroperiferico.com
			<P><a href="mailto:postmaster@cerebroperiferico.com"><u>Dr. Daniel Hinostroza buradan ulaşılabilir.</u></a>
</TD></TR></TBODY></TABLE>
<hr>
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        <TBODY>
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			<b>Daniel Zilli (BR)  CARE 2X ved www.care2x.com web sitesini   brezilya-portekizcesine çevirmiştir.</b>
			<p>
...
Daniel bilgisayar eğitim ürünleri, açık kaynak yazılım ve yerel bir linux dağıtımı üreten bir şirketin de sahibidir.
			<P><a href="mailto:danielz@cco.matrix.com.br"><u>Daniel Zilli ye buradan ulaçabilirsiniz.</u></a>
</TD></TR></TBODY></TABLE>
<hr>
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        <TBODY>
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			<b>Daniele Frijia (DE) CARE 2X in güvenlik yönlerini kontrol etmiştir .</b>
			<br>
		    ...
		    <p>
			Daniele Frijia (doğumu 81), halen Almanya Nurembergte bir servis sağlayıcı şirkette çalışıyor. php bilgisini Care2x in güvenliğini artırmaya harcıyor. Amacı açık kaynak topluluğu için yeni bir pazarı "medikal" açmak.
...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			<b>Gabriele Cicala (IT)  www.care2x.com websitesinin çoğunu italyancaya çevirmiştir.</b>
			<p>
			Gabriele Cicala güney İtalyada Calabriadaki Rossano'da 1970 te doğmuştur.
 Torino Politeknik üniversitesi Telekomünikasyon mühendisliği bölümü mezunudur. Halen bir enformatik şirketinde danışman olarak çalışmaktadır.  <p>Linuxla ve açık kaynak ortamı ile tanıştığından beri bu hareketteki her proje ile çok ilgilenmektedir. Ne bir medikal mesleği olmaması ne de medikal sektörde çalışmamasına rağmen Care projesine katılmaya karar vermiştir. Çünkü Care in yaratıcısı ve de katkıda bulunanlarının inandıkları aynı şeylere o da inanmaktadır.
			...
			<P><a href="mailto:gabcicala@tiscali.it"><u>Gabriele Cicala ya buradan erişilebilir.</u></a>
</TD></TR></TBODY></TABLE>
<hr>
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        <TBODY>
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			<b>Giuseppe Scarpi (IT)  CARE 2X i italyancaya tercüme etmiştir.</b>
			<p>
			Giuseppe Scarpi 35 yıl önce Roma İtalya'da doğmuştur. 
...
Hem  Linux ve Windowsu kullanmakta ve takdir etmektedir, "<i>çünkü her ikisi de çok büyük insan emeğinin ürünüdür ve saygı gösterilmelidir.</i>".<p>
...
<table cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <tr>
          <td vAlign=top><font face="verdana,arial" size=2>
			...
			Aynı zamanda pekçok  GNU/GPL projesinde katılımcıdır. Bunların bir kısmı  Care2x's sitesinde kullanılmaktadır.<br>
...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			Brezilyada pazarlama kampanyaları<p>
			...
			<P><a href="mailto:luca@camocim.com"><u>Luca Romoli ye buradan erişilebilir.</u></a>
</TD></TR></TBODY></TABLE>
...
<hr><TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			<b>Matej Hausenblas (FR) CARE2X in fransızca tercümelerini yapmıştır</b>
			<p>
Matej Hausenblas 1981 de Çek Cumhuriyetinde Pragda doğmuştur. Matematik-enformatik-fizik üzerine üniversite öğrencisidir. Birkaç yıl windows kullandıktan sonra Linuxa değerli bir seçenek olarak bakmaya karar vermiş ve bir süre sonra bazı becerilerini geliştirmek ve geriye birşeyler vermek ve aynı zamanda bu toplulukta işlerin nasıl yürüdüğünü görmek için Açık Kaynak Projelerinde görev almaya karar vermiştir.
			<P><a href="mailto:matejh@users.sourceforge.net"><u>Matej Hausenblas a buradan erişilebilir.</u></a>
</TD></TR></TBODY></TABLE>
...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			<P><a href="mailto:nino@kflog.org"><u>Nino Novak buradan ulaşılabilir.</u></a>
</TD></TR></TBODY></TABLE>
...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			<P><a href="mailto:noelrv@nipahut.org"><u>Noel Villamor buradan erişilebilir.</u></a>
</TD></TR></TBODY></TABLE>
<hr>
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        <TBODY>
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			<b>Patxi Gomaríz (ES) ispanyolca çevirileri yapmıştır.</b>
			<p>
			Patxi Gomaríz 1966 baharında Murcia İspanya'da doğmuştur. Hayatı ve işi çoğunlukla fotoğrafçılık üzerine döner. Oftalmolojik fotoğrafçılıkta (fundus kamerası) uzmandır. İnternet hayranıdır,  web siteleri dizaynı da yapmaktadır.<p>
			"<i>Bilhassa insanlık için önemli olan sağlık gibi temel alanlarda ekonomik küreselleşmenin olumsuz etkilerine karşı açık kaynak kodunun etkili bir silah olduğunu düşünüyorum. Nu nedenle bu büyük projeye yaptığım küçük katkım ile gurur duyuyorum..</i>"
...
<TABLE cellSpacing=0 cellPadding=0 border=0 width=100%>
        ...
        <TR>
          <TD vAlign=top><font face="verdana,arial" size=2>
			...
			Tam test <br>
			Hata bulma<br>
			DB 'optimist kilitleme kavramıt<br>
			DB iyileştirmeler<br>
...
<p>
Wei Ning Chen  1971 de doğu Çin'de Yangzi ırmağının yanındaki Nanjing de doğdu.
<p>
1992 de Doğu Çin Enstitüsünde Mühendislikte bir derece aldıktan sonra , Wei Ning Chen programlama becerilerini geliştirmeye devam etmektedir.
...
<hr>
<font face="verdana,arial" size=3 color="#0000ff">Daha fazla yazar</font>
...
<table border=0 cellspacing=1 cellpadding=1>
  ...
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;Grafik dizaynlar,, web sitesi dizaynı</font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;Norveççe çeviri ve online demo</font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;ecomscience.com, full time programcılar</font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#f9f9f9"><font face="verdana,arial" size=2>&nbsp;&nbsp;Ataraxia (WAP) modulü</font></td>
  </tr>
</table>
