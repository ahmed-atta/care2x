...
<STRONG>&nbsp; &nbsp; Verwaltung</STRONG></FONT></td>
...
print '<tr bgcolor=#ffffff><td><font face=verdana,arial size=2> '.$dept[$i].'</td>
		<td><font face=verdana,arial size=2><a href="#"><img src="../img/info.gif" width=12 height=17 border=0 alt="Click für mehr Info über die Ausbildung."></a></td>		
