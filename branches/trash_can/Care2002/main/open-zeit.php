...
<td bgcolor="<? print $cfg['top_bgcolor']; ?>" height="10" ><FONT  COLOR="<? print $cfg['top_txtcolor']; ?>"  SIZE=+3  FACE="Arial"><STRONG>&nbsp; &nbsp; Öffnungszeiten</STRONG></FONT></td>
<td bgcolor="<? print $cfg['top_bgcolor']; ?>" height="10" align=right>
<?if($cfg['dhtml'])print'<a href="#" onClick=history.back()><img src="../img/zuruck.gif" border=0 style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)></a>';?>
...
<FONT    SIZE=-1  FACE="Arial">
   ...
   <tr>
    ...
    <tr bgcolor=#ffffff>
      <td><font face="Verdana,arial" size=2><b>Tag</b></font></td>
      <td><font face="Verdana,arial" size=2><b>Öffnungszeiten</b></font></td>
      <td><font face="Verdana,arial" size=2><b>Besuchszeiten</b></font></td>
    </tr>
	<? for ($i=0;$i<sizeof($tage);$i++){
print '<tr bgcolor=#ffffff><td><font face=verdana,arial size=2> '.$tage[$i].'</td><td><font face=verdana,arial size=2><nobr>  '.$times[$i].'</td><td><font face=verdana,arial size=2><nobr> '.$visits[$i].'</td></tr>';
print "\r\n";
}
?>
  </table>
