...
(<?php echo $HTTP_SESSION_VARS['sess_en']; ?>)</font></td>
  ...
  <tr>
	...
	<table width="100%" border="0">
	  <tr>
		<td width="25%" bgcolor="#CAD3EC"><div align="center"><input type="button" name="show" value="Quicklist" onClick="javascript:submit_form(this,'icd10_quicklist.php','<?php echo $sid ?>','')">
		</div></td>
