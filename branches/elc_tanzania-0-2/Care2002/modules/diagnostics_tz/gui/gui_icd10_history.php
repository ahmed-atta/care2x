  ...
  <tr>
	...
	<table width="100%" border="0">
	  <tr>
		...
		<td width="20%" bgcolor="#CAD3EC"><div align="center"><input type="button" name="show" value="History" onClick="javascript:submit_form(this,'icd10_history.php','<?php echo $sid ?>','')">
		</div></td>
