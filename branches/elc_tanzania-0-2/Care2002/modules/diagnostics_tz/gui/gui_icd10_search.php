          ...
          <tr>
            <td width="100%" align="center">
                  <table border="0" cellpadding="0" cellspacing="0">
                  	...
                  	<tr>
                  		<td>
                  			<input type="radio" value="exact" name="search_mode"<?php if(!$search_mode || $search_mode=="exact") echo "checked"; ?>> <?php echo $LDExactSearch; ?>
                  		</td><td align="right">
                  			<input type="radio" value="fuzzy" name="search_mode"<?php if($search_mode=="fuzzy") echo "checked"; ?>> <?php echo $LDFuzzySearch; ?>
                  		</td>
                  	</tr>
                  </table>
                  <br>
