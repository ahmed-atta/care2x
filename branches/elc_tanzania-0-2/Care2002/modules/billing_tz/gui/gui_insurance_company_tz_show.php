	...
	<tr>
		<td  valign="top" align="middle" height="35">
          ...
          <tr valign=top  class="titlebar" >
            <td bgcolor="#99ccff" >
                &nbsp;&nbsp;<font color="#330066">Details of <?php echo $this_insurance['CompanyName']; ?></font>
	...
	<tr>
		<td bgcolor=#ffffff valign=top>
				...
				<table border="0" cellpadding="2" cellspacing="0">
					...
					<tr bgcolor=ffffaa>
						<td><?php $insurance_tz->ShowRedIfError('Insurance type',$error['InsuranceName']);?>:</td>
						<td><?php echo $this_insurance['InsuranceName']; ?></td>
					</tr>
					<tr bgcolor=ffffee>
						<td>Pay by invoice:</td>
						<td><?php if($this_insurance['invoice_flag']) echo 'Yes'; else echo 'No';?></td>
					</tr>
				</table>
				</form>
			<p>
