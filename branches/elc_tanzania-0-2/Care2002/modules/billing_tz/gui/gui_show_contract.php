...
?>
  <tr>
    <td>
    	<b>SELIAN LUTHERAN HOSPITAL PRE-PAID
   MEDICAL CARE PLAN</b><br><br>
...
<table border="0" cellpadding="0" cellspacing="0" width="400">
	...
	<tr>
		<td>ADDRESS:</td><td><b>PO Box:<?php echo $company['po_box'].'<br>
			Location:'.$company['city']; ?></b></td>
	</tr>
</table><br><br>

It is hereby agreed by Selian Lutheran Hospital and <b><?php echo $company['name']; ?></b><br>
To enter into an agreement for the provision of medical care by Selian Lutheran Hospital <br>
to __________________________ employees and families.<br><br>

Selian Lutheran Hospital agrees to provide hospital and clinic based medical care to<br>
...
and medications which are routinely available and on site at the Selian Lutheran Hospital<br>
and the Selian Lutheran Hospital Arusha Town Clinic. This include the following services:<br><br>

 Arusha Town Clinic Office Outpatient Care<br>
 Selian Hospital Outpatient Department<br>
 Selian Inpatient Wards - Medicine, Surgery, Obstetrics, Gynacology and Paediatrics<br>
 Selian Hospital Labor and Delivery<br>
 Surgical Theatre<br>
...
Revised for January 2005<br><br><br><br>
...
The per capital charge per annum for each registered member is 30,000.- (thirty <br>
thousand only) for the Tembo Silver Plan and 40,000.- (forty thousand) for the <br>
Tembo Gold Plan. This is payable in an annual, semi annual, or quarterly<br>
installments to be paid the first day of January, April, July and October.<br><br>

The following conditions apply:<br><br>
...
<li>Services required or desired beyond what is available at Selian LUtheran
 Hospital and the Arusha Town Clinic are the responsibility of the patient
 and the employer and not of Selian Lutheran Hospital.</li>
...
<li>An absolute annual individual maximum of 150,000 TSH in care for Gold
 Plan Members and 100,000 TSH for Silver Plan Members applies to all
 members in the! plan.</li></ol><br><br><br>
...
Existing employees must return their plan identification cards to Selian at the <br>
