			 ...
			 <table cellspacing="0"  class="titlebar" border=0>
 				<tr valign=top  class="titlebar" >
  					<td width="202" bgcolor="#99ccff" >
    					&nbsp;&nbsp;<font color="#330066">Reporting :: Company report </font></td>
						  <td width="408" align=right bgcolor="#99ccff">
						   ...
						   <?php } else if ($_GET['back_path']=="billing") {?>
						   <a href="<?php echo $root_path;?>modules/billing_tz/insurance_tz.php" ><img src="../../gui/img/control/default/en/en_close2.gif" border=0 width="103" height="24" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this,1)" onMouseOut="hilite(this,0)"></a>
						   <?php } ?>  
						  </td>
  					 </tr>
 </table>	
		...
		<TD><table cellpadding=3 cellspacing=1>
          <tbody class="submenu">
            <tr>
              ...
              <td width="149" class="submenu_item"><a href="company_summary.php">Company</a> </td>
              <td width="460">List of all members of a specific company</td>
            </tr>
