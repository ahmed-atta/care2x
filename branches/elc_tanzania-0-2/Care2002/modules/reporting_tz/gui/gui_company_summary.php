...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  <td width="202" bgcolor="#99ccff" >
    &nbsp;&nbsp;<font color="#330066">Reporting:: Company Record</font></td>
...
<!-- END HEAD OF HTML CONTENT -->
						...
						<form name="form1" method="post" action="">				
							...
							<?php require_once($root_path.$top_dir.'include/inc_gui_company_selection.php'); ?>			
						  <br><br><br>
                          <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor=#ffffdd>
                          <?php $rep_obj->DisplayCompanyTableHead();?>

						  <?php $rep_obj->DisplayCompanyTestSummary($start_timeframe, $end_timeframe);?>
						  <?php $rep_obj->DisplayCompanyResultRows($start_timeframe, $end_timeframe);?>
                          </table>
				</form>			  
						  <br><br><br>						  
