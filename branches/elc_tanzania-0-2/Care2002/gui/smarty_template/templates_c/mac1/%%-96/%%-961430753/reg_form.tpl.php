<?php /* Smarty version 2.6.0, created on 2004-07-03 16:08:01
...
&nbsp;&nbsp; <?php echo $this->_tpl_vars['sSexF']; ?>
			...
			<?php endif; ?>
				...
				<tr>
					<td class="reg_item" class="reg_input">
						<?php echo $this->_tpl_vars['LDStreet']; ?>
 ...
 <?php echo $this->_tpl_vars['sTownCityMiniCalendar']; ?>
					...
					<td class="reg_input">
						<?php echo $this->_tpl_vars['LDZipCode']; ?>
 &nbsp;&nbsp; <?php echo $this->_tpl_vars['sZipCodeInput']; ?>
