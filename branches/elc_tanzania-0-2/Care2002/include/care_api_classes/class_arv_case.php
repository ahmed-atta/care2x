...
//------------------------------------------------------------------------------------------------------------------------------------------------
	...
	function displayAllARVvisits() {
    	...
    	while ($this->row_elem = $this->res->FetchRow()) {
	    	...
	    	$table_string.="<td width=\"97\"  $BGCOLOR><a class=\"blue\" href=\"javascript:printOut('arv_print.php".URL_APPEND."&arv_visit_id=".$this->row_elem['care_tz_arv_visit_id']."&mode=edit&pid=".$this->pid."')\">print&gt;&gt;</a></td>";
	    	$table_string.="<td width=\"102\" $BGCOLOR><a class=\"blue\" href=\"arv_visit.php".URL_APPEND."&arv_visit_id=".$this->row_elem['care_tz_arv_visit_id']."&mode=edit&pid=".$this->pid."\">edit&gt;&gt;</a></td>";
	  		$table_string.="</tr>";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	function displayARVData() {
		global $date_format;
		if(!$this->getFacilityInfo()) return false;
