...
<?php 
				...
				{
					echo '<input name="addr_citytown_name" type="text"><a href="javascript:popSearchWin(\'citytown\',\'aufnahmeform.addr_citytown_nr\',\'aufnahmeform.addr_citytown_name\')"><img '.createComIcon($root_path,'b-write_addr.gif','0').'></a>';
				}
				?>	
