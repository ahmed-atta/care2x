<?php
$LDMainTitle='Sistema Integrado de Informação Hospitalar CARE 2X';
...
$LDAlertOldBrowser='A versão do seu navegador é mais velha do que 5.0!<br> Nós
recomendamos a versão 5.0 ou superior. <br> O uso de versões anteriores podem
acarretar num funcionamento inseguro do programa.';
$LDAlertNoCookie='Você ou seu navegador podem ter rejeitado o(s)
cookie(s).<br>Este programa é dependente deles. Do contrário o programa não
funcionará¡ adequadamente.<br>Por favor configure o seu navegador para
automaticamente aceitar cookies.<br>';
$LDClkAfter='Mais tarde clique aqui.';
