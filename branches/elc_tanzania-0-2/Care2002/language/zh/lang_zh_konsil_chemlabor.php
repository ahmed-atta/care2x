<?php
$LDDiagnosticTest='Õï¶Ï²âÊÔ¶©µ¥';
$LDHospitalName='CARE 2002';
$LDCentralLab='ÖÐÑëÊµÑéÊÒ';
$LDLabel='±êÇ©';
$LDRoomNr='·¿¼äºÅ';
$LDSamplingTime='²ÉÑùÊ±¼ä';
$LDDay='Ìì';
$LDMinutes='·ÖÖÓ';
$LDHours='Ð¡Ê±';
$LDBatchNr='Åú´Î±àºÅ';
...
$LDBLoodSugar1='BLS1';
$LDBloodPlasma='BLP';
$LDDoctorSignature='Ò½ÉúÇ©Ãû';
$LDLifeRisk='Risk to life';
$LDRarity='Rarity';
$LDSpecTest='ÌØÊâ²âÊÔ';
$LDClinicalInfo='ÁÙ´²ÐÅÏ¢';
$LDShortMonth=array('',
                    'Ò»ÔÂ',
                    '¶þÔÂ',
                    'ÈýÔÂ',
...
$LDShortDay=array('ÖÜÈÕ','ÖÜÒ»','ÖÜ¶þ','ÖÜÈý','ÖÜËÄ','ÖÜÎå','ÖÜÁù','ÖÜÈÕ');
                
$LDBatchNumber='Åú´Î±àºÅ';
$LDMaterial='²ÄÁÏ£º';
$LDEmergencyProgram='ÓÐ×ÏÉ«ÒõÓ°µÄ×Ö¶ÎÓÃÓÚ½ô¼±³ÌÐò';
$LDPhoneOrder=' = ±ØÐëÍ¨¹ýµç»°È·ÈÏ';
/* 2002-09-03 EL */                              
$LDSearchPatient='²éÕÒ²¡ÈË';
$LDPlsSelectPatientFirst='ÇëÏÈËÑË÷²¡ÈË¡£';
/* 2002-09-11 EL */
$LDPendingTestRequest='´ý´¦ÀíµÄ²âÊÔÇëÇó';
/* 2002-10-14 EL */
$LDDone='ÒÑÍê³É£¡×ªÒÆ´Ë±íµ¥µ½ÎÄ¼þ¼ÐÖÐ';
