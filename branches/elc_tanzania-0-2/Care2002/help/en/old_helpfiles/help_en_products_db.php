...
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
How to edit an article?</b>
</font>
<ul>       	
 	<b>Step 1: </b>Click the button <img <?php echo createComIcon('../','hammer.gif','0') ?>>.<br>
</ul>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
How to delete an article?</b>
</font>
<ul>       	
 	<b>Step 1: </b>Click the button <img <?php echo createComIcon('../','delete.gif','0') ?>>.<br>
</ul>
	<?php endif;?>
	<?php if($x1=="multiple") : ?>
<img <?php echo createComIcon('../','frage.gif','0') ?>> <font color="#990000"><b>
