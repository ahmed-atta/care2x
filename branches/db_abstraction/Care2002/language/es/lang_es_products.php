...
$LDNewsTxt='Leer o escribir noticias referentes a la farmacia';
...
$LDRemoveList='Borrar esta lista';
...
$LDSendOrder='Enviar esta lista de pedido.';

$LDBack2Edit='Volver y editar la lista.';

$LDEndOrder='Terminar el pedido.';

$LDCreateBasket='Empezar una nueva lista de pedidos.';
...
$LDArchindex=array('&nbsp;','&nbsp;','Lista pedida por:','Recibida el:','a las:','&nbsp;','Procesado el: a las:','por:');
...
$LDNewProductTxt='Ingrese un nuevo producto de farmacia en el banco de datos';
...
$LDNewOrder='Acaba de llegar la siguiente lista de pedidos.';

$LDNewOrderMany='Acaban de llegar las siguientes listas de pedidos.';
...
$LDOrderPrint='Imprima la lista de pedidos';

$LDOrder2Archive='Mueva la lista de pedidos al archivo';
...
$LDWriteReport='Escribir reporte';

$LDReportSent='El reporte ha sido enviado';
...
$LDDepotOrderBot='Medibot, Bot para médicos';

/* 2002-10-15 EL */

$LDCreatedOn='Creado el';
