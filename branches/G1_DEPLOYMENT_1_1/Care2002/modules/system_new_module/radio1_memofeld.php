...
$sql_code="CREATE TABLE test2 (id INT NOT NULL AUTO_INCREMENT ,n1 VARCHAR( 30 ) NOT NULL ,n2 VARCHAR( 30 ) NOT NULL ,PRIMARY KEY ( id ));";
?>
<p>
...
<textarea onmouseover="this.style.backgroundColor='#ffff00'; this.style.color='#0000ff' "  onmouseout="this.style.backgroundColor='#ffff99'; this.style.color='#000000' "  style="background:ffff99" name="sqlstring" cols="63" rows="10" ><?echo $sql_code;?></textarea><br/><br/><br/>
...
<input type='text'   name="suchfeld" value="sort_nr">
    <FONT FACE='ARIAL' color="<?php echo $cfg['top_txtcolor']; ?>"><?php echo $nenne_suchfeld; ?></FONT><br/>
<input type='text'   name="tabellentitel" value="Testtabelle">
