...
$mainline[34]="require(\$root_path.\"include/std_include_parts/footnote.inc.php\");\n";
$mainline[35]="?>\n";
...
fclose($datei);
if ($leere_seite=="0"){
   echo "Die vorletzte Datei des Moduls $ModulNeuBez wurde generiert.<br/>";
   }
else {
   echo "Die letzte Datei des Moduls $ModulNeuBez wurde generiert.<br/>";
	 }
//echo "Die Haupt-Datei-1 des Moduls ".$ModulNeuBez." wurde generiert.<br/>";
//Kontrollausgabe ob Patinetenbezogenes Modul gewünscht oder nicht
//echo "<br/>".$pat_bez;
