...
$TXT['EnterNameHS']='Leistungsname eigeben';
...
$TXT['TestCode']='Leistung/Untersuchungskennummer';
$TXT['PriceUnit']='Preis pro Einheit';
$TXT['EnterValueDiscount']='Rabatt (in %)';
$TXT['NameLT']='Name der Laboruntersuchung';
$TXT['LabTestItem']='Laboruntersuchung';
$TXT['Discount']='Rabatt';
$TXT['Code']='Kennummer';
$TXT['Name']='Name';
$TXT['CostPerUnit']='Preis pro Einheit';
$TXT['HospitalServiceItems']='Krankenhausleistungen';
$TXT['LabTestItems']='Laboruntersuchungen';
...
$TXT['PatientAddress']='Adresse';
$TXT['PatientType']='Aufnahmeart';
$TXT['DateofBirth']='Geburtsdatum';
$TXT['Sex']='Geschlecht';
$TXT['DateofAdmission']='Aufnahmedatum';
$TXT['BillingInformation']='Rechnungsdaten';
$TXT['Description']='Beschreibung';
$TXT['CostperUnit']='Preis pro Einheit';
$TXT['Units']='Einheiten';
$TXT['TotalCost']='Gesamtkosten';
$TXT['ItemType']='Produktart';
$TXT['MedicalServices']='Medizinische Leistungen';
$TXT['LaboratoryTests']='Laboruntersuchungen';
$TXT['Total']='Gesamt';
$TXT['TotalBillAmount']='Gesamtwert der Rechnung';
$TXT['OutstandingAmount']='Anstehender Wert';
$TXT['AmountDue']='Noch zu bezahlen';

/* 2003-10-19 DHC Echoes from show_final_bill.php */
$TXT['DiscountonTotalAmount']='Rabatt an Gesamtwert (%)';
$TXT['AmountAfterDiscount']='Wert nach Rabatt';
$TXT['AmountPreviouslyReceived']='Vorbezahlter Wert';
$TXT['CurrentPaidAmount']='Jetzige Zahlungswert';

/* 2003-10-19 DHC Echoes from show_final_bill.php */
$TXT['Payments']='Zahlungen';
$TXT['ReceiptNumber']='Belegnummer';
$TXT['ReceiptDateTime']='Belegsdatum und -Zeit';
$TXT['MakeaNewPayment']='Neue Anzahlung';
...
$TXT['CardNumber']='Kreditkartennummer';
$TXT['CCType']='Art von Kreditkarten';
$TXT['CheckNumber']='Schecknummer';

/* 2003-10-25 DHC Echoes from showpayment.php */
$TXT['ModeofPayment']='Zahlungsart';
...
$LDPatientName='Patientename';
$LDeComBill='eComBill';
$LDSearch='Suche';

# 2003-10-20 NDHC this line doesn't work because it's inside an "alt=".  eComBill Search.php
$LDBillthisPatient='Rechnung erstellen';

# 2003-10-25 NDHC eComBill confirmpayment.php
$LDBillPayment='Zahlung';
$LDPaymentPreview='Zahlungsvoranzeige';
$LDGeneralInfo='Allgemeine Daten';
$LDReceiptNumber='Belegnummer';
$LDPatientAddress='Adresse';
$LDBillDate='Rechnungsdatum';
$LDPatientType='Aufnahmeart';
$LDDateofBirth='Geburtsdatum';
$LDSex='Geschlecht';
$LDPatientNumber='Aufnahmenummer';
$LDDateofAdmission='Aufnahmedatum';
$LDPaymentInformation='Zahlungsdaten';
$LDModeofPayment='Zahlungsart';
$LDCash='Bar';
$LDAmount='Wert';
$LDCreditCard='Kreditkarten';
$LDCheck='Scheck';
$LDCheckNumber='Schecknummer';
$LDCardNumber='Kreditkartennummer';
?>
