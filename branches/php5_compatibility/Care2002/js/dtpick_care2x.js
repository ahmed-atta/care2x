...
// Modified by ELpidio Latorilla 2003-06-20, i18N of month names
...
Calendar.prototype.show = function() {
	...
	this.wwrite("</head>");
	this.wwrite("<body onLoad=\"if(window.focus) window.focus()\" /" + 
...
Calendar.prototype.showY = function() {
	...
	this.wwrite("<html>");
	this.wwrite("<head><title>eMPower:Calendar</title>");
...
Calendar.prototype.cal_header = function() {
	var vCode = "";
	// Modified by Elpidio Latorilla 2003-06-20, i18N of days
	vCode = vCode + "<TR>";
...
Calendar.prototype.format_data = function(p_day) {
	...
	switch (this.gFormat) {
		...
		case "DD-MM-YY" :
			vData = vDD + "-" + vMonth + "-" + vY2;
			break;
		// START Added by Elpidio Latorilla for care2x
		case "yyyy-MM-dd" :
		...
		case "MM\/dd\/yyyy" :
			vData = vMonth + "\/" + vDD + "\/" + vY4;
			break;
		// END Added by Elpidio Latorilla for care2x
...
function show_calendar() {
	...
	*/
	...
	p_item = arguments[0];
	// START Modified by Elpidio Latorilla for care2x
	if (arguments[1] == null)
		p_format = "MM/DD/YYYY";
	else
	...
	if (arguments[3] == "" || arguments[3] == null)
		...
		p_year = arguments[3];
	// END Modified by Elpidio Latorilla for care2x

	vWinCal = window.open("", "Calendar", 
		"width=250,height=250,status=no,resizable=no,top=100,left=100");
	vWinCal.opener = self;
	ggWinCal = vWinCal;
