...
$LDAlias='Alias';
$LDChoicePassword='Choisissez un mor de passe';
$LDPassword2x='Entrez le mot de passe de nouveau';
$LDRegister='Inscription';
$LDNewReg='Un nouvel utilisateur peut s\'inscrire ici.';

$LDInbox='Boite de reception';
$LDNewEmail='Nouvel email';
...
$LDReadEmail='Lire un email';
$LDEmailCount='Vous avez <font size=2 color="#000000"><b>~nr~ Email(s) nonlu(s)</b></font> dans votre boite de reception.';
$LDSortDate='Trier par date';
$LDSubject='Sujet';
$LDDate='Date';
$LDTime='Heure';
$LDSize='Taille';
...
$LDTo='A';
$LDSend='Envoyer';
$LDSave2Draft='Sauver comme brouillon';
$LDShowAll='Tout afficher';
$LDChange='Modifier';
...
$LDClk4Printer='Cliquer pour afficher une version imprimable';
$LDPrinterVersion='Version imprimable';
$LDAskDeleteMail='Etes-vous sur de vouloir effacer cet mail?';
$LDPrint='Imprimer';
$LDAttach='Attacher';
$LDEmailAddr='Adresse Email';
$LDShortName='Surnom';
