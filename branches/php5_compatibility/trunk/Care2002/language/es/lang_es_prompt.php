...
$LDRelatedDocsIds='Identificaciones de los documentos relacionados';
...
$LDProceedSave='¿Desea guardar los datos?';
#2003-08-28 EL
$LDPlsSelectWard='Por favor, seleccione un pabellón o estación';
# 2003-09-20 EL
$LDPlsEnterTherapy='Por favor, escriba la terapia';
$LDPlsMedicalAdvice='Por favor, especifique si el paciente recibió consulta médica o no.';
# 2003-09-23 EL
$LDPlsEnterJobFunction='Por favor, escriba la función laboral.';
#2003-04-10 EL
$LDPlsFillInfo='Por favor, complete los campos marcados con rojo';
$LDPlsEnterLocalization='Por favor, escriba la localización';
$LDPlsEnterNotes='Por favor escriba sus apuntes';
$LDPlsEnterClassification='Por favor, ingrese la clasificación';
$LDPlsEnterStartTime='Por favor, ingrese la fecha de inicio';
$LDPlsEnterEndTime='Por favor, ingrese la fecha de terminación';
$LDPlsEnterScrubNurse='Por favor, escriba la información acerca de la enfermera';
$LDPlsEnterORNr='Por favor, escriba el número del quirófano';
$LDWrongLoginPW='Su login o contraseña está incorrecto';
$LDPlsORNr='Por favor, escriba el número del quirófano';
