...
<html>
	...
	<body onLoad="if(window.focus) window.focus()">	
		<font face="verdana,arial" size=6 color="#0000ff">Zasluge</fonts>
		<hr>
		<table cellspacing=0 cellpadding=0 border=0	width=100%>
		  <tbody>
			<tr>
			  <td valign=top> <font	face="verdana,arial" size=2>
				<p>	<img src="../../fotos/credits/emir_prcic.jpg"  border=0	 align=right vspace=10>	<b>Emir Prcic (BS)</b>
				<p>Bosnian language translation.<br>
				Creation of Bosnian/Latin ICD10 sql data for Care2x<p>
				Born 1977 in Tuzla, Bosnia and Herzegovina.
				Graduated from Barton College in NC, USA (BS in Political Science, Computer
				Science and Mathematics)<br>
				Now, living and working as IT-Director in Germany.
				In IT business since 1992.
				Areas of expertise: Networks, Administration, ASP, VB, VBScript, C#, Java,
				JavaScript, PHP, SQL, etc....
 				<p>
				Wishes: "I wish Care2x to be the best HIS software in the world."

				<p>	<a href="mailto:e.prcic@gmx.de"><u>Emir Prcic se može kontaktirati ovde.</u></a> </td>
			</tr>
		  </tbody>
		</table>
		<hr>
		<font face="verdana,arial" size=1 color="#000000">Abecedni raspored	po imenu</fonts><br> 
		<hr>
		<table cellspacing=0 cellpadding=0 border=0	width=100%>
		  <tbody>
			<tr>
			...
			<tr> 
			  <td valign=top> <font	face="verdana,arial" size=2> 
				...
				<p><font size=1> Autor i koautor velikog broja medicinskih udžbenika<br> 
				  ...
				  2	vođa multimedijalnog projekta u "Grünenthal GmbH", Ahen, Nemačka</font> 
				<p>	zvanični prevodilac	phpMyAdmin (Španski)<br> 
				  Webmaster	najveće Ekvadorske medicinske websajt inicijative (www.cmpichincha.med.ec) i Ekvadorskog udruženja Dermatologije	(www.sociedadecuatorianadedermatologia.org.ec).<br>	
			...
			<tr> 
			  <td valign=top>
			  	<font face="verdana,arial"	size=2>	
					...
					<p>	Daniel je dibar momak koji voli da živi srećnim životom. Voli računare, fudbal, i dobru muziku. Voli računare i poseduje 10 godina iskustva u IT području. Daniel poseduje ralunarsku firmu	koja razvija proizvode za naučno obrazovanje, open	source softver	i lokalnu linux distribuciju.
		...
		<table cellspacing=0 cellpadding=0 border=0	width=100%>	
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	<b>Daniele Frijia (DE) je proverio sigurnosne aspekte CARE	2X.</b>	<br> 
				...
				<p>	Daniele	Frijia (rođen 81), trenutno radi za Internet provajdera u Nirnbergu, Nemačka, posvećuje svoje php	znanje za poboljšanje sigurnosti Care2x. Namera je da otvori novo 	"tržište" (medicinsko) za  open	source zajednicu.
		  ...
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				...
				<p>	Profesije: <br> 
				  Programer, Asistent hirurga , Elektronički & telekomunikacioni tehničar
				<p>	Područja interesovanja: <br>	
		...
		<table cellspacing=0 cellpadding=0 border=0	width=100%>	
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				<p><img	src="../../fotos/credits/gabriele_cicala.jpg"  border=0	 align=right vspace=10>	<b>Gabriele	Cicala (IT)	je preveo većinu www.care2x.com websajta na  italijanski.</b> 
				<p>	Gabriele Cicala	je rođen u Rosanu u	Kalabriji južna  Italija, 1970. Stekao je diplomu  Inžinjera Telekomunikacija na "Politecnico di Torino". Trenutno,	radi kao konsultant za informatičku firmu.
				<p>Obzirom da poznaje Linux	i open-source	okruženje, veoma je zainteresovan za svaki projekat ovog pokreta. Uprkos da ne radi niti u zdravstvenom niti u medicinskom sektoru, odlučio je da se pridruži Care zato što veruje u iste stvari u koje veruju kreator Care-a i njegovi saradnici.
		  ...
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				...
				<p>	Giuseppe Scarpi	je rođen u 	Rimu, Italija, pre 35	godina.
				<p>Poseduje diplomu iz  Elektronskog Inženjeringa i radio je za nekoliko firmi u biomedicinskom sektoru,	gde je razvio razumevanje za 	odnose između sveta medicine i sveta informatike.<br>	
				  Koristi i ceni i  Linux i Windows, "<i>obzirom da su oba proizvod velikog ljudskog rada koji mora da se ceni</i>".	
				<p>	Odlučio je da se aktivno uključi u 	open source	zato što: <br> 
		  ...
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				...
				<p><font size=1>
				  Marketing, Promocija i Donosi sa javnošću<br> 
				...
				<p>	Lopo L.	de Almeida je rođen u Angoli 1966. Zaposlen je u računarskom sektoru- ranging from commercial automation to	industrial automation -	as a software developer	and	interface designer for more	than 16	years now .	During the last	5 years	he worked mostly in	web	development	and	company	management.	He is the CEO/CTO of HumanEasy - a partner of Care2002 project in charge of	its	<b>Public Relations	and	Marketing Management</b>.<br> 
		  ...
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				...
				<p>	Luka je poslovni konsultant sa iskustvom čija su specijalnost web aplikacije. Njegovo cilj je da kreira prvu produktivnu instalaciju Care2x u Brazilskim bolnicama.
		  ...
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	<b>Matej Hausenblas	(FR) je uradio francuski prevod	CARE 2X</b>	
				<p>	Matej Hausenblas je rođen u Pragu,Češka Republika, 1981. On je student na matematičko-informatičko-fizičkom	univerzitetu.	
				Posle nekoliko godina korišćenja Windows-a odlučio je da baci pogled na Linux, i kao značajan izazov,	odlučio je da učestvuje u  
		...
		<table cellspacing=0 cellpadding=0 border=0	width=100%>	
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	<b>Nino	Novak (DE) je ažurirao nemačku stranu	www.care2x.com.</b>	
				...
				Poseduje neko naučno i medicinsko predznaje (zato se i pridružio care2x projektu).
		  ...
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				...
				<p>Završio je modul za ispis rezultata laboratorije	izboreći se pri tome sa teškim matematičkim problemima.
		  ...
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	<b>Patxi Gomaríz (ES) je uradio španske prevode.</b>	
				<p>	Patxi Gomaríz je rođen u proleće 1966 u Mursiji, Španija. Njegov rad i život su uglavnom okrenuti ka 
		...
		<table cellspacing=0 cellpadding=0 border=0	width=100%>	
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				<p><img	src="../../fotos/credits/thomas_wiedmann.jpg"  border=0	 align=right vspace=10>	<b>Thomas Wiedmann (DE)	je najaktivnije debuger</b>	
				<p>	
				<font size=1> Kempletno testiranje<br>	
				Debagovanje<br> 
				DB koncept 'optimističnog zaključavanja'<br>	
				DB optimizacije<br> 
				Skriptovi za provera datuma i brojeva	
				<p>	</font>	Thomas Wiedmann	je softver developer dugo godina i radi u Študgartu, Nemačka. Radio je sa 	Gupta Team Developer i IBM DB2 tokom  7  godina i on je  IBM Certified UDB DB2 Administrator, takođe. 
				Pročitajte više o DB2 u njegovoj knjizi "DB2" ISBN 3-932311-80-9. On je autor TOOLBOX (www.toolbox-mag.de), Nemačkog časopisa za programiranje i razvoj softvera.
			...
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				...
				<p>	Obrazovanje i kvalifikacije<br>	
				  Inženjer nauka -	Računarski inžinjering - 1999<br>	
		  ...
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				...
				<p>	Wei	Ning Chen je rođen 1971 u Nanjingu, pored Jangce reke u istočnoj Kini.
				<p>	Nakon što je stekao diplomu Inžinjeringa	od strane Institita Istočne Kine 1992 godine, Wei Ning je zatim usavršavao svoje programerske veštine.
					...
					odlučio je da učestvuje u Open Source projektima da bi poboljšao neke veštine i isto tako da  vrati kao i da vidi kako rade neke stvari u ovoj zajednici.
				<p>	Uprkos činjenici da ne radi niti u zdravstvenom niti u medicinskom sektoru, odlučio je da se priključi Care projektu zato što veruje u rezultat njegovog nastojanja	da	se Care
				 projekat u budućnosti koristi u Kineskim bolnicama.
		  ...
		  <tbody> 
			<tr> 
			  <td valign=top><font face="verdana,arial"	size=2>	
				...
				Promocije, Odnosi sa javnošću<br> 
				Konsultacije
		...
		<table border=0	cellspacing=1 cellpadding=1> 
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;eComBill modul za naplatu</font></td>	
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Grafički dizajn,	web dajt dizajn</font></td> 
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;PostgreSQL inicijalni skript i razvoj</font></td> 
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Debagovanje eCombill modula</font></td> 
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Portugalski prevod</font></td> 
		  </tr>	
		  <tr> 
		  ...
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Alternativni GUI dizajn</font></td> 
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;ecomscience.com, stalno zaposleni programer</font></td> 
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Holandski prevod, serverski paket</font></td> 
		  </tr>	
		  <tr> 
		  ...
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Sigurnosna unapređenja</font></td> 
		  </tr>	
		  <tr> 
		  ...
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Poljski prevod</font></td> 
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Češki prevod</font></td> 
		  </tr>	
		  <tr> 
		  ...
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;care2x.it miror sajt</font></td> 
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Unapređenje dizajna, izveštavanje o greškama</font></td> 
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Dodatni italijanski prevodi</font></td>	
		  </tr>	
		  <tr> 
			...
			<td	bgcolor="#f9f9f9"><font	face="verdana,arial" size=2>&nbsp;&nbsp;Izmena	PPT	prezentacija</font></td> 
		  </tr>	
		  <tr> 
		...
		<font face="verdana,arial" size=1>Napomena:	Ovo je samo delimični spisak. Dodatne zaslužni će da slede.</font> 
	</body>
</html>
