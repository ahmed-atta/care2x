...
$LDWrongEntry='Verkeerde ingang!';
$LDNoAuth='U heeft geen toegangsrechten!';
$LDAuthLocked='Uw toegangscode is geblokkeerd!';

$LDNewData='Nieuwe Data';
$LDEdit='Verander';
$LDAdmit='Admit';
$LDSearch='Zoek';
$LDArchive='Archiveer';
$LDAdmission='Patient Admission';
$LDAdmTargetEntry='Toelating';
...
$LDTestType=array('patho'=>'Pathologie', 
							 ...
							 'baclabor'=>'Bacteriologisch laboratorium',
							 'blood'=>'Bloed Bank',
							 'radio'=>'Radiologie',
							 'sono'=>'Echografie',
							 'allamb'=>'Algemene ambulante hulp',
							 'unfamb'=>'Ambulante spoedeisende hulp',
							 'nuklear'=>'Nucleaire diagnostiek',
							 'inmed'=>'Polikliniek');
...
$LDBilling='eComBill';
/* 2003-05-18 EL */
$LDPlsContactEDP='Neem u.a.b. contact op met uw systeem beheerder.';
$LDPlsTryAgain='Please try again';
/* 2003-07-11 EL */
$LDAdministration='Administration';
$LDOutpatientClinic='Ambulante hulp';
