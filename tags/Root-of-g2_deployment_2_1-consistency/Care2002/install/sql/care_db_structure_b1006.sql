...
#
# Host: localhost
# Erstellungszeit: 06. August 2003 um 03:07
...
#
# Tabellenstruktur für Tabelle care_address_country
#
...
#
# Tabellenstruktur für Tabelle care_address_region
#
...
#
# Tabellenstruktur für Tabelle care_department_firm
#
...
#
# Tabellenstruktur für Tabelle care_department_time
#
...
#
# Tabellenstruktur für Tabelle care_doctor_referrer
#
...
#
# Tabellenstruktur für Tabelle care_encounter_anamnesis
#
...
#
# Tabellenstruktur für Tabelle care_encounter_bowel_movmt
#
...
#
# Tabellenstruktur für Tabelle care_encounter_diet
#
...
#
# Tabellenstruktur für Tabelle care_encounter_doctor_directive
#
...
#
# Tabellenstruktur für Tabelle care_encounter_inpatient
#
...
#
# Tabellenstruktur für Tabelle care_encounter_op_instrument_box
#
...
#
# Tabellenstruktur für Tabelle care_encounter_op_material
#
...
#
# Tabellenstruktur für Tabelle care_encounter_op_roleperson
#
...
#
# Tabellenstruktur für Tabelle care_encounter_op_time
#
...
#
# Tabellenstruktur für Tabelle care_encounter_other_number
#
...
#
# Tabellenstruktur für Tabelle care_encounter_outpatient
#
...
#
# Tabellenstruktur für Tabelle care_encounter_roleperson
#

CREATE TABLE care_encounter_roleperson (
   nr int(10) unsigned DEFAULT '0' NOT NULL auto_increment,
   encounter_nr int(10) unsigned DEFAULT '0' NOT NULL,
   type_nr smallint(6) DEFAULT '0' NOT NULL,
   pid int(11) DEFAULT '0' NOT NULL,
   date_from date DEFAULT '0000-00-00' NOT NULL,
   date_to date DEFAULT '0000-00-00' NOT NULL,
   notes text NOT NULL,
   ...
   create_time timestamp(14),
   PRIMARY KEY (nr),
   KEY encounter_nr (encounter_nr, type_nr)
);
# --------------------------------------------------------
...
#
# Tabellenstruktur für Tabelle care_encounter_test
#
...
#
# Tabellenstruktur für Tabelle care_encounter_transplant_donor
#
...
#
# Tabellenstruktur für Tabelle care_lookup_citytown_region
#
...
#
# Tabellenstruktur für Tabelle care_lookup_color_event
#
...
#
# Tabellenstruktur für Tabelle care_lookup_ward_dept
#
...
#
# Tabellenstruktur für Tabelle care_lookup_zip_locode
#
...
#
# Tabellenstruktur für Tabelle care_mail_list
#
...
CREATE TABLE care_neonatal (
   ...
   weight float(4,2) unsigned DEFAULT '0.00',
   length smallint(5) unsigned DEFAULT '0',
   head_circumference float(4,2) unsigned DEFAULT '0.00',
   scored_gestational_age float(4,2) unsigned DEFAULT '0.00',
   feeding tinyint(4) DEFAULT '0',
   congenital_abnormality varchar(125) NOT NULL,
   classification varchar(255) DEFAULT '0' NOT NULL,
   disease_category tinyint(2) DEFAULT '0',
...
#
# Tabellenstruktur für Tabelle care_nursing_op_logbook
#
...
#
# Tabellenstruktur für Tabelle care_person_death
#
...
#
# Tabellenstruktur für Tabelle care_personell_doctor
#
...
#
# Tabellenstruktur für Tabelle care_personell_doctor_dept
#
...
#
# Tabellenstruktur für Tabelle care_time
#
...
#
# Tabellenstruktur für Tabelle care_type_event
#
...
INSERT INTO care_currency VALUES (13, '€', 'Euro', 'European currency', 'main', '', 00000000000000, '', 00000000000000);
INSERT INTO care_currency VALUES (3, 'L', 'Pound', 'GB British Pound (ISO = GBP)', '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_currency VALUES (10, '$', 'Dollar', 'US Dollar', '', '', 00000000000000, '', 00000000000000);
...
INSERT INTO care_menu_main VALUES ('2', '5', 'Person', 'LDPerson', 'modules/registration_admission/patient.php', '1', '', '', 20030805010253, 00000000000000);
...
INSERT INTO care_type_discharge VALUES (1, 'regular', 'Regular discharge', 'LDRegularRelease', '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_discharge VALUES (2, 'own', 'Patient left hospital on his own will', 'LDSelfRelease', '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_discharge VALUES (3, 'emergency', 'Emergency discharge', 'LDEmRelease', '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_discharge VALUES (4, 'change_ward', 'Change of ward', 'LDChangeWard', '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_discharge VALUES (6, 'change_bed', 'Change of bed', 'LDChangeBed', '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_discharge VALUES (7, 'death', 'Death of patient', 'LDPatientDied', '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_discharge VALUES (5, 'change_room', 'Change of room', 'LDChangeRoom', '', '', 00000000000000, '', 00000000000000);
...
INSERT INTO care_type_feeding VALUES (4, '2', 'parenteral', 'Parenteral', 'LDParenteral', '', '', '', 00000000000000, '', 00000000000000);
...
INSERT INTO care_type_localization VALUES ('1', 'left', 'Left', 'LDLeft', 'L', 'LDLeft_s', '', '0', '', '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_localization VALUES ('2', 'right', 'Right', 'LDRight', 'R', 'LDRight_s', '', '0', '', '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_localization VALUES ('3', 'both_side', 'Both sides', 'LDBothSides', 'B', 'LDBothSides_s', '', '0', '', '', '', 00000000000000, '', 00000000000000);
...
INSERT INTO care_type_notes VALUES (1, 'histo_physical', 'Admission History and Physical', 'LDAdmitHistoPhysical', 5, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (2, 'daily_doctor', 'Doctor\'s daily notes', 'LDDoctorDailyNotes', 55, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (3, 'discharge', 'Discharge summary', 'LDDischargeSummary', 50, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (4, 'consult', 'Consultation notes', 'LDConsultNotes', 25, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (5, 'op', 'Operation notes', 'LDOpNotes', 100, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (6, 'daily_ward', 'Daily ward\'s notes', 'LDDailyNurseNotes', 30, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (7, 'daily_chart_notes', 'Chart notes', 'LDChartNotes', 20, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (8, 'chart_notes_etc', 'PT,ATG,etc. daily notes', 'LDPTATGetc', 115, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (9, 'daily_iv_notes', 'IV daily notes', 'LDIVDailyNotes', 75, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (10, 'daily_anticoag', 'Anticoagulant daily notes', 'LDAnticoagDailyNotes', 15, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (11, 'lot_charge_nr', 'Material LOT, Charge Nr.', 'LDMaterialLOTChargeNr', 80, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (12, 'text_diagnosis', 'Diagnosis text', 'LDDiagnosis', 40, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (13, 'text_therapy', 'Therapy text', 'LDTherapy', 120, '', '', 20030517184408, '', 00000000000000);
INSERT INTO care_type_notes VALUES (14, 'chart_extra', 'Extra notes on therapy & diagnosis', 'LDExtraNotes', 65, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (15, 'nursing_report', 'Nursing care report', 'LDNursingReport', 85, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (16, 'nursing_problem', 'Nursing problem report', 'LDNursingProblemReport', 95, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (17, 'nursing_effectivity', 'Nursing effectivity report', 'LDNursingEffectivityReport', 90, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (18, 'nursing_inquiry', 'Inquiry to doctor', 'LDInquiryToDoctor', 70, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (19, 'doctor_directive', 'Doctor\'s directive', 'LDDoctorDirective', 60, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (20, 'problem', 'Problem', 'LDProblem', 110, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (21, 'development', 'Development', 'LDDevelopment', 35, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (22, 'allergy', 'Allergy', 'LDAllergy', 10, '', '', 00000000000000, '', 00000000000000);
INSERT INTO care_type_notes VALUES (23, 'daily_diet', 'Diet plan', 'LDDietPlan', 45, '', '', 00000000000000, '', 00000000000000);
...
INSERT INTO care_type_unit_measurement VALUES (5, 'temperature', 'Temperature', 'LDTemperature', '', '', '', 00000000000000, '', 00000000000000);
...
INSERT INTO care_users VALUES ('admin', 'admin', 'admin', 0, '0', 'System_Admin', '1', '0000-00-00', '00:00:00', '2003-07-27', '00:00:00', '', '', '', 00000000000000, '', 00000000000000);

#
# Daten für Tabelle care_version
#

INSERT INTO care_version VALUES ('care 2002', 'beta', '1.01.06', '1.0', '2003-08-06', '00:00:00', 'Elpidio Latorilla');
