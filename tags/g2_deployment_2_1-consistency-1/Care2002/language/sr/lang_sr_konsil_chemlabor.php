...
/*
	...
	March - June 2004
*/
$LDDiagnosticTest='Poredak dijagnostièkih testova';
$LDHospitalName='CARE 2X';
$LDCentralLab='Centralna Laboratorija';
$LDLabel='Oznaka';
$LDRoomNr='Br.- Sobe';
$LDSamplingTime='Vreme probavanja';
$LDDay='Dan';
$LDMinutes='Minute';
$LDHours='Sati';
$LDBatchNr='Serijski br.';
...
$LDBLoodSugar1='BLS1';
$LDBloodPlasma='BLP';
$LDDoctorSignature='Potpis lekara';
$LDLifeRisk='Opasnost po život';
$LDRarity='Retkost';
$LDSpecTest='specijalni Testovi';
...
$LDShortDay=array('Ne','Po','Ut','Sr','Èe','Pt','Su','So');
				
$LDBatchNumber='Serijski br.';
$LDMaterial='Materijal:';
$LDEmergencyProgram='Polja oznaèena ljubièastom bojom pripadaju urgentnom programu';
$LDPhoneOrder=' = mora biti potvrðeno telefonom';
/* 2002-09-03 EL */							  
$LDSearchPatient='Pretraga pacijenta';
$LDPlsSelectPatientFirst='Prvo pronaðite pacijenta';
/* 2002-09-11 EL */
$LDPendingTestRequest='Nerešeni Test Zahtev';
/* 2002-10-14 EL */
$LDDone='Završeno je! Premesti formular u arhivu';
...
*/
$LD_Elements = array('tx_1'=>'Klinièka Hem.',
                                  'tx_2'=> 'Koagulacija',
								  'tx_3'=> 'Priteini',
								  'tx_4'=>'Tumormarker',
								  'tx_5'=>'Infekt.serologija',
								  'tx_6'=>'Medicina',
								  'tx_7'=>'Urine/Spont.u.',
								  
                                  '_iof__x__iof_2_' => 'IOF',
                                  '_marcumar_therapy_' => 'Marcumar-Ther.',
								  '_emx_protein_total_' => 'ukupni proteini',
								  '_afp_' => 'AFP',
								  'tx_8' => 'Serum - Liquor',
								  '_amiodaron_' => 'Amiodaron',
								  '_emx_urin_status_' => 'Status urina',
								  ...
								  '_emx_urin_amilase_'=>'Urinska amilaza',
								  ...
								  '_emx_bilirubin_total_'=>'Ukupno Bili',
								  '_emx_ptz_'=>'PTZ',
								  ...
								  '_lithium_'=>'Litijum',
								  '_urine_cytology_'=>'Citologija urina',
								  ...
								  '_bleeding_time_telx_'=>'Vreme krvarenja',
								  'tx_11'=>'Štitne žlezde',
								  '_asma_'=>'ASMA',
								 ...
								 '_cortisol_'=>'Cortisol',
								 '_anti_hbe_'=>'Anti-HBe',
								 '_mononucleosis_'=>'Mononukleoza',
								 '_first_serology_'=>'Prva serologija',
								 ...
								 '_emx_blood_alcohol_'=>'Alkohol u krvi',
								 ...
								 'tx_24'=>'Potpis lekara',
								 'tx_25'=>'Visoki rizik >>',
								 '_highrisk_'=>'<< Visoki rizik',
								 'tx_26'=>'Retkost:',
								 'tx_27'=>'specijalni Test',
								 'tx_28'=>'',
								 'tx_29'=>'klinièka informacija',
								  );
?>
