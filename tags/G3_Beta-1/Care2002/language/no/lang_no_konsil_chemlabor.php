...
$LDDoctorSignature='Legen\'s signatur';

$LDLifeRisk='Risk to life';

$LDRarity='Rarity';

$LDSpecTest='Spesielle tester';
...
$LDShortDay=array('Sø','Ma','Ti','On','To','Fr','Lø','Sø');
...
$LDEmergencyProgram='Fargen fiolett hører til det kritiske program';

$LDPhoneOrder=' = bare etter godkjennelse over telefon';
...
$LD_Elements = array('tx_1'=>'Clinical Chem.',
								  ...
								  '_emx_urin_amilase_'=>'Urin amylase',
...
$LDPlsSelectPatientFirst='Søk etter pasienten først.';

/* 2002-09-11 EL */
$LDPendingTestRequest='Venter på test forespørsel';

/* 2002-10-14 EL */
$LDDone='Det er utført! Flytt skjemaet til arkivet';
?>
