...
$LDQuickView='Rychlý pøehled';
$LDSearchPatient='Hledat pacienta';
$LDArchive='Archív';
$LDStationMan='Pokoje nastavení';
$LDNews='Novinky';
$LDMemo='Poznámky';
...
$LDCloseBack2Main='Zavøít a jít zpìt na hlavní stránku';
$LDOld='Stará';
$LDTodays='Dne¹ní';
$LDOccupancy='obsazenost';
$LDBedNr='Poèet lù¾ek';
$LDOptions='Volby';
...
$LDSearchKeyword='Hledat podle klíèového slova';
$LDWasFound='bylo nalezeno  ~rows~  listù obsazenosti pokojù!';
$LDPlsClk='Prosím vyberte po¾adovaného pacienta.';
$LDMoreFunctions='Více funkcí';
$LDSrcKeyword='Hledat podle klíèového slova';
$LDSearchArchive='Hledej také v archívu.';
$LDSearchPrompt='Prosím zadejte klíèové slovo.<br>	Napøíklad: Jméno, pøíjmení nebo obojí....';
$LDSearch='Hledat';
$LDCancel='Zru¹it';
$LDHow2Search='Jak mohu najít pacienta?';
$LDClk2Show='Kliknìte zde pro zobrazení údajù';
$LDDate='Datum';
$LDClockTime='Èas';

$LDClkDate='Kliknìte na po¾adované datum.';
...
$LDDirectSelect='Pøímá volba';
$LDPlusYear='Pøidat rok';
$LDMinusYear='Ubrát rok';
$LDGo='Pokraèovat';
$LDLastMonth='Minulý mìsíc';
$LDNextMonth='Dal¹í mìsíc';
$LDNursingManage='Správa pokojù / oddìlení';
$LDShowStationDataTxt='&nbsp;Zobrazit, editovat, vytvoøit, <br> &nbsp; popis jednotlivých lù¾ek  apod.';
$LDLockBedTxt='&nbsp;nebo uvolnit lù¾ko';
$LDAccessRightsTxt='&nbsp;Vytvoøit, uzamknout, zmìnit,<br>&nbsp;activovat, smazat, apod.';
$LDShowStationData='Oddìlení - nastavení vlastností';
$LDLockBed='Zamluvit lù¾ko';
$LDAccessRights='Pøístupová práva';
$LDProfile='Profile';
$LDCreate='Vytvoøit';
$LDNewStation='Nové oddìlení';
$LDDescription='Popis';
$LDDept='Oddìlení';
$LDRoom1Nr='Èíslo prvního pokoje';
$LDRoom2Nr='Èíslo posledního pokoje';
$LDRoomPrefix='Písmeno pøed jménem pokoje';
$LDNrBeds='Poèet lù¾ek na pokoji';
$LDMaxBeds='Souhrnný poèet volných lù¾ek';
$LDBed1Prefix='Oznaèení pro první lù¾ko';
$LDBed2Prefix='Oznaèení pro druhé lù¾ko';
$LDHeadNurse='Hlavní sestra';
$LDHeadNurse2='Asistent(ka) hlavní sestry';
$LDNurses='Sestry';
$LDCreateStation='Vytvoøi oddìlení';
$LDEnterAllFields ='Polo¾ky oznaèené  <font color=#ff0000><b>*</b></font> musí být vyplnìna.';
$LDPlsSelect='Prosím vyberte oddìlení';
$LDStationExists='Oddìlení ~station~ ji¾ existuje! Prosím pou¾ijte jiný název.';
$LDAlertIncomplete='Chybìjící údaje. Prosím dopòte potøebné údaje';
$LDAlertRoomNr='Èíslo posledního pokoje MUSÍ být vìt¹í ne¾ èíslo prvního pokoje!';
$LDExistStations='Existující oddìlení. Zvolte jedno prosím';
$LDOtherStations='Jiná oddìlení';
$LDEditProfile='Editovat nastavení oddìlení';
$LDCreatedOn='Datum vytvoøení:';
