...
$LDInitFindings='Constatari initiale';
$LDCurrentFindings='Constatari actuale';
$LDFinalFindings='Constatare finala';

$LDFillLabOnly='Numai pentru uzul laboratorului';
$LDLEN='LEN';  /* LEN =  Numar intrare laborator */

$LDDate='Data';
$LDEye='Ochi';
$LDBac_1='Bact.1'; /* Note: Bact. este prescurtare la bacterie sau agent patogen */
$LDBac_2='Bact.2';
$LDBac_3='Bact.3';
$LDBac_I='Patho.I';
$LDBac_II='Patho.II';
$LDBac_III='Patho.III';
$LDFungi='Fungi';
$LDResistanceTestAnaerob='Resistenta la testul pentru germenii anaerobi';				
$LDResistanceTestAerob='Resistenta la testul pentru germenii aerobi';
$LDTestFindings='Rezultatele testului / Concluzii';
$LDMarkStreptocResistance='Prezenta rezistenta a streptococilor';
$LDBlockerNeg='Gram negativ';
$LDBlockerPos='Gram pozitiv';
...
*/
$lab_TestType = array('_laborator_cultur_aerob_' => 'C.aer.',
								 ...
								 '_lab_bacitracina_1_' => 'BCTCN',
								 '_lab_campylocbacter_1_' => 'CPBTR',
								 
                                 '_laborator_cultura_anaeroba_' => 'C.ana',
								 ...
								 '_lab_bacitracina_2_' => 'BCTCN',
								 '_lab_campylocbacter_2_' => 'CPBTR',
								 
								 '_lab_culture_fungil_1_' => 'Fung.C.',
								 '_lab_culture_fungil_2_' => 'Fung.C.',
								 ...
								 '_lab_ehec_' => 'EHEC',
								 '_lab_mobilitate_' => 'MBLTY',
								 
								 '_lab_metil_albastru' => 'M-blau',
								 ...
								 '_lab_catalaza_1_' => 'CTLS.1',
								 '_lab_indol_1_' => 'Ndol.1',
								 '_lab_oxidaza_1_' => 'OXDS.1',
								 ...
								 '_lab_catalaza_3_' => 'CTLS.3',
								 '_lab_indol_3_' => 'Ndol.3',
								 '_lab_oxidaza_3_' => 'OXDS.3',
...
/*$lab_TestType = array('_lab_cultura_aeroba_' => 'Kultur aerob',
								 ...
								 '_lab_bacitracina_1_' => 'Bacitracin',
								 '_lab_campylocbacter_1_' => 'Campylobacter',
								 
                                 '_lab_cultura_anaeroba_' => 'Kultur anaerob',
								 ...
								 '_lab_bacitracina_2_' => 'Bacitracin',
								 ...
								 '_lab_metil_albastru' => 'Albastru de metil',
								 ...
								 '_lab_catalaza_1_' => 'catalaza 1',
								 '_lab_indol_1_' => 'Indol 1',
								 '_lab_oxidaza_1_' => 'Oxidaza 1',
								 ...
								 '_lab_catalaza_2_' => 'Catalaza 2',
								 '_lab_indol_2_' => 'Indol 2',
								 '_lab_oxidaza_2_' => 'Oxidaza 2',
								 ...
								 '_lab_Catalaza_3_' => 'Catalaza 3',
								 '_lab_indol_3_' => 'Indol 3',
								 '_lab_oxidaza_3_' => 'Oxidaza 3',
...
$lab_TestResultId_1=array('Staph.aureus', 'E.coli', 'enterob.aerogenes',
									 ...
									 'Streptococc.', 'E.coli muc.', 'Haemophilus species',
...
/*$lab_TestResultId_1=array('Staph.aureus', 'E.coli', 'enterobac aerogenes',
									 ...
									 'Group D', 'klebsiella species', 'Prevotella',
