<?php
$LDOr='M&#369;t&#337;';
$LDLOGBOOK='M&#369;téti kiírás';
$LDOrDocument='M&#369;téti leirás';
$LDOrDocumentTxt='A m&#369;tétek dokumentálása';
...
*/
$LDDOC='Orvosi ügyelet';
$LDORNOC='Ügyeletes m&#369;t&#337;sn&#337;';
$LDScheduler=' - kiírás';

$LDQuickView='- áttekint&#337;';
$LDQviewTxtDocs='Ügyeletes orvos - áttekint&#337;';
$LDOrLogBook='M&#369;téti kiíás';
$LDOrLogBookTxt='M&#369;téti tevékenység dokumentációja, archívum';
$LDOrProgram='M&#369;téti program';
$LDOrProgramTxt='M&#369;téti program kiírása, javítása';
$LDQviewTxtNurse='Ügyeletes m&#369;t&#337;sn&#337; - áttekint&#337;';
$LDDutyPlanTxt='M&#369;t&#337;sn&#337; ügyelet, kiírása, javítása';
$LDOnCallDuty='Behívós ügyelet';
$LDOnCallDutyTxt='Documenting the work during an On-Call duty';
$LDAnaLogBook='Aneszteziológus kiírás';
$LDAnaLogBookTxt='Aneszteziológiai tevékenység dokumentációja, archívum';
$LDQviewTxtAna='Ügyeletes aneszt asszisztens - áttekint&#337;';
$LDNewDocu='Új dokumentum';
$LDSearch='Keres';
$LDArchive='Archívum';
$LDSee='Megtekint';
$LDUpdate='Javít';
$LDCreate='Újat';
$LDCreatePersonList='M&#369;t&#337;sn&#337;i listát készít';
$LDDoctor='Orvosok';
$LDNursing='N&#337;vérek';
$LDAna='Anaesztézia';
...
$LDResearchArchive='Keresés az arhívumban';
...
$LDPatientNr='Azonosító';
$LDMatchCode='Matchcode Name';
$LDOpDate='M&#369;tét dátuma';
$LDOperator='Sebész';
...
$LDDiagnosis='Diagnózis';
$LDLocalization='Localizáció';
$LDTherapy='Beavatkozás';
$LDSpecials='Megjegyzés';
$LDClassification='Klasszifikáció';
...
$LDStartNewDocu='Új dokumentum készítése';
...
$monat=array('',
				...
				'December');
$LDPrevDay='El&#337;z&#337; nap';
$LDNextDay='Következ&#337; nap';
$LDChange='Vált';
$LDOpMainElements=array(
										nr_date=>'Sorszám/Dátum',
										patient=>'Beteg',
										diagnosis=>'Diagnózis',
										operator=>'Sebész/Asszisztens',
										ana=>'Anesztézia',
										cutclose=>'B&#337;rmetszés/Zárás',
										therapy=>'Beavatkozás',
										result=>'Kimenet',
										inout=>'Kezdés/Vége'
										);
$LDOpCut='B&#337;rmetszés';
$LDOpClose='Zárás';
$LDOpIn='M&#369;t&#337;be érkezés';
$LDOpOut='M&#369;t&#337;b&#337;l távozás';
$LDOpInFull='Kezdés';
$LDOpOutFull='Vége';
...
$tbuf=array('O','A','S','R');
$cbuf=array('Sebész','Asszisztens','M&#369;t&#337;sn&#337;','M&#369;t&#337;sfiú');
...
$LDAnaDoc='Altatóorvos';
$LDAnaPrefix='AN';
$LDEnterPerson='Enter a new ~tagword~';
$LDExtraInfo='Egyéb információ';
$LDFrom='Tól';
$LDTo='Ig';
$LDFunction='Funkció';
$LDCurrentEntries='Jelenlegi bejegyzések';
$LDDeleteEntry='Bejegyzés törlése';
$LDSearchNewPerson='Új ~tagword~ keresése';
...
$LDUseData='A személy hozzáadása mint ~tagword~';
$LDJobIdTag=array(
						nurse=>'Nurse',
						doctor=>'Physician/Surgeon'
						);
$LDQuickSelectList='Választás';
$LDTimes='Idõ';
$LDPlasterCast='Motor indul';
/**
*  Reposition = repositioning of bone dislocation or fracture
*/
$LDReposition='Aorta kirekesztés';
$LDWaitTime='Várakozás';
$LDStart='Kezdés';
$LDEnd='Vége';
...
$opts=array('-',
					'A beteg kés&#337;n érkezett',
       				'Az anaszteziológus kés&#337;n érkezett',
       				'Sebész kés&#337;n érkezett', 
					'Takarítás késett',
       				'Egyéb ok');
$LDReason='A várakozás oka';
...
$LDPromptSearch='Kérem adja meg a keresett szót.<br>Például: vezetéknév, keresztnév, születési dátum.';
$LDKeyword='Kulcsszó';
$LDOtherFunctions='További funkciók';
...
$LDMonth='Month';
$LDYear='Year';
$LDDutyElements = array('Date','&nbsp;','Family name, Given name','tól','ig','OP Room','Diagnosis & therapy');
$LDPrint='Print';
