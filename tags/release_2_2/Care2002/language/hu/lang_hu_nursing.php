...
*/
$LDNursing='Osztályok';
$LDStation='Ápolási Osztály:';

$LDQuickView='Gyorsnézet';
$LDSearchPatient='Beteg keresése';
$LDArchive='Arhívum';
$LDStationMan='Osztályok kezelése';
$LDNews='Hírek';
$LDMemo='Memo';
$LDNursingForum='Nursing forum';
$LDNursingStations='Ápolási Osztályok';

$LDQuickViewTxt='Az ápolási osztályok mai ágykihasználtsága.';
$LDSearchPatientTxt='Osztályra felvett beteg keresése.';
$LDArchiveTxt='Osztályok arhív adatai.';
$LDStationManTxt='Osztályok kezelése, ágyszám, személyzet stb. beállítása.';
$LDNewsTxt='Hírek írása, olvasása.';
$LDMemoTxt='Feljegyzések írása, olvasása.';
...
$LDClk2Show='Kattintásra adatok megmutatása';
$LDDate='Dátum';
$LDClockTime='Id&#337;';

$LDClkDate='Kattintás a megfelel&#337; dátumra.';
...
$LDShowStationData='Osztályok\' profile data';
...
$LDQuickInformer='Gyorslista';
$LDAttention='Figyelem!';
$LDOccupied='Foglalt ágyak';
$LDFree='Szabad ágyak';
$LDLocked='Lezárt ágyak';
$LDDutyDoctor='<b>Ügyeletes orvos</b>';
$LDShortMale='ffi';
$LDShortFemale='n&#337;';
$LDLegend='Jelmagyarázat';

$LDOpenFile='Kórlap megnyitása';
$LDNotesEmpty='Nincs megjegyzés';
$LDNotes='Megjegyzés';
$LDRelease='Emisszió';
$LDFreeOccupy='Szabad ágy/Felvesz';
$LDMale='ffi';
$LDFemale='n&#337;';
/**********do not change the ~station~ **************************/
$LDNoInit='The ward ~station~ is not yet initialized!';
$LDIfInit='To initialize the ward, please click here.';
$LDShowPatData='Kórlap megnyitása';
$LDReleasePatient='Beteg emissziója';
$LDNoticeRW='Megjegyzés olvasása/írása';
$LDInfoUnlock='Lezárás feloldása';
...
$LDSave='Mentés';
$LDNurse='Nõvér';
$LDYesSure='Igen, biztosan emittálni akarom.';
...
$LDReleaseType='Emisszió tipusa';
$LDRegularRelease='Normál emisszió';
$LDSelfRelease='A beteg saját kérésére távozott';
$LDEmRelease='Sürgõs emisszió';
$LDAlertNoName='Kérem írja be a nevét.';
$LDAlertNoDate='Enter the date in this format:';
$LDAlertNoTime='Enter the time in the ff: format: HH.mm.';
$LDPatDataFolder='Kórlap';

$LDClose='Bezár';
$LDHelp='Segítség';
$LDReset='Újra';

$LDNoLabReport='Nincsenek elérhetõ laboradatok!';
$LDFeverCurve='Lázlap';
$LDNursingReport='Ápolási lap';
$LDDocsPrescription='Orvosi rendelések';
$LDNursingPlan='Ápolási terv';
$LDRootData='Root data';
$LDReports='Vizsgálati eredmények';
$LDLabReports='Laboreredmények';
$LDPhotos='Fotók';
$LDChkUpRequests='Vizsgálat kérése';
$LDPleaseSelect='Select diagnostic test request';
$LDSetColorRider='Click to set or reset color rider';
$LDDiet='Diéta';
$LDBackDay='Egy napot vissza. (jobb gombra dátum kiválasztása)';
$LDFwdDay='Egy napot elõre. (jobb gombra dátum kiválasztása)';
$LDClk2PlanDiet='Kattintás a napi diéta rögzítéséhez';

$LDAllergy='Allergia';
$LDDiagnosisTherapy='Diagnózis / Terápia';
$LDBpTemp='H&#337;mérséklet / Vérnyomás';
$LDPtAtgEtc='Gyógytorna';
$LDAntiCoag='Antikoaguláns';
$LDExtraNotes='Megjegyzés';
$LDMedication='Gyógyszerek';
$LDIvPort='Intravénás';
$LDPtAtgEtcTxt='Fizikoterápia, gyógytorna';
...
$LDEntryPrompt='Ide írja az új feljegyzést';
...
$LDDosage='Adagolás';
$LDColorMark='Jelölés szinekkel';
$LDNormal='Normál';
$LDAntibiotic='Antibiotikum';
$LDDialytic='Vízhajtó';
$LDHemolytic='Hemolítikus';
$LDIntravenous='Intravénás';
$LDTodaysReport='Today\'s report';
$LDNoMedicineYet='There is no medication yet!';
$LDEffectReport='Ápolási tevékenység';
$LDFrom='Kezd&#337; dátum:';
$LDTo='Vége:';
$LDPage='Oldal';
$LDSignature='Szigno';
$LDInsertSymbol='Jel beszúrása a sor elejére.';
$LDInsertDate='Mai dátum beszúrása';
$LDInsertTimeNow='Id&#337; beszúrása';
...
$LDLastName='Vezetéknév';
$LDName='Keresztnév';
$LDBirthDate='Szül.dátum';
$LDLockThisBed='Az ágy lezárása';
$LDClk2LockBed='Kattintás az ágy lezárásához';
$LDAssignOcc='Beteg hozzárendelése';
$LDSearchFound='Search found <font color=red><b>~nr~</b></font> patients.';
$LDAssign2Bed='Az adott beteg hozzárendelése';
$LDSend='Send';
...
$LDQueries='Kérdések az orvoshoz';
$LDChangeWard='Másik osztály';
$LDChangeBed='Másik ágy';
$LDPatientDied='Exit';
...
/* 2002-10-23 EL*/
$LDQueryDoctor='Kérdés az orvoshoz';
$LDDoctorInfo='Orvosi utasítások';
$LDDiagnosticsReport='Vizsgálati eredmény érkezett';
$LDInfusionTherapy='Infúziók';
$LDMonitorFluidDischarge='Folyadékegyenleg';
$LDBloodProgram='Transzfúzió';
$LDVitalStatistics='Vital statistics';
$LDAntibioticsProgram='Antibiotikum terápia';
$LDAnticoagProgram='Antikoaguláció';
$LDSpecialCare='Szoros megfigyelés';
$LDTestConsultRequested='Vizsgálat/Konzílium szükséges';
$LDNurseReport='Új ápolási lap';
$LDDaily='Naponta';
$LDSaveChanges='Változások mentése';
/* 2002-12-07*/
$LDNoDiagReport='No diagnostic report available.';
/* 2003-03-23 EL */
$LDNursesList='N&#337;vérlista';
$LDNursesListTxt='Osztályos n&#337;vérek listájának kezelése';
/* 2003-04-18 */
...
/* 2003-05-10 EL */
$LDChangeRoom='Másik kórterem';
/*2003-06-14 EL*/
$LDNrOfBedsRoom='The nr. of beds of room';
$LDIsNotANumber='is not a valid number';
$LDWaitingList='Várólista';
$LDShowAll='Mindet mutat';
$LDShowWardOnly='Csak az osztályt mutatja';
$LDTransferToBed='Ezen az osztályon másik ágyra áthelyez';
$LDTransferToWard='Áthelyezés másik osztályra';
$LDShowBeds='Ágyakat mutat';
$LDTransferPatient='Beteg áthelyezés';
$LDDRG='DRG';
$LDFinanceType='Insurance';
#2003-08-02 EL
$LDOutToInpatient='Felvétel fekv&#337;betegnek';
$LDTransferClinic='Áthelyezés másik részlegre';
$LDClinic='Részleg';
$LDOwnPatient='Az osztály betege';
$LDNonOwnPatient='Nem az osztály betege';
# 2003-08-04 EL
$LDShowClinicOnly='Csak ezt az ambulanciát';
# 2003-09-16 EL
$LDAdmissionData='Felvételi adatok';
$LDShowPhoto='Fotót mutat';
