...
$LDSearch4OPS301='ÈÍË Úä ÔÝÑÉ OPS-301';
$LDDescription='æÕÝ';
...
$LDMain='ÑÆíÓí'; // M = Main
$LDRight='íãíä'; // R = Right
$LDLeft='íÓÇÑ';   // L = Left
$LDBoth='ÇáÌÇäÈÇä';  // B = Both or (both sides)

$LDDeleteEntry='ÍÐÝ ÇáãÏÎá';
$LDNoQuickList='ÇáÞÇÆãÉ ÇáÓÑíÚÉ ÝÇÑÛÉ Ýí åÐå ÇáÏÞíÞÉ.';
$LDClick2Search='ÅÖÛØ åäÇ áÐåÇÈ Çáì ÇáÈÍË.';
$LDPossibleCodes='ÔÝÑÇÊ ICD æ ICPM ÇáããßäÉ';
/*2003-05-25 EL */
$LDCategory='ÇáÝÆÉ';
$LDLoc='Loc.';
$LDBy='ÈæÇÓØÉ';
