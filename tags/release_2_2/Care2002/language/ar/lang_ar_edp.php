...
$LDInfo='דÚבזדַÊ';
$LDInfoTxt='ָֻֽ ז Þֱַֹׁ דÚבזדַÊ דÊÚבÞֹ ֵַָֹֿׁ ַבהÙַד.';
$LDManage='ֵַֹֿׁ';
$LDUpdateOk='Êד ַבÊֽֿםֻ <b>ָהַּֽ</b>!';
$LDDataSaved='Êד ֽÝÙ ַבָםַהַÊ ַבÊַבםֹ ָהַּֽ:';
...
/* 2002-11-22 EL*/
$LDDeleteCurrency='וב ֳהÊ דÊֳßֿ, וב ÊׁÛָ ֽÞַ Ýם ֽ׀Ý ו׀ו ַבÚדבֹ¿';
$LDNoMainDelete='בַ םדßהß ֽ׀Ý ַבÚדבֹ ַבֶׁם׃םֹ. \nםָּ ֳה Êֽֿֿ Úדבֹ ֶׁם׃םֹ ֳ־ׁל ֳזבַ.';
$LDCurrencyExisting='ו׀ו ַבÚדבֹ דזּזֹֿ!';
/* 2003-02-21 EL*/
$LDMenuItem='ַבָםַה';
$LDOrderNr='ׁÞד ַבÊׁÊםָ';
$LDStatus='ַבַֽבֹ';
$LDHideBy='ד־Ýם דה:';
$LDPath='ַבד׃ַׁ';
$LDVisible='דֶׁם';
...
$LDDataEntryForms='הדַ׀ּ ֵֿ־ַב ַבָםַהַÊ';
$LDControlButImg='ֳַׁׁׂ ַבÊֽßד';
$LDSampleButtons='Úםהֹ דה ַבַַׁׁׂ';
$LDTheme='דּדזÚֹ ַבױזׁ';
$LDItem='ַבָםַה';
/* 2003-02-26- EL*/
$LDDeptAdmin='ֵַֹֿׁ ַבַÞ׃ַד';
$LDNewDept='ֵהװֱַ ז ֵÚַֿֿ ֳÞ׃ַד ּֿםֹֿ';
$LDShowDeptInfo ='ַֽÝÙֹ ָםַהַÊ ַבÞ׃ד';
$LDShowDeptInfoTxt='Úׁײ דÚבזדַÊ ַֽÝÙֹ ָםַהַÊ ַבַÞ׃ַד ַבהװ״ֹ ַבדזּזֹֿ';
$LDConfigOptions='־םַַׁÊ ַבדÙוׁ ַבÚַד';
$LDDeptConfigOptions='ֵÚַֿֿ, Êֽֿםֻ ַבדÚבזדַÊ, ֵבÛֱַ ַבÊהװם״, Êהװם״, ֵ־Ýֱַ ז Úׁײ ַבַÞ׃ַד';
$LDDescription='זױÝ';
/* 2003-023-01 EL*/
$LDFormalName='ַבַ׃ד';
...
/* 2003-03-30 EL*/
$LDConfigOptions='ַב־םַַׁÊ ַבÚַדֹ';
$LDDoesSurgeryOp='םּׁם ÚדבםַÊ ַּֽׁםֹ¿';
$LDList='Þֶַדֹ';
$LDUpdate='Êֽֿםֻ';
# 2003-08-03 EL
...
$LDAddressListTxt='Úהֿ Úׁײ Þֶַדֹ ַבÚהַזםה Ýם זֹֽֿ דֿםׁ ַבÚהַזםה.';
$LDAddressSearch='ָֻֽ Ýם ַבÚהַזםה';
$LDAddressSearchTxt='Úהֿ ַבָֻֽ Úה Úהזַה ֳּׁÚ Þֶַדֹ';
$LDInsuranceList='Þֶַדֹ װׁßַÊ ַבÊֳדםה';
$LDInsuranceListTxt='Úהֿ Úׁײ Þֶַדֹ װׁßַÊ ַבÊֳדםה Ýם זֹֽֿ װׁßַÊ ַבÊֳדםה.';
$LDInsuranceSearch='ַבָֻֽ Ýם ַבÊֳדםה';
$LDInsuranceSearchTxt='Úהֿ ַבָֻֽ Ýם װׁßַÊ ַבÊֳדםה ֳּׁÚ Þֳֶדֹ.';
$LDPersonnelSearch='ַבָֻֽ Ýם ַבדזÙÝםה';
$LDPersonnelSearchTxt='Úהֿ ַבָֻֽ Ýם ַבדזÙÝםה ֳּׁÚ Þֶַדֹ.';
$LDPersonnelList='Þֶַדֹ ַבדזÙÝםה';
$LDPersonnelListTxt='Úהֿ Úׁײ Þֶַדֹ ַבדזÙÝםה Ýם זֹֽֿ דֿםׁ ַבדזÙÝםה.';
$LDPersonSearch='ַבָֻֽ Ýם ַבַװ־ַױ';
$LDPersonSearchTxt='Úהֿ ַבָֻֽ Ýם ַבַװ־ַױ ֳּׁÚ Þֶַדֹ.';
$LDPatientSearch='ַבָֻֽ Ýם ַבדׁײל';
...
$LDNewsDisplay='Úׁײ ַבַ־ַָׁ';
$LDTitleFontSize='ּֽד ־״ ַבÚהזַה';
$LDTitleFontColor='בזה ־״ ַבÚהזַה';
$LDTitleFont='־״ ַבÚהזַה';
$LDPrefaceFontSize='ּֽד ־״ דÞֿדֹ ַבדÞַבֹ';
$LDPrefaceFontColor='בזה ־״ דÞֿדֹ ַבדÞַבֹ';
$LDPrefaceFont='־״ דÞֿדֹ ַבדÞַבֹ';
$LDBodyFontSize='ּֽד ־״ ָֿה ַבַ־ַָׁ';
$LDBodyFontColor='בזה ־״ ָֿה ַבַ־ַָׁ';
