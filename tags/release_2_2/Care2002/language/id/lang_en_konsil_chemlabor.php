...
$LDLabel='Label';
$LDRoomNr='No. Ruang';
$LDSamplingTime='Jam pengambilan contoh';
$LDDay='Hari';
$LDMinutes='Menit';
$LDHours='Jam';
$LDBatchNr='Batch Nr.';
$LDCaseNr='Nomor penyakit'; //Case=penyakit
$LDHouse='Rumah';
...
$LDBLoodSugar1='BLS1';
$LDBloodPlasma='BLP';
$LDDoctorSignature='Tanda Tangan Dokter';
$LDLifeRisk='Harapan Hidup';  //Risk to life????
$LDRarity='Hal yang jarang terjadi';
$LDSpecTest='Tes Khusus';
$LDClinicalInfo='Info Klinis';
$LDShortMonth=array('',
                                   'Jan',
								   'Feb',
								   'Mar',
...
$LDShortDay=array('Ah','Sn','Sl','Rb','Km','Jm','Sb','Ah');
				
$LDBatchNumber='Batch nr.';
$LDMaterial='Material:';
$LDEmergencyProgram='Kolom warna ungu mengacu pada program Gawat darurat(Emergency)';
$LDPhoneOrder=' = harus dikonfirmasikan lewat telepon';
/* 2002-09-03 EL */							  
$LDSearchPatient='Mecari Pasien';
$LDPlsSelectPatientFirst='Silakan mencari pasien dahulu.';
/* 2002-09-11 EL */
$LDPendingTestRequest='Penantian permintaan tes';
/* 2002-10-14 EL */
$LDDone='Telah dilakukan! pindahkan form ke arsip';
