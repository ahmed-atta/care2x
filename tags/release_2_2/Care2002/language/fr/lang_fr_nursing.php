...
$LDQuickViewTxt='Vue rapide de l\' occupation actuelle des salles d\' infermerie.';
$LDSearchPatientTxt='Recherche la salle pour un patient admis.';
$LDArchiveTxt='Rechercher les fichier archiver pour les salles.';
