...
<?php if($src!=$x1) : ?>
<b>Paso 1</b>
<ul> Dé clic en el botón <img src="../img/en/en<?php switch($x1)
																			{
...
<b>Paso 2</b>
<?php endif ?>
<ul>  Si usted ha ingresado su nombre y contraseña previamente y tiene permiso para ver esta función, aparecerá el
<?php switch($x1)
	{
...
?>  en la ventana principal.<br>
		...
		Si usted decide cancelar, dé clic en el botón <img <?php echo createLDImgSrc('../','cancel.gif','0') ?>>.
