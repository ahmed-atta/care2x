...
<?php if($src!=$x1) : ?>
<b>Paso 1</b>
<ul> Dé clic en el botón <img src="../gui/img/control/default/es/es<?php switch($x1)
																			{
...
<b>Paso 2</b>
<?php endif ?>
<ul> Si usted ya ingresó su nombre y contraseña y tiene permiso para ver esta función, aparecerá el 
<?php switch($x1)
	{
...
?>  en la ventana principal.<br>
		De otro modo, se le pedirá que escriba su nombre y contraseña. <p>
		Ingréselos y dé clic en el botón <img <?php echo createLDImgSrc('../','continue.gif','0') ?>>.<p>
		Si desea salir de esta ventana, dé clic en el botón <img <?php echo createLDImgSrc('../','cancel.gif','0') ?>>.
