...
if(!isset($notabs)||!$notabs){
	if($target=='person_reg') $tab_bot_line='#66ee66';
		else $tab_bot_line='#00009c';
?>
...
<tr>
<td colspan=3  bgcolor=<?php echo $tab_bot_line; ?>><img src="p.gif" border=0 width=1 height=5><?php
