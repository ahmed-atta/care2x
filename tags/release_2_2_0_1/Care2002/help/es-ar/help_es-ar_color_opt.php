...
<form action="#" >
  ...
  &iquest;Cómo seleccionar el color del fondo?</b> </font></font> 
  <ul>
    ...
    <b>Paso 5: </b>Para terminar haga clic en el bot&oacute;n 
    <input type="button" value="OK">
    .<br>
    </font>
  </ul>
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img <?php echo createComIcon('../','frage.gif','0') ?>> 
  <font color="#990000"><b> &iquest;Como seleccionar el color del texto?</b> </font></font> 
  <ul>
    <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Paso 1: </b>Dé clic 
