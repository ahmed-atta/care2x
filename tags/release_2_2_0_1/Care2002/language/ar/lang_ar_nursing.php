...
$LDEditProfile='ÊÍÑíÑ ÈíÇäÇÊ ÇáÇÌäÍÉ';
$LDCreatedOn='ÃäÔÆÊ İí:';
...
$LDFree='ÔÇÛÑ';
$LDLocked='ãÛáŞ';
$LDDutyDoctor='<b>ØÈíÈ</b> (ÇáãäÇæÈÉ)';
$LDShortMale='M';
$LDShortFemale='F';
$LDLegend='ÇáÑãæÒ';

$LDOpenFile='İÊÍ ÇáãÎØØ';
$LDNotesEmpty='ãáÇÍÙÇÊ İÇÑÛÉ';
$LDNotes='ãáÇÍÙÇÊ';
$LDRelease='ÎÑæÌ';
$LDFreeOccupy='ÔÇÛÑ/ãÔÛæá';
$LDMale='ĞßÑ';
$LDFemale='ÃäËì';
/**********do not change the ~station~ **************************/
...
$LDQueries='ÇÓÊÚáÇãÇÊ ááØÈíÈ';
$LDChangeWard='ÊÛííÑ ÇáÌäÇÍ';
$LDChangeBed='ÊÛííÑ ÇáÓÑíÑ';
...
$LDTestConsultRequested='ÊÍáíá/ØáÈ ÇÓÊÔÇÑÉ';
$LDNurseReport='ÊŞÑíÑ ÊãÑíÖ ÌÏíÏ';
$LDDaily='íæãí';
$LDSaveChanges='ÍİÙ ÇáÊÛííÑÇÊ';
/* 2002-12-07*/
$LDNoDiagReport='ÊŞÑíÑ ÇáÊÔÎíÕÇÊ ÛíÑ ãÊæİÑ';
/* 2003-03-23 EL */
...
$LDTransferToBed='äŞá Çáì ÓÑíÑ ÃÎÑ İí äİÓ ÇáÌäÇÍ';
...
$LDTransferClinic='äŞá Çáì ÚíÇÏÉ Ãæ ŞÓã';
$LDClinic='ÚíÇÏÉ';
