...
$readerpath="editor-4plus1-read.php?target=healthtips&file=";
...
$dept=array("Allgemeine Chirurgie Gesund Leben, Gesund Denken","Unfall Chirurgie","Plastische Chirurgie","HNO","Augenklinik","Pathologie",
					"Gynäkologie");
?>
...
<STRONG>&nbsp;Gesundheitstips</STRONG></FONT></td>
...
<? if($rows) : ?>
   ...
   <tr>
    ...
    <tr bgcolor=#ffffff>
      <td><font face="Verdana,arial" size=2 color="#0000cc"><b>Gesundheitstip</b></font></td>
      <td>&nbsp;</td>
...
<a href="editor-pass.php?target=healthtips"><img src="../img/news.gif" width=16 height=14 border=0></a>
<?php
