...
<ul>       	
 	...
 	<b>Schritt 2: </b>Klickt den <img src="../img/dwnArrowGrnLrg.gif" width=16 height=16 border=0> Knopf des Artikels. Der Artikel wird in den Katalog gestellt.<br>
 	<b>Schritt 3: </b>Wenn Sie vorher die Information über den Artikel sehen möchten, klickt entweder seinen Namen oder das Symbol <img src="../img/info3.gif" border=0> an.<br>
...
<ul>       	
 	<b>Schritt 1: </b>Klickt das Symbol <img src="../img/info3.gif" border=0> an.<br>
...
<ul>       	
	...
	Benutzernamen und Passwort gefragt.<br>
 	...
 	<b>Schritt 3: </b>Falls erforderlich geben Sie Ihren Benutzernamen und Passwort ein. Klickt den <img src="../img/de/de_continue.gif" border=0> Knopf an.<br>
 	...
 	<b>Schritt 5: </b>Wenn der Artikel den Sie bestellen möchten in der Katalogliste ist, klickt seinen <img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0> Knopf an um  in den Bestellkorb auf dem linken Rahmen <b>ein Stück</b> von dem Artikel zu stellen.<p>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
...
<ul>       	
	...
	Gibt entweder eine vollständige Information oder die erste Zeichen von dem Markennamen des Artikels, oder seinem Generic, oder seiner Bestellnummer, usw. in das Feld
 	...
 	<b>Schritt 4: </b>Wenn Sie nur ein Stück von dem Artikel bestellen möchten, klickt den <img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0> Knopf an. 
	Der Artikel wird in den Bestellkorb gestellt. Gleichzeitig wird er auch in den Katalog gestellt.<br>
 	<b>Schritt 5: </b>Wenn Sie den Artikel nur in den Katalog stellen möchten, klickt den <img src="../img/dwnArrowGrnLrg.gif" width=16 height=16 border=0> Knopf an.<br>
</ul>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
Ich möchte mehr Information über den Artikel sehen. Was soll ich tun?</b>
</font>
...
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Achtung!</b></font> 
<ul>       	
 Sie bekommen weitere Hilfsanweisungen durch Anklicken des Symbols <img src="../img/frage.gif" border=0> innerhalb des Bestellkorbes bzw. Katalogs .
</ul>
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Achtung!</b></font> 
<ul>       	
...
<ul>       	
 	...
 	<b>Schritt 2: </b>Wenn der Artikel den Sie bestellen möchten in der Katalogliste ist, klickt seinen <img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0> Knopf an um  in den Bestellkorb auf dem linken Rahmen <b>ein Stück</b> von dem Artikel zu stellen.<p>
</ul>
<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Achtung!</b></font> 
<ul>       	
 Sie bekommen weitere Hilfsanweisungen durch Anklicken des Symbols <img src="../img/frage.gif" border=0> innerhalb des Bestellkorbes bzw. Katalogs .
...
<ul>       	
 	<b>Schritt 1: </b>Wenn der Artikel den Sie bestellen möchten in der Katalogliste ist, klickt seinen <img src="../img/L-arrowGrnLrg.gif" width=16 height=16 border=0> Knopf an um  in den Bestellkorb auf dem linken Rahmen <b>ein Stück</b> von dem Artikel zu stellen.<p>
</ul>
...
<ul>  	
 	<b>Schritt 1: </b>Klickt den <img src="../img/uparrowGrnLrg.gif" width=16 height=16 border=0> Knopf einer Bestellungsliste an. Die Details werden gezeigt.<br>
</ul>

<img src="../img/warn.gif" border=0 align="absmiddle"> <font color="#990000"><b> Achtung!</b></font> 
<ul>       	
 Wenn Sie die Suche beenden möchten klickt den <img src="../img/de/de_close2.gif" border=0> Knopf an.
</ul>
