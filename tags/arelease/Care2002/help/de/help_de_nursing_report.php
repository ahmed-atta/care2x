...
<b><? if($x1=="docs") print "Äztliche Anordnung"; else print "Pflegebericht"; ?></b></font>
<form action="#" >
<p><font size=2 face="verdana,arial" >

<? if($src=="") : ?>
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
Wie schreibe ich  <? if($x1=="docs") print "eine ärztliche Anordnung"; else print "einen Pflegebericht"; ?>?</b></font>
<ul> 
	<b>Schritt 1: </b>Gibt das Datum in das Feld "<span style="background-color:yellow" > Datum: <input type="text" name="d" size=10 maxlength=10 value="10.10.2002"> </span>" in der "<? if($x1=="docs") print "Ärztlichen Anordnung"; else print "Pflegebericht"; ?>" Spalte ein.<br>
	...
	<b>Schritt 2: </b>Gibt die Zeit in das Feld  "<span style="background-color:yellow" > Uhrzeit: <input type="text" name="d" size=5 maxlength=5 value="10.35"> </span>"  in der "<? if($x1=="docs") print "Ärztlichen Anordnung"; else print "Pflegebericht"; ?>" Spalte ein.<br>
	...
	<b>Schritt 3: </b>Schreiben sie <? if($x1=="docs") print "die ärztlichen Anordnung"; else print "den Pflegebericht"; ?> in das Feld "<span style="background-color:yellow" > <? if($x1=="docs") print "Ärztlichen Anordnung"; else print "Pflegebericht"; ?>: <input type="text" name="d" size=10 maxlength=10 value="test"> </span>".<br>
		<font color="#000099" size=1><b>Tips:</b>
		<ul type=disc>
		<li>Klicken Sie den Checkbox "<span style="background-color:yellow" > <input type="checkbox" name="c" value="c"> <img src="../img/warn.gif" width=16 height=16 border=0>Dieses Symbol vorm Bericht einfügen. </span>" an, wenn Sie möchten das das Symbol <img src="../img/warn.gif" width=16 height=16 border=0> vor <? if($x1=="docs") print "der ärztlichen Anordung"; else print "dem Pflegebericht"; ?> steht.
		<li>Wenn Sie ein Teil  <? if($x1=="docs") print "der Anordung"; else print "vom Bericht"; ?>  hervorheben möchten, klickt das Symbol <img src="../img/hilite-s.gif" width=48 height=14 border=0> an bevor Sie das Wort oder den Satz schreiben. Um die
...
<img src="../img/frage.gif" border=0 align="absmiddle"> <font color="#990000"><b>
Wie schreibe ich <? if($x1=="docs") print "eine Frage an den Arzt"; else print " einen Bericht über die Effektivität der Pflegeplanung"; ?>?</b></font>
<ul> 
	<b>Schritt 1: </b>Gibt das Datum in das Feld "<span style="background-color:yellow" > Datum: <input type="text" name="d" size=10 maxlength=10 value="10.10.2002"> </span>" in der "<? if($x1=="docs") print "Fragen an den Arzt"; else print "Bericht über die Effektivität der Pflegeplanung"; ?>" Spalte ein.<br>
		<font color="#000099" size=1><b>Tipps:</b>
		<ul type=disc>
		<li>Um das heutige Datum einzugeben, tippt "h" oder "H" (bedeutet HEUTE) in das Datum Feld ein. Das heutige Datum zeigt sich automatisch.
		<li>oder klickt den <img src="../img/arrow-t.gif" width=12 height=12 border=0> Knopf unter dem Eingabefeld an. Das heutige Datum zeigt sich automatisch.
	...
	<b>Schritt 2: </b>Schreiben sie <? if($x1=="docs") print "die Frage"; else print "den Bericht"; ?> in das Feld "<span style="background-color:yellow" > <? if($x1=="docs") print "Fragen an den Arzt"; else print "Bericht über die Effektivität der Pflegeplanung"; ?>: <input type="text" name="d" size=10 maxlength=10 value="test"> </span>".<br>
		<font color="#000099" size=1><b>Tips:</b>
		<ul type=disc>
		<li>Klicken Sie den Checkbox "<span style="background-color:yellow" > <input type="checkbox" name="c" value="c"> <img src="../img/warn.gif" width=16 height=16 border=0>Dieses Symbol vorm Bericht einfügen. </span>" an, wenn Sie möchten das das Symbol <img src="../img/warn.gif" width=16 height=16 border=0> vor <? if($x1=="docs") print "der Frage"; else print "dem Bericht"; ?> steht.
		<li>Wenn Sie ein Teil  <? if($x1=="docs") print "von der Frage"; else print "von dem Bericht"; ?>  hervorheben möchten, klickt das Symbol <img src="../img/hilite-s.gif" width=48 height=14 border=0> an bevor Sie das Wort oder den Satz schreiben. Um die
		Hervorhebung zu beenden, klickt das Symbol <img src="../img/hilite-e.gif" width=48 height=14 border=0> an nachdem Sie das letzte Zeichen des hervorgehobenen Teils schrieben.
		</font>
		</ul>
...
Achtung!</b></font>
<ul> 
	Sie können auch beide <? if($x1=="docs") print "ärztliche Anordnung und Fragen and den Arzt"; else print "Pflegebericht und Bericht über die Effektivität der Pflegeplanung"; ?> gleichzeitig schreiben.</ul>
