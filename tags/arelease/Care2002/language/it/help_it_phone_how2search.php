...
<ul> Se si è fatto login precedentemente e si hanno i diritti di accesso sufficienti, apparirà un
		...
		Inserire i propri dati e premere il bottone <img src="../img/en/en_continue.gif" border=0>.<p>
		Per annullare l'operazione, premere <img src="../img/en/en_cancel.gif" border=0>.
</ul><? endif ?>
<b>Nota</b>
<ul> Per annullare l'operazione di ricerca, premere <img src="../img/en/en_cancel.gif" border=0>.
</ul>
</form>
